...
swarmdo verify check --file src/critical.js --threshold 0.99

# Verify and auto-fix issues
swarmdo verify check --directory src/ --auto-fix

# Get JSON output for CI/CD
swarmdo verify check --json > verification.json
```
