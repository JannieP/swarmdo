...
```bash
npx swarmdo hook pre-edit -f "config/database.js" --validate-syntax
```

### Manual agent assignment

```bash
npx swarmdo hook pre-edit -f "api/users.ts" --auto-assign-agent false
```
...
npx swarmdo hook pre-edit --file "path/to/file.js" --validate-syntax
```
