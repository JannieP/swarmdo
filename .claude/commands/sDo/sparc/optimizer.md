...
npx swarmdo sparc run optimizer "optimize application performance"

# For alpha features
npx swarmdo@alpha sparc run optimizer "optimize application performance"
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run optimizer "optimize application performance"
```
