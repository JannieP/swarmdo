...
npx swarmdo sparc run security-review "audit API security"

# For alpha features
npx swarmdo@alpha sparc run security-review "audit API security"

# With namespace
npx swarmdo sparc run security-review "your task" --namespace security-review

# Non-interactive mode
npx swarmdo sparc run security-review "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run security-review "audit API security"
```
...
```bash
# Store mode-specific context
npx swarmdo memory store "security-review_context" "important decisions" --namespace security-review

# Query previous work
npx swarmdo memory query "security-review" --limit 5
```
