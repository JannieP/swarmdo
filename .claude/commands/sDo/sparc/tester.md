...
npx swarmdo sparc run tester "full regression suite"

# For alpha features
npx swarmdo@alpha sparc run tester "full regression suite"
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run tester "full regression suite"
```
