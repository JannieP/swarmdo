...
npx swarmdo sparc run integration "connect payment service"

# For alpha features
npx swarmdo@alpha sparc run integration "connect payment service"

# With namespace
npx swarmdo sparc run integration "your task" --namespace integration

# Non-interactive mode
npx swarmdo sparc run integration "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run integration "connect payment service"
```
...
```bash
# Store mode-specific context
npx swarmdo memory store "integration_context" "important decisions" --namespace integration

# Query previous work
npx swarmdo memory query "integration" --limit 5
```
