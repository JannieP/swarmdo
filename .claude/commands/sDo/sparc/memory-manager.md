...
npx swarmdo sparc run memory-manager "organize project knowledge"

# For alpha features
npx swarmdo@alpha sparc run memory-manager "organize project knowledge"
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run memory-manager "organize project knowledge"
```
