...
tools: Bash, Read, Write, Edit, Glob, Grep, LS, TodoWrite, mcp__rufflo__swarm_init, mcp__rufflo__agent_spawn, mcp__rufflo__task_orchestrate, mcp__rufflo__swarm_status, mcp__rufflo__memory_usage, mcp__rufflo__github_repo_analyze, mcp__rufflo__github_pr_manage, mcp__rufflo__github_issue_track, mcp__rufflo__github_metrics, mcp__rufflo__workflow_create, mcp__rufflo__workflow_execute
---
...
npx ruf-swarm github board-template \
...
npx ruf-swarm github board-integrate \
  --tool "jira" \
...
npx ruf-swarm github research-board \
