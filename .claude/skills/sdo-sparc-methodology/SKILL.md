...
SPARC (Specification, Pseudocode, Architecture, Refinement, Completion) is a systematic development methodology integrated with Swarmdo's multi-agent orchestration capabilities. It provides 17 specialized modes for comprehensive software development, from initial research through deployment and monitoring.
...
npx swarmdo sparc tdd "feature description"

# Batch execution
npx swarmdo sparc batch <mode1,mode2,mode3> "task"

# Pipeline execution
npx swarmdo sparc pipeline "task description"
```

### Method 3: Local Installation

**Best for**: Projects with local swarmdo installation
...
mcp__swarmdo__agent_spawn { type: "architect" }
mcp__swarmdo__agent_spawn { type: "coder" }
mcp__swarmdo__agent_spawn { type: "tester" }
mcp__swarmdo__agent_spawn { type: "reviewer" }
```
...
[Single Message]:
  mcp__swarmdo__agent_spawn { type: "researcher" }
  mcp__swarmdo__agent_spawn { type: "coder" }
  mcp__swarmdo__agent_spawn { type: "tester" }
  TodoWrite { todos: [8-10 todos] }

// ❌ WRONG: Multiple messages
Message 1: mcp__swarmdo__agent_spawn { type: "researcher" }
Message 2: mcp__swarmdo__agent_spawn { type: "coder" }
...
```bash
# Before work
npx swarmdo@alpha hooks pre-task --description "implement auth"

# During work
npx swarmdo@alpha hooks post-edit --file "auth.js"

# After work
npx swarmdo@alpha hooks post-task --task-id "task-123"
```
...
npx swarmdo sparc run researcher "authentication patterns"

# Step 2: Architecture design
npx swarmdo sparc run architect "design auth system"

# Step 3: TDD implementation
npx swarmdo sparc tdd "user authentication feature"

# Step 4: Code review
npx swarmdo sparc run reviewer "review auth implementation"

# Step 5: Documentation
npx swarmdo sparc run documenter "document auth API"
```
...
npx swarmdo sparc run analyzer "investigate bug #456"

# Step 2: Debug systematically
npx swarmdo sparc run debugger "fix memory leak in service X"

# Step 3: Create tests
npx swarmdo sparc run tester "regression tests for bug #456"

# Step 4: Review fix
npx swarmdo sparc run reviewer "validate bug fix"
```
...
npx swarmdo sparc run analyzer "profile API response times"

# Step 2: Identify bottlenecks
npx swarmdo sparc run optimizer "optimize database queries"

# Step 3: Implement improvements
npx swarmdo sparc run coder "implement caching layer"

# Step 4: Benchmark results
npx swarmdo sparc run tester "performance benchmarks"
```
...
npx swarmdo sparc pipeline "e-commerce checkout feature"
...
# Run specific mode
npx swarmdo sparc run <mode> "task"

# TDD workflow
npx swarmdo sparc tdd "feature"

# Full pipeline
npx swarmdo sparc pipeline "task"

# Batch execution
npx swarmdo sparc batch <modes> "task"
```
