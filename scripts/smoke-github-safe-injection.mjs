#!/usr/bin/env node
/**
 * Regression guard for upstream/swarmdo#2089 — ADR-127 Phase 1.
 *
 ...
 *   2. v3/@swarmdo/cli/.claude/helpers/github-safe.js   (init-template)
 */
...
const HELPERS = [
  ...
  join(REPO_ROOT, 'v3', '@swarmdo', 'cli', '.claude', 'helpers', 'github-safe.js'),
];
