#!/usr/bin/env node
/**
 * Deprecated-action regression guard for upstream/swarmdo#2089 — ADR-127 Phase 3.
 *
 ...
 * ones replaced in upstream/neural-trader's release workflow. Catching them
...
const SCAN_TREES = [
  ...
  join(REPO_ROOT, 'v3', '@swarmdo', 'cli', '.claude', 'agents', 'github'),
