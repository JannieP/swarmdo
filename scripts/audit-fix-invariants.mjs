...
const INVARIANTS = [
  ...
  {
    issue: '#1939',
    file: 'v3/@swarmdo/cli/src/mcp-tools/memory-tools.ts',
    regex: /\/\^\[A-Za-z\]:\[\\\\\/\]\//,
  ...
  {
    issue: '#1941',
    file: 'v3/@swarmdo/cli/src/memory/memory-bridge.ts',
  ...
  {
    issue: '#1941',
    file: 'v3/@swarmdo/cli/src/memory/memory-initializer.ts',
    substring: 'INSERT OR IGNORE INTO vector_indexes (id, name, dimensions)',
  ...
  {
    issue: '#1943',
    file: 'v3/@swarmdo/cli/src/init/settings-generator.ts',
    substring: '[ -f "$D/',
  ...
  // #1945 / #1946 — memory bridge + doctor honor SWARMDO_MEMORY_PATH
  {
    issue: '#1945',
    file: 'v3/@swarmdo/cli/src/memory/memory-bridge.ts',
  ...
  {
    issue: '#1946',
    file: 'v3/@swarmdo/cli/src/commands/doctor.ts',
    substring: 'getMemoryRoot',
  ...
  {
    issue: '#1951',
    file: 'v3/@swarmdo/cli/.claude/helpers/statusline.cjs',
    substring: 'SWARMDO_VERSION',
    why: 'Startup version-probe variable in the deployed statusline — without it the header reverts to a hard-coded `Swarmdo V3.5`.',
  },
  {
    issue: '#1951',
    file: 'v3/@swarmdo/cli/.claude/helpers/statusline.cjs',
    // Regex matches the path.join(home, '.claude', 'plugins', 'marketplaces', 'swarmdo', …) form.
    ...
    regex: /['"]marketplaces['"]\s*,\s*['"]swarmdo['"]/,
  ...
  {
    issue: '#1951',
    file: 'v3/@swarmdo/cli/src/init/statusline-generator.ts',
    regex: /['"]marketplaces['"]\s*,\s*['"]swarmdo['"]/,
  ...
  {
    issue: '#1953',
    file: 'v3/@swarmdo/cli/src/mcp-tools/hooks-tools.ts',
  ...
  {
    issue: '#1968',
    file: 'v3/@swarmdo/cli/src/commands/daemon.ts',
  ...
  // magic-check would ever be relevant. See upstream/swarmdo#2216 for the
  ...
  {
    issue: '#1987',
    file: 'v3/@swarmdo/cli/src/commands/memory.ts',
  ...
  // #1921 — pin @opentelemetry/core to dodge arborist Invalid Version
  {
    ...
    why: 'overrides pin for @opentelemetry/core@1.25.1. Eliminates the npm 10.8.x arborist `Invalid Version: ` placeholder that fails every `npx swarmdo@alpha …` install (including all 5 hook fires).',
  },

  // #1910 — MCP stdio mode protects stdout from stray console.log
  {
    issue: '#1910',
    file: 'v3/@swarmdo/cli/src/mcp-server.ts',
  ...
  {
    issue: 'ADR-120',
    file: 'v3/@swarmdo/plugin-agent-federation/src/transport/midstream-aware-loader.ts',
  ...
  {
    issue: 'ADR-120',
    file: 'v3/@swarmdo/plugin-agent-federation/src/plugin.ts',
  ...
  {
    issue: '#1949',
    file: 'v3/@swarmdo/plugin-agent-federation/package.json',
  ...
  // ADR-120 Step 3 — swarmdo-federation-peer Rust crate composes the
  // QUIC transport (midstreamer-quic) with the AIMDS 3-gate pipeline.
  {
    issue: 'ADR-120',
    file: 'v3/crates/swarmdo-federation-peer/Cargo.toml',
    substring: 'name = "swarmdo-federation-peer"',
  ...
  },
  {
    ...
    why: 'Step 3 crate pins midstreamer-quic@0.3.0 (upstream/midstream PR #82 added the QuicTransport embedding trait this crate needs for its TransportProvider blanket impl).',
  },
  {
    issue: 'ADR-120',
    file: 'v3/crates/swarmdo-federation-peer/Cargo.toml',
    substring: 'aimds-core = { version = "0.2.0"',
    why: 'Step 3 crate pins aimds-core@0.2.0 (upstream/midstream PR #82 added the SafetyGate composing trait this crate adapts in native_gate).',
  },
  {
    issue: 'ADR-120',
    file: 'v3/crates/swarmdo-federation-peer/src/lib.rs',
