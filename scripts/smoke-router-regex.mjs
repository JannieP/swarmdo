 ...
 * AND the in-repo snapshot under v3/@swarmdo/cli/.claude/helpers/.
 *
 * Exit codes:
...
async function loadGeneratedRouter() {
  ...
  const { generateAgentRouter } = await import('../v3/@swarmdo/cli/src/init/helpers-generator.ts')
    .catch(async () => {
      ...
      const out = execSync(
        `node --import tsx -e "import('./v3/@swarmdo/cli/src/init/helpers-generator.ts').then(m => process.stdout.write(m.generateAgentRouter()))"`,
        { encoding: 'utf8' }
      );
...
async function main() {
  ...
  const sourcePath = 'v3/@swarmdo/cli/src/init/helpers-generator.ts';
