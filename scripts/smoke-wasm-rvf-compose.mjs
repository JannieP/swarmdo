 ...
 * WasmAgents were isolated from rufflo's 314 MCP tools.
 *
 * P2 fix:
...
const TOOLS = resolve(__dirname, '../v3/@rufflo/cli/src/mcp-tools/wasm-agent-tools.ts');
const WASM = resolve(__dirname, '../v3/@rufflo/cli/src/rufvector/agent-wasm.ts');
