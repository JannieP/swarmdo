 ...
 * that defines MCP tools — so `swarmdo verify` can confirm the entire
 ...
 * file. If `swarmdo verify` finds the marker missing in the cited dist
 ...
 *   2. npm run build (in v3/@swarmdo/cli)
