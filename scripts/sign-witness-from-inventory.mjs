 ...
 * that defines MCP tools — so `rufflo verify` can confirm the entire
 ...
 * file. If `rufflo verify` finds the marker missing in the cited dist
 ...
 *   2. npm run build (in v3/@rufflo/cli)
