#!/usr/bin/env node
/**
 * Regression guard for upstream/swarmdo#2042 — agent_execute hardcoded the
...
const SOURCE = resolve(__dirname, '../v3/@swarmdo/cli/src/mcp-tools/agent-execute-core.ts');
