...
// Step 1: Generate settings.json via rufflo init
const tmpDir = mkdtempSync(join(tmpdir(), 'rufflo-smoke-hook-exec-'));
...
if (postEditCmd) {
  ...
  const env = {
    ...
    // rufflo@latest` — that takes 30+s on a cold CI runner and exceeds
