...
1. Queries the `gaia-runs` namespace: `npx @swarmdo/cli@latest memory list --namespace gaia-runs`
...
1. Run `npx @swarmdo/cli@latest memory list --namespace gaia-runs --limit $LIMIT`
