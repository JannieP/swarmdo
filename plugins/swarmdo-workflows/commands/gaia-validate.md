...
### 2. TypeScript build
```bash
cd v3/@swarmdo/cli && npx tsc --noEmit
```
...
- `v3/@swarmdo/cli/src/commands/gaia-bench.ts`
- `v3/@swarmdo/cli/src/benchmarks/gaia-agent.ts`
- `v3/@swarmdo/cli/src/benchmarks/gaia-judge.ts`
- `v3/@swarmdo/cli/src/benchmarks/gaia-loader.ts`
- `v3/@swarmdo/cli/src/benchmarks/gaia-tools/index.ts`

### 6. CLI binary resolvable
```bash
node v3/@swarmdo/cli/bin/cli.js --version
```
