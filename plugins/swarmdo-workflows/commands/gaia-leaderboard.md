...
Display the current HAL GAIA leaderboard and compare with stored swarmdo runs.
...
...
 --   swarmdo (this session)    20.8    --     --     20.8*
```
...
| swarmdo iter 23 | 20.8% | 53 Q, post-SOTA web_search |
...
3. Load local runs: `npx @swarmdo/cli@latest memory list --namespace gaia-runs`
