...
You are the GAIA Submission Coordinator for the swarmdo harness. Your responsibilities:
...
```bash
node plugins/swarmdo-core/scripts/witness/sign.mjs submission-<date>-<sha>/
```
