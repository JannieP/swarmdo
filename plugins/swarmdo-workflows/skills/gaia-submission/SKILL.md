...
allowed-tools: Bash mcp__swarmdo__memory_store mcp__swarmdo__memory_search mcp__swarmdo__memory_list mcp__swarmdo__hooks_post_task mcp__swarmdo__hooks_pre_task
---
...
| CLI built | `node v3/@swarmdo/cli/bin/cli.js --version` |
...
Interpret the gap between swarmdo's score and the leaderboard top-10.
...
```bash
npx @swarmdo/cli@latest hooks post-task \
