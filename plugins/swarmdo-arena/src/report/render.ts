// Text rendering of results. In the full system these surfaces become Swarmdo dashboard
// panels fed by SwarmVector read-models (ADR-149/198/202). Here we render to text so the
