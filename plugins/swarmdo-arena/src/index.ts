/**
 * swarmdo-arena — Competitive ruliology for Swarmdo swarms (ADR-147/148).
 *
 ...
 * The presentation/dashboard layer lives in Swarmdo (ADR-150); the data/intelligence layer
 * is SwarmVector's (ADR-196/197). This plugin is execution + a local data stand-in.
 */
