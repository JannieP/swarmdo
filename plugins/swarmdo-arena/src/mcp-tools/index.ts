// MCP tools for swarmdo-arena (Swarmdo ADR-147/148). Tool shape matches the Swarmdo convention:
...
/**
 * Default tool set, persisting to `.swarmdo/arena/` under the process CWD.
 *
