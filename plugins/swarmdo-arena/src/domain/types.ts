// Domain contracts for competitive ruliology (Swarmdo ADR-147/148).
...
/** A persisted, queryable record of a competition run (local stand-in for SwarmVector ADR-197). */
...
// ---------------------------------------------------------------------------
// Zod input schemas — validated at MCP tool boundaries (Swarmdo: validate at boundaries).
