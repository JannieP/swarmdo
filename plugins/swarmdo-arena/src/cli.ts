#!/usr/bin/env node
// Human-facing CLI for swarmdo-arena. Subcommands mirror the MCP tools (ADR-147).
//   swarmdo-arena demo | arena | tournament | evolve | coevolve
...
function cmdDemo(): void {
  console.log('============================================================');
  console.log(' swarmdo-arena — competitive ruliology demo (ADR-147/148/150)');
  console.log('============================================================');
