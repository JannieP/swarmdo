...
allowed-tools: mcp__swarmdo__hooks_transfer mcp__swarmdo__hooks_intelligence_pattern-search mcp__swarmdo__hooks_intelligence_pattern-store mcp__swarmdo__neural_patterns mcp__swarmdo__neural_status Bash
---
...
- `swarmdo-agentdb` ADR-0001 §"Namespace convention" — defines `pattern` namespace that this transfer reads from
