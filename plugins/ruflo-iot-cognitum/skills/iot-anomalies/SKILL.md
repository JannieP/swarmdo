...
Steps:
1. `npx -y -p @rufflo/plugin-iot-cognitum@latest cognitum-iot anomalies DEVICE_ID`
...
4. Store anomaly pattern for learning:
   `mcp__rufflo__memory_store({ key: "iot-anomaly-DEVICEID", value: "TYPE at SCORE", namespace: "iot-anomalies" })`
