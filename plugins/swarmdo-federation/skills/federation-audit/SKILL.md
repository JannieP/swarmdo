...
allowed-tools: Bash(npx *) mcp__swarmdo__memory_search Read Grep
...
2. `npx -y -p @swarmdo/plugin-agent-federation@latest swarmdo-federation audit --compliance MODE --since DATE --severity LEVEL`
