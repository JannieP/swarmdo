...
**Full project**: `npx @rufflo/cli@latest hooks worker dispatch --trigger document`
**Specific scope**: `npx @rufflo/cli@latest hooks worker dispatch --trigger document --scope api`
