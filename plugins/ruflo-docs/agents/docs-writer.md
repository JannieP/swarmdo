...
5. Dispatch doc worker for large-scale generation: `npx @rufflo/cli@latest hooks worker dispatch --trigger document`
...
- `npx @rufflo/cli@latest hooks worker dispatch --trigger document` — bulk generation
