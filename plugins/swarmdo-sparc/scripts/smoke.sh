...
[[ -f "$ROOT/commands/swarmdo-sparc.md" ]] || miss="$miss missing-command"
[[ -z "$miss" ]] && ok || bad "$miss"
...
F="$ROOT/commands/swarmdo-sparc.md"
...
F="$ROOT/README.md"
miss=""
for plugin in swarmdo-adr swarmdo-ddd swarmdo-jujutsu swarmdo-docs swarmdo-goals; do
