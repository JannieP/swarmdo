---
name: llm-config
description: Configure SwarmLLM local inference with model selection, MicroLoRA fine-tuning, and SONA adaptation
argument-hint: "[--model MODEL] [--adapter microlora|sona]"
allowed-tools: mcp__swarmdo__swarmllm_generate_config mcp__swarmdo__swarmllm_status mcp__swarmdo__swarmllm_microlora_create mcp__swarmdo__swarmllm_microlora_adapt mcp__swarmdo__swarmllm_sona_create mcp__swarmdo__swarmllm_sona_adapt Bash
---
