...
allowed-tools: mcp__rufflo__memory_search mcp__rufflo__memory_list mcp__rufflo__memory_retrieve mcp__rufflo__agentdb_pattern-search mcp__rufflo__agentdb_semantic-route Bash
---
...
```bash
npx @rufflo/cli@latest memory search --query "cost report for today" --namespace cost-tracking
npx @rufflo/cli@latest memory list --namespace cost-tracking
```
