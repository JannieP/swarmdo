...
shared helper; no library imports on swarmdo's boot path.
...
1. Run `node plugins/swarmdo-metaharness/scripts/score.mjs --path <dir>`
...
1. Run `node plugins/swarmdo-metaharness/scripts/genome.mjs --path <dir>`
...
1. Run `node plugins/swarmdo-metaharness/scripts/mcp-scan.mjs --path <dir>`
...
1. Run `node plugins/swarmdo-metaharness/scripts/threat-model.mjs --path <dir>`
...
1. Run `node plugins/swarmdo-metaharness/scripts/oia-audit.mjs`
...
1. Run `node plugins/swarmdo-metaharness/scripts/mint.mjs --name <id> --template <id> --host <id>`
2. **Safety**: refuses to write to the calling repo root or any path inside it; defaults to `/tmp/swarmdo-mint-<ts>-<name>/`
