...
## Phase-0 baseline (swarmdo, measured 2026-06-16)
...
Swarmdo's `risk_score: 0.27` is low (good). `publish_readiness: 0.9` is
high. The `mcp_surface: "remote"` reflects that swarmdo's MCP servers are
hosted, not bundled.
