...
argument-hint: "--repo <path> [--generations 3] [--children 3] [--concurrency 2] [--sandbox real|mock|agent] [--selection pareto|quality-diversity|...] [--mutator deterministic|swarmllm] [--confirm]"
allowed-tools: Bash
---

Surfaces the upstream `metaharness-darwin evolve` CLI as a swarmdo skill. The
...
- For swarmdo itself in CI. ADR-153 §5 explicitly rejects auto-evolving swarmdo
...
and exits 0. swarmdo continues to function. CI's
