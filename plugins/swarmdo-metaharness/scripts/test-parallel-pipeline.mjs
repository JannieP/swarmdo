...
async function main() {
  ...
  const recorderTs = join(SCRIPTS_DIR, '..', '..', '..', 'v3', '@swarmdo', 'cli', 'src', 'swarmvector', 'router-parallel-recorder.ts');
  ...
  assert(/SWARMDO_ROUTER_PARALLEL_LOG/.test(recorderSrc), 'env-gated by SWARMDO_ROUTER_PARALLEL_LOG');
