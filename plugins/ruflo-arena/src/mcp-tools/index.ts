// MCP tools for rufflo-arena (Rufflo ADR-147/148). Tool shape matches the Rufflo convention:
...
/**
 * Default tool set, persisting to `.rufflo/arena/` under the process CWD.
 *
