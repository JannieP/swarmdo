 ...
 * hard-import @swarmdo/browser. Phase 2 of *this* plugin ships the
...
/**
 * The slice of @swarmdo/browser's CausalRecoveryService surface we depend on.
...
export class BrowserCausalAdapter implements SublinearAdapter {
  ...
  readonly ownerPlugin = '@swarmdo/browser';
 ...
 *
 * Intended to be invoked from @swarmdo/browser's init code:
 *   import { registerBrowserCausalAdapter } from 'swarmdo-graph-intelligence/adapters';
