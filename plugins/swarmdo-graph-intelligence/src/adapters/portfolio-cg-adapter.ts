 ...
 *
 * `swarmdo-neural-trader` does mean-variance optimisation: solve `Σ x = μ`
...
export function portfolioGraphId(portfolioId: string): string {
  return `swarmdo-neural-trader:covariance:${portfolioId}`;
}

export class PortfolioCovarianceAdapter implements SublinearAdapter {
  readonly graphId: string;
  readonly ownerPlugin = 'swarmdo-neural-trader';
