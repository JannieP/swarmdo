 ...
 *
 * Run:
 *   node plugins/swarmdo-neural-trader/benchmarks/signal-generation.bench.mjs
 *
...
console.log('- `plugins/swarmdo-neural-trader/skills/trader-signal/SKILL.md` — production scan path');
