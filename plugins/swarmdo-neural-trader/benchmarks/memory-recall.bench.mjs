 ...
 *
 * Measures `mcp__swarmdo__memory_search`-style latency over the
 ...
 *
 * Run:
 *   node plugins/swarmdo-neural-trader/benchmarks/memory-recall.bench.mjs
 *
...
console.log('- `plugins/swarmdo-neural-trader/skills/trader-backtest/SKILL.md` — production recall path');
