 ...
 *
 * Run:
 *   node plugins/swarmdo-neural-trader/benchmarks/backtest-throughput.bench.mjs
 *
...
console.log('- `plugins/swarmdo-neural-trader/skills/trader-backtest/SKILL.md` — production backtest path');
