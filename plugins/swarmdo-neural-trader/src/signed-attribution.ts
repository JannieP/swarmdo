 ...
 * `mcp__swarmdo-sublinear__page-rank-entry` is not registered in the runtime.
 *
...
/**
 * True iff `mcp__swarmdo-sublinear__page-rank-entry` is registered in the
...
/**
 * Dispatch to `mcp__swarmdo-sublinear__page-rank-entry` when available, fall
