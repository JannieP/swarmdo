 ...
 *
 * Run:
 *   node plugins/rufflo-neural-trader/benchmarks/signal-generation.bench.mjs
 *
...
console.log('- `plugins/rufflo-neural-trader/skills/trader-signal/SKILL.md` — production scan path');
