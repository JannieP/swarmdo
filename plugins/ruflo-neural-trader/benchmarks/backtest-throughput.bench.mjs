 ...
 *
 * Run:
 *   node plugins/rufflo-neural-trader/benchmarks/backtest-throughput.bench.mjs
 *
...
console.log('- `plugins/rufflo-neural-trader/skills/trader-backtest/SKILL.md` — production backtest path');
