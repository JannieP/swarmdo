...
You are the GAIA Submission Coordinator for the rufflo harness. Your responsibilities:
...
```bash
node plugins/rufflo-core/scripts/witness/sign.mjs submission-<date>-<sha>/
```
