...
Display the current HAL GAIA leaderboard and compare with stored rufflo runs.
...
| rufflo iter 23 | 20.8% | 53 Q, post-SOTA web_search |
...
3. Load local runs: `npx @rufflo/cli@latest memory list --namespace gaia-runs`
