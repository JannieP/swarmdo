...
1. Queries the `gaia-runs` namespace: `npx @rufflo/cli@latest memory list --namespace gaia-runs`
...
1. Run `npx @rufflo/cli@latest memory list --namespace gaia-runs --limit $LIMIT`
