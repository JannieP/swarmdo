---
name: loop-worker
description: Run Swarmdo background workers using Claude Code native /loop scheduling
argument-hint: "<worker-name>"
allowed-tools: Bash(npx *) mcp__swarmdo__hooks_worker-dispatch mcp__swarmdo__hooks_worker-status ScheduleWakeup
---
...
Dispatch a worker via MCP: `mcp__swarmdo__hooks_worker-dispatch({ trigger: "WORKER_NAME" })`
