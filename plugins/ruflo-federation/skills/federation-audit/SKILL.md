...
allowed-tools: Bash(npx *) mcp__rufflo__memory_search Read Grep
...
2. `npx -y -p @rufflo/plugin-agent-federation@latest rufflo-federation audit --compliance MODE --since DATE --severity LEVEL`
