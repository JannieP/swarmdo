...
argument-hint: "<topic>"
allowed-tools: mcp__swarmdo__memory_store mcp__swarmdo__memory_search mcp__swarmdo__memory_search_unified mcp__swarmdo__agentdb_hierarchical-store mcp__swarmdo__agentdb_hierarchical-recall mcp__swarmdo__agentdb_pattern-search mcp__swarmdo__agentdb_pattern-store mcp__swarmdo__neural_predict mcp__swarmdo__hooks_intelligence_pattern-search mcp__swarmdo__hooks_intelligence_pattern-store mcp__swarmdo__task_create mcp__swarmdo__task_list mcp__swarmdo__task_summary Bash WebSearch WebFetch Read Write
---
...
2. **Search existing knowledge** — call `mcp__swarmdo__memory_search_unified` and `mcp__swarmdo__agentdb_pattern-search` to check what's already known
...
6. **Store findings** — call `mcp__swarmdo__memory_store` with namespace `research` for each key finding
7. **Store patterns** — call `mcp__swarmdo__agentdb_pattern-store` for reusable patterns discovered
