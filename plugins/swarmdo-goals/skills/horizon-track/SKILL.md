...
allowed-tools: mcp__swarmdo__memory_store mcp__swarmdo__memory_search mcp__swarmdo__memory_list mcp__swarmdo__memory_retrieve mcp__swarmdo__task_list mcp__swarmdo__task_summary mcp__swarmdo__progress_check mcp__swarmdo__progress_summary mcp__swarmdo__agentdb_hierarchical-store mcp__swarmdo__agentdb_hierarchical-recall mcp__swarmdo__hooks_intelligence_pattern-store mcp__swarmdo__session_save mcp__swarmdo__session_restore Bash Read Write
---
...
2. **Store horizon** — call `mcp__swarmdo__memory_store` with namespace `horizons` and key `horizon-[name]`:
   ```json
   {
     "objective": "...",
     "created": "2026-04-28",
...
3. **Session check-in** — at the start of each session:
   - Recall horizon: `mcp__swarmdo__memory_retrieve` key `horizon-[name]` namespace `horizons`
...
6. **Milestone completion** — when a milestone is done:
   ...
   - Store learned patterns via `mcp__swarmdo__hooks_intelligence_pattern-store`
