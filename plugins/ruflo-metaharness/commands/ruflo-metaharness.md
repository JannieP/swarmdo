...
shared helper; no library imports on rufflo's boot path.
...
1. Run `node plugins/rufflo-metaharness/scripts/score.mjs --path <dir>`
...
1. Run `node plugins/rufflo-metaharness/scripts/genome.mjs --path <dir>`
...
1. Run `node plugins/rufflo-metaharness/scripts/mcp-scan.mjs --path <dir>`
...
1. Run `node plugins/rufflo-metaharness/scripts/threat-model.mjs --path <dir>`
...
1. Run `node plugins/rufflo-metaharness/scripts/oia-audit.mjs`
...
1. Run `node plugins/rufflo-metaharness/scripts/mint.mjs --name <id> --template <id> --host <id>`
2. **Safety**: refuses to write to the calling repo root or any path inside it; defaults to `/tmp/rufflo-mint-<ts>-<name>/`
