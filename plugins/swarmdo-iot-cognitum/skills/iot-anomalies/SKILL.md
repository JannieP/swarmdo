...
Steps:
1. `npx -y -p @swarmdo/plugin-iot-cognitum@latest cognitum-iot anomalies DEVICE_ID`
...
4. Store anomaly pattern for learning:
   `mcp__swarmdo__memory_store({ key: "iot-anomaly-DEVICEID", value: "TYPE at SCORE", namespace: "iot-anomalies" })`
