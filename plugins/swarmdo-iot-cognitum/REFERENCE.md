# swarmdo-iot-cognitum — Operations Reference
...
```bash
# Lifecycle
npx -y -p @swarmdo/plugin-iot-cognitum@latest cognitum-iot register [endpoint]
npx -y -p @swarmdo/plugin-iot-cognitum@latest cognitum-iot pair <device-id>
npx -y -p @swarmdo/plugin-iot-cognitum@latest cognitum-iot unpair <device-id>
npx -y -p @swarmdo/plugin-iot-cognitum@latest cognitum-iot remove <device-id>

# Inspection
npx -y -p @swarmdo/plugin-iot-cognitum@latest cognitum-iot status <device-id>
npx -y -p @swarmdo/plugin-iot-cognitum@latest cognitum-iot list
npx -y -p @swarmdo/plugin-iot-cognitum@latest cognitum-iot mesh <device-id>

# Witness audit
npx -y -p @swarmdo/plugin-iot-cognitum@latest cognitum-iot witness <device-id>
npx -y -p @swarmdo/plugin-iot-cognitum@latest cognitum-iot witness verify <device-id>
```
...
Workers are dispatched by the host daemon when `swarmdo-iot-cognitum` is loaded. Verify via `swarmdo hooks worker list` and `swarmdo hooks worker status`.
