...
allowed-tools: mcp__swarmdo__browser_eval Bash Read Write
---
...
1. **Locate both RVF containers**:
   ```bash
   npx -y swarmvector@0.2.25 rvf status <session-id-a>.rvf
   npx -y swarmvector@0.2.25 rvf status <session-id-b>.rvf
   ```
