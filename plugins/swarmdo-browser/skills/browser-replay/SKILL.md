...
allowed-tools: mcp__swarmdo__browser_open mcp__swarmdo__browser_close mcp__swarmdo__browser_click mcp__swarmdo__browser_fill mcp__swarmdo__browser_type mcp__swarmdo__browser_press mcp__swarmdo__browser_select mcp__swarmdo__browser_check mcp__swarmdo__browser_uncheck mcp__swarmdo__browser_hover mcp__swarmdo__browser_wait mcp__swarmdo__browser_screenshot mcp__swarmdo__browser_snapshot mcp__swarmdo__browser_eval Bash Read
---
...
- Forking a session (`/swarmdo-browser fork`) and replaying the parent before mutating.
...
3. **Open a fresh browser** via `mcp__swarmdo__browser_open` (target URL = original or `--url` override).
