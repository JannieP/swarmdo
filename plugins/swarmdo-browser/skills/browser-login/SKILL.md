...
allowed-tools: mcp__swarmdo__browser_open mcp__swarmdo__browser_close mcp__swarmdo__browser_fill mcp__swarmdo__browser_type mcp__swarmdo__browser_click mcp__swarmdo__browser_wait mcp__swarmdo__browser_eval mcp__swarmdo__browser_snapshot mcp__swarmdo__aidefence_scan mcp__swarmdo__aidefence_has_pii Bash Read Write
---
...
6. **Store in `browser-cookies`**:
   ```bash
   npx -y @swarmdo/cli@latest memory store --namespace browser-cookies \
     --key "<host>" \
