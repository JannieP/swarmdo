...
allowed-tools: mcp__swarmdo__browser_open mcp__swarmdo__browser_click mcp__swarmdo__browser_fill mcp__swarmdo__browser_type mcp__swarmdo__browser_press mcp__swarmdo__browser_check mcp__swarmdo__browser_uncheck mcp__swarmdo__browser_select mcp__swarmdo__browser_hover mcp__swarmdo__browser_wait mcp__swarmdo__browser_screenshot mcp__swarmdo__browser_snapshot mcp__swarmdo__browser_get-text mcp__swarmdo__browser_get-title mcp__swarmdo__browser_get-url mcp__swarmdo__browser_get-value mcp__swarmdo__browser_eval mcp__swarmdo__browser_close mcp__swarmdo__browser_session-list mcp__swarmdo__aidefence_is_safe Bash Read Write
---
...
1. **Record the test run** by composing `browser-record`:
   ...
   - Begins a swarmvector trajectory.
...
- The same skill, used in CI, now produces an artifact that `/swarmdo-browser replay` can re-drive.
