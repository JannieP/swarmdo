#!/usr/bin/env bash
# Structural smoke test for swarmdo-cost-tracker v0.3.0 (ADR-0001 + ADR-0002).
set -u
...
step "5. README pins @swarmdo/cli to v3.6"
grep -qE "@swarmdo/cli.*v3\.6|v3\.6.*swarmdo/cli" "$ROOT/README.md" \
  && ok || bad "v3.6 pin missing"

step "6. README defers to swarmdo-agentdb namespace convention"
grep -q "swarmdo-agentdb" "$ROOT/README.md" \
...
miss=""
grep -qE "getTokenOptimizer|@swarmdo/integration" "$F" || miss="$miss bridge-ref"
...
grep -q "swarmdo-loop-workers" "$F" || miss="$miss cross-link"
[[ -z "$miss" ]] && ok || bad "$miss"

step "15. swarmdo-cost.md documents 'cost workers' subcommand with hooks_worker-status"
F="$ROOT/commands/swarmdo-cost.md"
miss=""
...
step "26. swarmdo-cost.md documents 'cost benchmark' subcommand"
F="$ROOT/commands/swarmdo-cost.md"
...
step "30. swarmdo-cost.md documents 'cost track' subcommand"
F="$ROOT/commands/swarmdo-cost.md"
...
step "33. swarmdo-cost.md documents 'cost budget set/get/check' subcommands"
F="$ROOT/commands/swarmdo-cost.md"
miss=""
...
step "36. swarmdo-cost.md documents 'cost outcome' subcommand"
grep -q "cost outcome" "$ROOT/commands/swarmdo-cost.md" \
  && ok || bad "missing"
...
step "39. swarmdo-cost.md documents 'cost trend' subcommand"
grep -q "cost trend" "$ROOT/commands/swarmdo-cost.md" \
  && ok || bad "missing"
...
step "39m. swarmdo-cost.md documents 'cost session' subcommand"
F="$ROOT/commands/swarmdo-cost.md"
miss=""
...
step "39k. swarmdo-cost.md documents 'cost diff' subcommand"
F="$ROOT/commands/swarmdo-cost.md"
miss=""
...
step "39i. swarmdo-cost.md documents 'cost health' subcommand"
F="$ROOT/commands/swarmdo-cost.md"
miss=""
...
step "39g. swarmdo-cost.md documents 'cost anomaly' subcommand with alert flag"
F="$ROOT/commands/swarmdo-cost.md"
miss=""
...
step "39e. swarmdo-cost.md documents 'cost burn' subcommand with alert flag"
F="$ROOT/commands/swarmdo-cost.md"
miss=""
