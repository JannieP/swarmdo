...
allowed-tools: Bash mcp__swarmdo__memory_retrieve mcp__swarmdo__memory_list mcp__swarmdo__memory_store
---
...
1. **Run the check**:
   ...
   ```bash
   node plugins/swarmdo-cost-tracker/scripts/budget.mjs check
   ```
...
3. **Set / inspect the budget**:
   ...
   ```bash
   node plugins/swarmdo-cost-tracker/scripts/budget.mjs set 50.00
   node plugins/swarmdo-cost-tracker/scripts/budget.mjs get
   ```
