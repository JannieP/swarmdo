...
5. Dispatch doc worker for large-scale generation: `npx @swarmdo/cli@latest hooks worker dispatch --trigger document`
...
- `npx @swarmdo/cli@latest hooks worker dispatch --trigger document` — bulk generation
