...
**Full project**: `npx @swarmdo/cli@latest hooks worker dispatch --trigger document`
**Specific scope**: `npx @swarmdo/cli@latest hooks worker dispatch --trigger document --scope api`
