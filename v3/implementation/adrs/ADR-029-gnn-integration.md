# ADR-029: Graph Neural Network Integration for Rufflo V3
...
Rufflo V3 processes complex, interconnected data structures that naturally form graphs:
...
Integrate Graph Neural Network layers from RuVector into Rufflo V3 for graph-aware processing. The integration follows the **optional dependency pattern** established in ADR-017.
...
```typescript
// v3/@rufflo/gnn/src/layers/gcn.ts
...
```typescript
// v3/@rufflo/gnn/src/layers/gat.ts
...
```typescript
// v3/@rufflo/gnn/src/layers/graphsage.ts
...
```typescript
// v3/@rufflo/gnn/src/layers/mpnn.ts
...
```typescript
// v3/@rufflo/gnn/src/layers/edge-conv.ts
...
```typescript
// v3/@rufflo/gnn/src/data/node-embeddings.ts
...
```typescript
// v3/@rufflo/gnn/src/data/edge-features.ts
...
```typescript
// v3/@rufflo/gnn/src/data/graph-representation.ts
...
```typescript
// v3/@rufflo/gnn/src/use-cases/codebase-graph.ts
...
```typescript
// v3/@rufflo/gnn/src/use-cases/agent-graph.ts
...
```typescript
// v3/@rufflo/gnn/src/use-cases/pattern-propagation.ts
...
```typescript
// v3/@rufflo/gnn/src/use-cases/impact-analysis.ts
...
```typescript
// v3/@rufflo/gnn/src/integration/memory-integration.ts
...
```typescript
// v3/@rufflo/gnn/src/integration/plugin-graph.ts
...
```typescript
// v3/@rufflo/gnn/src/integration/swarm-optimization.ts
...
```typescript
// v3/@rufflo/gnn/src/utils/sparse.ts
...
```typescript
// v3/@rufflo/gnn/src/utils/batching.ts
...
```typescript
// v3/@rufflo/gnn/src/utils/gpu.ts
...
```typescript
// v3/@rufflo/gnn/src/types/index.ts
