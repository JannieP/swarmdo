# ADR-029: Graph Neural Network Integration for Swarmdo V3
...
Swarmdo V3 processes complex, interconnected data structures that naturally form graphs:
...
The SwarmVector intelligence system already provides:
...
Integrate Graph Neural Network layers from SwarmVector into Swarmdo V3 for graph-aware processing. The integration follows the **optional dependency pattern** established in ADR-017.
...
5. **Consistent API** - Matches existing SwarmVector interfaces
...
```typescript
// v3/@swarmdo/gnn/src/layers/gcn.ts
...
```typescript
// v3/@swarmdo/gnn/src/layers/gat.ts
...
```typescript
// v3/@swarmdo/gnn/src/layers/graphsage.ts
...
```typescript
// v3/@swarmdo/gnn/src/layers/mpnn.ts
...
```typescript
// v3/@swarmdo/gnn/src/layers/edge-conv.ts
...
```typescript
// v3/@swarmdo/gnn/src/data/node-embeddings.ts
...
```typescript
// v3/@swarmdo/gnn/src/data/edge-features.ts
...
```typescript
// v3/@swarmdo/gnn/src/data/graph-representation.ts
...
```typescript
// v3/@swarmdo/gnn/src/use-cases/codebase-graph.ts
...
```typescript
// v3/@swarmdo/gnn/src/use-cases/agent-graph.ts
...
```typescript
// v3/@swarmdo/gnn/src/use-cases/pattern-propagation.ts
...
```typescript
// v3/@swarmdo/gnn/src/use-cases/impact-analysis.ts
...
```typescript
// v3/@swarmdo/gnn/src/integration/memory-integration.ts
...
```typescript
// v3/@swarmdo/gnn/src/integration/plugin-graph.ts
...
```typescript
// v3/@swarmdo/gnn/src/integration/swarm-optimization.ts
...
```typescript
// v3/@swarmdo/gnn/src/utils/sparse.ts
...
```typescript
// v3/@swarmdo/gnn/src/utils/batching.ts
...
```typescript
// v3/@swarmdo/gnn/src/utils/gpu.ts
...
```typescript
// v3/@swarmdo/gnn/src/types/index.ts
