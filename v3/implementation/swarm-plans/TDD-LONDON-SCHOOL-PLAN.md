...
This document defines the **London School TDD** (Mock-first, Outside-in) approach for Swarmdo v3 implementation. All 15 agents follow this methodology, with Agent #13 (TDD Test Engineer) as the primary coordinator.
