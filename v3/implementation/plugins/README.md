...
```typescript
import { ClaudeFlowPlugin, PluginContext } from '@rufflo/shared';
...
Located in `@rufflo/shared/src/plugins/official/`:
...
```typescript
import { PluginError, PluginErrorCode } from '@rufflo/shared';
