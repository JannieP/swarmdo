...
```typescript
import { ClaudeFlowPlugin, PluginContext } from '@swarmdo/shared';
...
Located in `@swarmdo/shared/src/plugins/official/`:
...
```typescript
import { PluginError, PluginErrorCode } from '@swarmdo/shared';
