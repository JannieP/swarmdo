# better-sqlite3 Usage Inventory - Swarmdo v3
...
**File**: `/home/user/swarmdo/src/memory/sqlite-wrapper.js`
...
**File**: `/home/user/swarmdo/src/api/database-service.ts`
- **Line**: 559
...
**File**: `/home/user/swarmdo/src/core/DatabaseManager.ts`
- **Line**: 197
...
**File**: `/home/user/swarmdo/src/core/persistence.ts`
- **Line**: 5
...
// Line 1-8
/**
 * Persistence layer for Swarmdo using SQLite
 */
...
**File**: `/home/user/swarmdo/src/memory/backends/sqlite.ts`
...
**File**: `/home/user/swarmdo/src/memory/sqlite-store.js`
- **Line**: 10
...
**File**: `/home/user/swarmdo/src/cli/simple-commands/hive-mind.js`
- **Lines**: 38, 46
...
**File**: `/home/user/swarmdo/src/cli/simple-commands/hive-mind-wizard.js`
- **Line**: 4
...
**File**: `/home/user/swarmdo/src/cli/simple-commands/hive-mind/memory.js`
- **Line**: 7
...
**File**: `/home/user/swarmdo/src/cli/simple-commands/hive-mind/metrics-reader.js`
- **Line**: 6
- **Usage**: ES module import
- **Migration**: Use abstraction layer
...
**File**: `/home/user/swarmdo/src/cli/simple-commands/hive-mind/db-optimizer.js`
- **Line**: 8
- **Usage**: ES module import
- **Migration**: Use abstraction layer
...
**File**: `/home/user/swarmdo/src/cli/simple-commands/hive-mind/mcp-wrapper.js`
- **Line**: 132
...
**File**: `/home/user/swarmdo/src/cli/simple-commands/init/hive-mind-init.js`
- **Lines**: 304, 307
...
**File**: `/home/user/swarmdo/src/cli/simple-commands/swarm-metrics-integration.js`
- **Line**: 8
- **Usage**: ES module import
- **Migration**: Use abstraction layer
...
**File**: `/home/user/swarmdo/src/utils/error-recovery.ts`
...
**File**: `/home/user/swarmdo/scripts/fix-agentic-flow-sqlite.sh`
- **Line**: 6, 16, 25-26
...
**File**: `/home/user/swarmdo/src/patches/hive-mind-timezone-fix.patch`
- **Line**: 77
...
**File**: `/home/user/swarmdo/scripts/install-arm64.js`
- **Lines**: 9, 11
