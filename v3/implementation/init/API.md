...
**Example:**
```typescript
import { detectPlatform } from '@rufflo/cli/init';
...
```typescript
import { generateSettings, generateSettingsJson } from '@rufflo/cli/init';
...
```typescript
import { generateMCPConfig, generateMCPJson, generateMCPCommands } from '@rufflo/cli/init';
...
// ['claude mcp add rufflo -- npx @rufflo/cli mcp start', ...]
```
...
```typescript
import { generateStatuslineScript, generateStatuslineHook } from '@rufflo/cli/init';
...
const result = await executeInit({
  ...
  sourceBaseDir: '/path/to/rufflo', // Source for skills/commands/agents
  force: true,
  components: {
...
```typescript
import { executeInit, detectPlatform, DEFAULT_INIT_OPTIONS } from '@rufflo/cli/init';
...
```typescript
import { executeInit, MINIMAL_INIT_OPTIONS } from '@rufflo/cli/init';
