    ...
    projects: [
      {
        ...
        test: {
          ...
          exclude: [
            ...
            '**/integrations-skills-cmd.test.ts',
            '**/intelligence-context-injection.test.ts',
          ],
        },
      },
      {
        ...
        test: {
          ...
          include: [
            ...
            '@swarmdo/cli/__tests__/issue-2250-2251-regression.test.ts',
            '@swarmdo/cli/__tests__/integrations-skills-cmd.test.ts',
            '@swarmdo/cli/__tests__/intelligence-context-injection.test.ts',
          ],
