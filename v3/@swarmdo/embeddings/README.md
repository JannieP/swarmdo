...
[![npm version](https://img.shields.io/npm/v/@swarmdo/embeddings.svg)](https://www.npmjs.com/package/@swarmdo/embeddings)
[![npm downloads](https://img.shields.io/npm/dm/@swarmdo/embeddings.svg)](https://www.npmjs.com/package/@swarmdo/embeddings)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Performance](https://img.shields.io/badge/Performance-<5ms-brightgreen.svg)](the upstream project (see NOTICE))

> High-performance embedding generation module for Swarmdo V3 - multi-provider support with persistent caching, document chunking, normalization, hyperbolic embeddings, and neural substrate integration.
...
```bash
npm install @swarmdo/embeddings
```

## Standalone use (without the Swarmdo CLI)

This package runs on its own — no `@swarmdo/cli`, no MCP server,
...
swarmdo embeddings init --provider agentic-flow
```
...
```typescript
import { OpenAIEmbeddingService } from '@swarmdo/embeddings';
...
```typescript
import { AgenticFlowEmbeddingService } from '@swarmdo/embeddings';
...
```typescript
import { TransformersEmbeddingService } from '@swarmdo/embeddings';
...
```typescript
import { MockEmbeddingService } from '@swarmdo/embeddings';
...
```typescript
import { createEmbeddingService } from '@swarmdo/embeddings';
...
```typescript
import { chunkText, estimateTokens, reconstructFromChunks } from '@swarmdo/embeddings';
...
```typescript
import { PersistentEmbeddingCache, isPersistentCacheAvailable } from '@swarmdo/embeddings';
...
# Neural operations
swarmdo embeddings neural drift --baseline "context" --input "check this"
...
- [@swarmdo/memory](../memory) - HNSW indexing and vector storage
- [@swarmdo/providers](../providers) - Multi-LLM provider system
- [@swarmdo/neural](../neural) - SONA learning integration
