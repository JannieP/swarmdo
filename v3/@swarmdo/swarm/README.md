...
[![npm version](https://img.shields.io/npm/v/@swarmdo/swarm.svg)](https://www.npmjs.com/package/@swarmdo/swarm)
[![npm downloads](https://img.shields.io/npm/dm/@swarmdo/swarm.svg)](https://www.npmjs.com/package/@swarmdo/swarm)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![ADR-003](https://img.shields.io/badge/ADR--003-Compliant-green.svg)](the upstream project (see NOTICE))
[![Agents](https://img.shields.io/badge/Agents-Up%20to%20100+-orange.svg)](the upstream project (see NOTICE))
...
```typescript
import { createUnifiedSwarmCoordinator } from '@swarmdo/swarm';
...
```typescript
import { createSwarmHub } from '@swarmdo/swarm';
...
```typescript
import { createQueenCoordinator } from '@swarmdo/swarm';
...
```typescript
import { createAttentionCoordinator } from '@swarmdo/swarm';
...
```typescript
import { createFederationHub, getDefaultFederationHub } from '@swarmdo/swarm';
