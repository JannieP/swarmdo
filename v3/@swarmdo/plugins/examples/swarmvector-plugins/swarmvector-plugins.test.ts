/**
 * SwarmVector Plugins Test Suite
 *
 * Tests for all SwarmVector-powered plugins.
 */
...
describe('Plugin Integration Types', () => {
  it('should export all plugin types', async () => {
    ...
    expect(exports.registerAllSwarmVectorPlugins).toBeDefined();
  });
...
describe('Plugin Metadata', () => {
  it('reasoningBankPlugin should have correct metadata', async () => {
    ...
    expect(metadata.id).toBe('swarmvector-reasoning-bank');
    expect(metadata.name).toBe('SwarmVector Reasoning Bank');
  ...
  it('semanticCodeSearchPlugin should have correct metadata', async () => {
    ...
    expect(metadata.id).toBe('swarmvector-semantic-code-search');
    expect(metadata.name).toBe('SwarmVector Semantic Code Search');
  ...
  it('sonaLearningPlugin should have correct metadata', async () => {
    ...
    expect(metadata.id).toBe('swarmvector-sona-learning');
    expect(metadata.name).toBe('SwarmVector SONA Learning');
    expect(metadata.capabilities).toContain('learning');
  ...
  it('intentRouterPlugin should have correct metadata', async () => {
    ...
    expect(metadata.id).toBe('swarmvector-intent-router');
    expect(metadata.name).toBe('SwarmVector Intent Router');
  ...
  it('mcpToolOptimizerPlugin should have correct metadata', async () => {
    ...
    expect(metadata.id).toBe('swarmvector-mcp-tool-optimizer');
    expect(metadata.name).toBe('SwarmVector MCP Tool Optimizer');
  ...
  it('hookPatternLibraryPlugin should have correct metadata', async () => {
    ...
    expect(metadata.id).toBe('swarmvector-hook-pattern-library');
    expect(metadata.name).toBe('SwarmVector Hook Pattern Library');
