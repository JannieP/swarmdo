/**
 * SwarmVector Plugin Collection
 *
 * High-value plugins using @swarmvector WASM packages for Swarmdo.
 *
...
/**
 * Register all SwarmVector plugins with the default registry.
 */
export async function registerAllSwarmVectorPlugins(): Promise<void> {
