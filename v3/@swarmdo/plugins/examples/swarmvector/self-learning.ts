/**
 * SwarmVector PostgreSQL Bridge - Self-Learning Example
 *
 ...
 *
 * Run with: npx ts-node examples/swarmvector/self-learning.ts
 *
 * @module @swarmdo/plugins/examples/swarmvector/self-learning
 */
...
} from '../../src/integrations/swarmvector/self-learning.js';
...
async function main(): Promise<void> {
  console.log('SwarmVector PostgreSQL Bridge - Self-Learning Example');
  console.log('====================================================\n');
