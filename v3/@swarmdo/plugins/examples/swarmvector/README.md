# SwarmVector PostgreSQL Bridge Examples

Comprehensive examples demonstrating the SwarmVector PostgreSQL Bridge plugin features.
...
npx ts-node examples/swarmvector/basic-usage.ts

# Semantic code search
npx ts-node examples/swarmvector/semantic-search.ts

# Attention mechanisms
npx ts-node examples/swarmvector/attention-patterns.ts

# Graph neural networks
npx ts-node examples/swarmvector/gnn-analysis.ts

# Hyperbolic embeddings
npx ts-node examples/swarmvector/hyperbolic-hierarchies.ts

# Self-learning optimization
npx ts-node examples/swarmvector/self-learning.ts

# Large-scale streaming
npx ts-node examples/swarmvector/streaming-large-data.ts

# Quantization methods
npx ts-node examples/swarmvector/quantization.ts

# Transaction patterns
npx ts-node examples/swarmvector/transactions.ts
```
...
Getting started with SwarmVector PostgreSQL Bridge:
...
**Expected output:**
```
SwarmVector PostgreSQL Bridge - Basic Usage Example
================================================
...
- [SwarmVector Plugin Documentation](../../src/integrations/swarmvector/README.md)
