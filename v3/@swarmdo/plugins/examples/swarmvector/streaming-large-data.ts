/**
 * SwarmVector PostgreSQL Bridge - Streaming Large Data Example
 *
 ...
 *
 * Run with: npx ts-node examples/swarmvector/streaming-large-data.ts
 *
 * @module @swarmdo/plugins/examples/swarmvector/streaming-large-data
 */
...
async function main(): Promise<void> {
  console.log('SwarmVector PostgreSQL Bridge - Streaming Large Data Example');
  console.log('============================================================\n');
