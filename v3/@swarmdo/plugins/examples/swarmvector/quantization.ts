/**
 * SwarmVector PostgreSQL Bridge - Quantization Example
 *
 ...
 *
 * Run with: npx ts-node examples/swarmvector/quantization.ts
 *
 * @module @swarmdo/plugins/examples/swarmvector/quantization
 */
...
async function main(): Promise<void> {
  console.log('SwarmVector PostgreSQL Bridge - Quantization Example');
  console.log('===================================================\n');
