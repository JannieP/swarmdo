/**
 * SwarmVector PostgreSQL Bridge - Attention Mechanisms Example
 *
 ...
 *
 * Run with: npx ts-node examples/swarmvector/attention-patterns.ts
 *
 * @module @swarmdo/plugins/examples/swarmvector/attention-patterns
 */
...
} from '../../src/integrations/swarmvector/attention.js';
...
async function main(): Promise<void> {
  console.log('SwarmVector PostgreSQL Bridge - Attention Mechanisms Example');
  console.log('==========================================================\n');
