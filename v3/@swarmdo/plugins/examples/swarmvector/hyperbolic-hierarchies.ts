/**
 * SwarmVector PostgreSQL Bridge - Hyperbolic Embeddings Example
 *
 ...
 *
 * Run with: npx ts-node examples/swarmvector/hyperbolic-hierarchies.ts
 *
 * @module @swarmdo/plugins/examples/swarmvector/hyperbolic-hierarchies
 */

import {
  createSwarmVectorBridge,
  type SwarmVectorBridge,
} from '../../src/integrations/swarmvector/index.js';
...
import {
  ...
  type HierarchyNode,
} from '../../src/integrations/swarmvector/hyperbolic.js';
...
async function main(): Promise<void> {
  console.log('SwarmVector PostgreSQL Bridge - Hyperbolic Embeddings Example');
  console.log('============================================================\n');

  const bridge: SwarmVectorBridge = createSwarmVectorBridge({
