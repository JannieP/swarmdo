/**
 * SwarmVector PostgreSQL Bridge - Graph Neural Network Analysis Example
 *
 ...
 *
 * Run with: npx ts-node examples/swarmvector/gnn-analysis.ts
 *
 * @module @swarmdo/plugins/examples/swarmvector/gnn-analysis
 */
...
} from '../../src/integrations/swarmvector/gnn.js';
...
async function main(): Promise<void> {
  console.log('SwarmVector PostgreSQL Bridge - Graph Neural Network Analysis Example');
  console.log('===================================================================\n');
