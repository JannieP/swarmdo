/**
 * SwarmVector PostgreSQL Bridge - Semantic Code Search Example
 *
 ...
 *
 * Run with: npx ts-node examples/swarmvector/semantic-search.ts
 *
 * @module @swarmdo/plugins/examples/swarmvector/semantic-search
 */
...
async function main(): Promise<void> {
  console.log('SwarmVector PostgreSQL Bridge - Semantic Code Search Example');
  console.log('=========================================================\n');
