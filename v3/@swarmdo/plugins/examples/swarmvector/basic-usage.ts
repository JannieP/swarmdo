 ...
 *
 * Run with: npx ts-node examples/swarmvector/basic-usage.ts
 *
 * @module @swarmdo/plugins/examples/swarmvector/basic-usage
 */
...
async function main(): Promise<void> {
  console.log('SwarmVector PostgreSQL Bridge - Basic Usage Example');
  console.log('================================================\n');
