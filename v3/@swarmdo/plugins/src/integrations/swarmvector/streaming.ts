/**
 * SwarmVector PostgreSQL Bridge - Streaming and Transaction Support
 *
 ...
 *
 * @module @swarmdo/plugins/integrations/swarmvector/streaming
 * @version 1.0.0
 */
...
const DEFAULT_CURSOR_PREFIX = 'swarmvector_cursor_';
...
// ============================================================================
// SwarmVectorStream Class
// ============================================================================

/**
 * Streaming support for SwarmVector operations.
 *
 ...
 * @example
 * ```typescript
 * const stream = new SwarmVectorStream(pool, config);
 *
 ...
 * ```
 */
export class SwarmVectorStream extends EventEmitter {
...
// ============================================================================
// SwarmVectorTransaction Class
// ============================================================================

/**
 * Enhanced transaction support for SwarmVector operations.
 *
 ...
 * @example
 * ```typescript
 * const tx = new SwarmVectorTransaction(client);
 ...
 * ```
 */
export class SwarmVectorTransaction extends EventEmitter {
...
/**
 * Create a new SwarmVectorStream instance.
 */
export function createSwarmVectorStream(
  pool: Pool,
  options?: {
    schema?: string;
    defaultTableName?: string;
  ...
  return new SwarmVectorStream(pool, options);
}

/**
 * Create a new SwarmVectorTransaction instance.
 */
export function createSwarmVectorTransaction(
  client: PoolClient,
  options?: {
    schema?: string;
    defaultTableName?: string;
  }
): SwarmVectorTransaction {
  return new SwarmVectorTransaction(client, options);
}
...
export default {
  ...
  BatchProcessor,
  PoolEventEmitter,
  createSwarmVectorStream,
  createSwarmVectorTransaction,
