/**
 * SwarmVector PostgreSQL Bridge - Type Definitions
 *
 * Comprehensive TypeScript types for the SwarmVector PostgreSQL vector database
...
/**
 * Primary configuration for SwarmVector PostgreSQL connection.
 */
...
/**
 * Index types supported by SwarmVector/pgvector.
 */
...
/**
 * All 39 attention mechanism types supported by SwarmVector.
 *
 * These mechanisms enable sophisticated neural search and pattern matching
 * directly within PostgreSQL using SwarmVector's attention functions.
 */
...
/**
 * GNN layer types supported by SwarmVector.
 */
...
/**
 * Hyperbolic space models supported by SwarmVector.
 */
...
/**
 * SwarmVector SQL function categories.
 */
export type SwarmVectorFunctionCategory =
...
export interface VectorFunctions {
  ...
  'swarmvector.vector_add': VectorBinaryOp;
  'swarmvector.vector_sub': VectorBinaryOp;
  'swarmvector.vector_mul': VectorScalarOp;
  'swarmvector.vector_div': VectorScalarOp;
  'swarmvector.vector_neg': VectorUnaryOp;
  'swarmvector.vector_dot': VectorBinaryScalarOp;
  'swarmvector.vector_cross': VectorBinaryOp;
  'swarmvector.vector_norm': VectorNormOp;
  'swarmvector.vector_normalize': VectorUnaryOp;
  'swarmvector.vector_scale': VectorScalarOp;
  'swarmvector.vector_lerp': VectorLerpOp;
  'swarmvector.vector_slerp': VectorSlerpOp;

  // Distance Functions
  'swarmvector.cosine_distance': DistanceFunction;
  'swarmvector.cosine_similarity': DistanceFunction;
  'swarmvector.euclidean_distance': DistanceFunction;
  'swarmvector.l2_distance': DistanceFunction;
  'swarmvector.manhattan_distance': DistanceFunction;
  'swarmvector.l1_distance': DistanceFunction;
  'swarmvector.hamming_distance': DistanceFunction;
  'swarmvector.jaccard_distance': DistanceFunction;
  'swarmvector.inner_product': DistanceFunction;
  'swarmvector.dot_product': DistanceFunction;

  // Aggregation Functions
  'swarmvector.vector_avg': VectorAggregateOp;
  'swarmvector.vector_sum': VectorAggregateOp;
  'swarmvector.vector_min': VectorAggregateOp;
  'swarmvector.vector_max': VectorAggregateOp;
  'swarmvector.vector_centroid': VectorAggregateOp;
  'swarmvector.vector_median': VectorAggregateOp;
}
...
export interface IndexFunctions {
  'swarmvector.create_hnsw_index': CreateIndexOp;
  'swarmvector.create_ivfflat_index': CreateIndexOp;
  'swarmvector.drop_index': DropIndexOp;
  'swarmvector.reindex': ReindexOp;
  'swarmvector.index_stats': IndexStatsOp;
  'swarmvector.set_ef_search': SetParamOp;
  'swarmvector.set_probes': SetParamOp;
}
...
export interface AttentionFunctions {
  'swarmvector.multi_head_attention': AttentionOp;
  'swarmvector.self_attention': AttentionOp;
  'swarmvector.cross_attention': CrossAttentionOp;
  'swarmvector.flash_attention': FlashAttentionOp;
  'swarmvector.linear_attention': LinearAttentionOp;
  'swarmvector.sparse_attention': SparseAttentionOp;
  'swarmvector.compute_attention_weights': AttentionWeightsOp;
}
...
export interface GNNFunctions {
  'swarmvector.gcn_layer': GNNLayerOp;
  'swarmvector.gat_layer': GNNLayerOp;
  'swarmvector.sage_layer': GNNLayerOp;
  'swarmvector.message_passing': MessagePassingOp;
  'swarmvector.aggregate_neighbors': AggregateOp;
  'swarmvector.graph_pooling': PoolingOp;
}
...
export interface HyperbolicFunctions {
  'swarmvector.poincare_distance': HyperbolicDistanceOp;
  'swarmvector.lorentz_distance': HyperbolicDistanceOp;
  'swarmvector.exp_map': ExpMapOp;
  'swarmvector.log_map': LogMapOp;
  'swarmvector.mobius_add': MobiusOp;
  'swarmvector.parallel_transport': TransportOp;
  'swarmvector.hyperbolic_centroid': HyperbolicCentroidOp;
}
...
export interface EmbeddingFunctions {
  'swarmvector.embed_text': EmbedTextOp;
  'swarmvector.embed_batch': EmbedBatchOp;
  'swarmvector.embed_image': EmbedImageOp;
  'swarmvector.embed_chunk': EmbedChunkOp;
}
...
export interface QuantizationFunctions {
  'swarmvector.quantize_scalar': QuantizeOp;
  'swarmvector.quantize_product': ProductQuantizeOp;
  'swarmvector.dequantize': DequantizeOp;
  'swarmvector.binary_quantize': BinaryQuantizeOp;
}
...
export interface UtilityFunctions {
  'swarmvector.version': VersionOp;
  'swarmvector.config': ConfigOp;
  'swarmvector.stats': StatsOp;
  'swarmvector.health_check': HealthCheckOp;
  'swarmvector.vacuum_vectors': VacuumOp;
  'swarmvector.analyze_vectors': AnalyzeOp;
}
...
/**
 * SwarmVector statistics.
 */
export interface SwarmVectorStats {
  /** Version string */
...
/**
 * SwarmVector event types.
 */
export type SwarmVectorEventType =
  // Connection Events
  | 'connection:open'
  | 'connection:close'
  | 'connection:error'
 ...
 */
export interface SwarmVectorEvent<T extends SwarmVectorEventType = SwarmVectorEventType> {
  /** Event type */
  readonly type: T;
  /** Timestamp */
 ...
 * Event handler type.
 */
export type SwarmVectorEventHandler<T extends SwarmVectorEventType = SwarmVectorEventType> =
  (event: SwarmVectorEvent<T>) => void | Promise<void>;

/**
 * Event emitter interface.
 */
export interface SwarmVectorEventEmitter {
  on<T extends SwarmVectorEventType>(event: T, handler: SwarmVectorEventHandler<T>): () => void;
  off<T extends SwarmVectorEventType>(event: T, handler: SwarmVectorEventHandler<T>): void;
  once<T extends SwarmVectorEventType>(event: T, handler: SwarmVectorEventHandler<T>): () => void;
  emit<T extends SwarmVectorEventType>(event: T, data: EventDataMap[T]): void;
  removeAllListeners(event?: SwarmVectorEventType): void;
}
...
export interface ConnectionResult {
  ...
  /** SwarmVector extension version */
  readonly swarmVectorVersion: string;
...
/**
 * SwarmVector client configuration options.
 */
export interface SwarmVectorClientOptions extends SwarmVectorConfig {
  ...
  readonly eventHandlers?: Partial<{
    [K in SwarmVectorEventType]: SwarmVectorEventHandler<K>;
  }>;
  /** Custom logger */
  readonly logger?: SwarmVectorLogger;
}

/**
 * Logger interface.
 */
export interface SwarmVectorLogger {
...
/**
 * SwarmVector client interface.
 */
export interface ISwarmVectorClient extends SwarmVectorEventEmitter {
  ...
  // Transaction Support
  transaction<T>(fn: (tx: ISwarmVectorTransaction) => Promise<T>): Promise<TransactionResult<T>>;
 ...
 */
export interface ISwarmVectorTransaction {
...
/**
 * Factory function for creating SwarmVector clients.
 */
export type SwarmVectorClientFactory = (options: SwarmVectorClientOptions) => ISwarmVectorClient;

/**
 * Plugin registration type for the SwarmVector integration.
 */
export interface SwarmVectorPluginRegistration {
  /** Plugin name */
  readonly name: 'swarmvector';
  /** Plugin version */
  readonly version: string;
  /** Client factory */
  readonly createClient: SwarmVectorClientFactory;
  /** Supported features */
  readonly features: SwarmVectorFeature[];
}

/**
 * SwarmVector feature flags.
 */
export type SwarmVectorFeature =
  | 'vector_search'
  | 'hnsw_index'
  | 'ivf_index'
  | 'attention'
 ...
 */
export interface SwarmVectorSQLFunctions
 ...
 */
export namespace SwarmVector {
  export type Config = SwarmVectorConfig;
  export type Client = ISwarmVectorClient;
  export type ClientOptions = SwarmVectorClientOptions;
  ...
  export type Event = SwarmVectorEventType;
  export type EventData<T extends SwarmVectorEventType> = EventDataMap[T];
  export type Feature = SwarmVectorFeature;
}
