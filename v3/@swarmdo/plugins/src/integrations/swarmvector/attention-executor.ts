/**
 * SwarmVector PostgreSQL Bridge - Attention Executor and Factory
 *
 * Provides execution layer and factory for attention mechanisms.
 *
 * @module @swarmdo/plugins/integrations/swarmvector/attention-executor
 */
...
/**
 * Executes attention operations via PostgreSQL SwarmVector functions.
 */
...
export class AttentionSQLBuilder {
  ...
  constructor(schema: string = 'swarmvector') {
    this.schema = schema;
  }
