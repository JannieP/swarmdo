 ...
 *
 * Integration module for SwarmVector - a PostgreSQL extension providing
...
export { SwarmVectorBridge, createSwarmVectorBridge } from './swarmvector-bridge.js';
export { default as SwarmVectorBridgeDefault } from './swarmvector-bridge.js';
...
export type {
  ...
  SwarmVectorEvent,
  SwarmVectorEventHandler,
  SwarmVectorEventEmitter,
...
// Export namespace
export { SwarmVector } from './types.js';
