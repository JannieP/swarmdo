/**
 * SwarmVector PostgreSQL Bridge - Migration Manager
 *
 * Handles database migrations for the SwarmVector PostgreSQL integration.
 * Supports up/down migrations, rollback, and migration tracking.
 *
 * @module @swarmdo/plugins/integrations/swarmvector/migrations
 * @version 1.0.0
 */
...
/**
 * Manages database migrations for SwarmVector PostgreSQL Bridge
 */
