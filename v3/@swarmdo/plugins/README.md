...
[![npm version](https://img.shields.io/npm/v/@swarmdo/plugins.svg)](https://www.npmjs.com/package/@swarmdo/plugins)
[![npm downloads](https://img.shields.io/npm/dm/@swarmdo/plugins.svg)](https://www.npmjs.com/package/@swarmdo/plugins)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

**Unified Plugin SDK for Swarmdo V3**

A comprehensive plugin development framework providing workers, hooks, providers, and security utilities for building Swarmdo extensions.

## Installation

```bash
npm install @swarmdo/plugins
```
...
const myPlugin = new PluginBuilder('my-awesome-plugin', '1.0.0')
  .withDescription('My awesome plugin for Swarmdo')
...
import { getDefaultRegistry } from '@swarmdo/plugins';
...
```typescript
import { createToolPlugin, createHooksPlugin, createWorkerPlugin } from '@swarmdo/plugins';
...
```typescript
import { MCPToolBuilder } from '@swarmdo/plugins';
...
```typescript
import { HookBuilder, HookFactory, HookRegistry, HookEvent, HookPriority } from '@swarmdo/plugins';
...
```typescript
import { WorkerPool, WorkerFactory } from '@swarmdo/plugins';
...
```typescript
import { ProviderRegistry, ProviderFactory, BaseLLMProvider } from '@swarmdo/plugins';
...
```typescript
import { AgenticFlowBridge, AgentDBBridge } from '@swarmdo/plugins';
...
```typescript
import { Security, createRateLimiter, createResourceLimiter } from '@swarmdo/plugins';
