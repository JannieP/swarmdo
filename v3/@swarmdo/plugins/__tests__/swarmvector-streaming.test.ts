 ...
 *
 * @module @swarmdo/plugins/__tests__/swarmvector-streaming
 */
...
describe('SwarmVector Streaming', () => {
  ...
  describe('Streaming Search Results', () => {
    ...
    it('should support enrichment transforms', async () => {
      ...
      results.forEach((r) => {
        ...
        expect(r.metadata?.source).toBe('swarmvector');
      });
    });
  });
