...
[![npm version](https://img.shields.io/npm/v/@swarmdo/integration.svg)](https://www.npmjs.com/package/@swarmdo/integration)
...
```bash
npm install @swarmdo/integration
...
```typescript
import { AgenticFlowBridge, createAgenticFlowBridge } from '@swarmdo/integration';
...
- [@swarmdo/neural](../neural) - SONA learning module
- [@swarmdo/memory](../memory) - AgentDB memory
- [@swarmdo/performance](../performance) - Benchmarking
