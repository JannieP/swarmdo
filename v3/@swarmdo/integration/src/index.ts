/**
 * @swarmdo/integration - V3 Integration Module
 *
 ...
 * Usage:
 * ```typescript
 * import { createAgenticFlowBridge } from '@swarmdo/integration';
 *
...
export const METADATA = {
  name: '@swarmdo/integration',
  version: VERSION,
  description: 'Deep agentic-flow@alpha integration for swarmdo v3',
  implements: ['ADR-001'],
  features: [
