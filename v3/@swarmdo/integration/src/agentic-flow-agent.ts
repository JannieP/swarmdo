/**
 * AgenticFlowAgent - Swarmdo Agent with agentic-flow Delegation
 *
 * Per ADR-001: "Use agentic-flow's Agent base class for all agents"
 * This class wraps agentic-flow functionality while adding Swarmdo specifics.
 *
 * This implements the adapter pattern to bridge between:
 * - Swarmdo's agent lifecycle (v3 DDD architecture)
...
/**
 * AgenticFlowAgent - Base class for all Swarmdo v3 agents
 *
 * This class serves as the foundation for all agent types in Swarmdo v3,
