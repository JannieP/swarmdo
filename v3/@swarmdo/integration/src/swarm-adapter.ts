 ...
 * - Swarmdo v3 UnifiedSwarmCoordinator
...
// ============================================================================
// V3 Swarm Types (Source Interface from @swarmdo/swarm)
// ============================================================================

/**
 * V3 Topology types (from @swarmdo/swarm)
 */
export type V3TopologyType = 'mesh' | 'hierarchical' | 'centralized' | 'hybrid';

/**
 * V3 Agent Domain types (from @swarmdo/swarm)
 */
export type V3AgentDomain = 'queen' | 'security' | 'core' | 'integration' | 'support';

/**
 * V3 Agent State interface (simplified from @swarmdo/swarm)
 */
...
/**
 * V3 Task Definition interface (simplified from @swarmdo/swarm)
 */
 ...
 * Usage:
 * ```typescript
 * import { SwarmAdapter, createSwarmAdapter } from '@swarmdo/integration';
 *
