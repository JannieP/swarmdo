...
[![npm version](https://img.shields.io/npm/v/@swarmdo/testing.svg)](https://www.npmjs.com/package/@swarmdo/testing)
[![npm downloads](https://img.shields.io/npm/dm/@swarmdo/testing.svg)](https://www.npmjs.com/package/@swarmdo/testing)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![TDD](https://img.shields.io/badge/TDD-London%20School-purple.svg)](the upstream project (see NOTICE))
[![ADR-008](https://img.shields.io/badge/ADR--008-Vitest-green.svg)](https://vitest.dev/)

> Comprehensive testing framework for V3 Swarmdo modules. Implements London School TDD patterns with behavior verification, shared fixtures, and mock services.
...
```bash
npm install @swarmdo/testing vitest --save-dev
```
...
```typescript
import { createMockClock, measureTime } from '@swarmdo/testing';
...
```typescript
import { createTestEmitter } from '@swarmdo/testing';
...
```typescript
import { MockAgentDB } from '@swarmdo/testing';
...
```typescript
import { MockSwarmCoordinator } from '@swarmdo/testing';
...
```typescript
import { MockMCPClient, createStandardMockMCPClient } from '@swarmdo/testing';
...
```typescript
import { registerCustomMatchers } from '@swarmdo/testing';
...
```typescript
import { setupV3Tests, configureTestEnvironment } from '@swarmdo/testing';
...
```typescript
import { createSetupContext, createTestScope } from '@swarmdo/testing';
...
```typescript
import { createPerformanceTestHelper } from '@swarmdo/testing';
...
```typescript
import { assertV3PerformanceTargets, TEST_CONFIG } from '@swarmdo/testing';
