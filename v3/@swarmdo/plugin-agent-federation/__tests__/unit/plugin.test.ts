...
describe('AgentFederationPlugin', () => {
  ...
  describe('interface compliance', () => {
    it('should have name set to @swarmdo/plugin-agent-federation', () => {
      expect(plugin.name).toBe('@swarmdo/plugin-agent-federation');
    });
    ...
    it('should have author set to Swarmdo Team', () => {
      expect(plugin.author).toBe('Swarmdo Team');
    });

    it('should declare @swarmdo/security as a dependency', () => {
      expect(plugin.dependencies).toContain('@swarmdo/security');
    });

    it('should declare @swarmdo/aidefence as a dependency', () => {
      expect(plugin.dependencies).toContain('@swarmdo/aidefence');
    });
