...
[![npm version](https://img.shields.io/npm/v/@swarmdo/providers.svg)](https://www.npmjs.com/package/@swarmdo/providers)
...
- **6+ LLM Providers** - Anthropic, OpenAI, Google, Cohere, Ollama, SwarmVector
...
### SwarmVector
- Custom models via @swarmvector/swarmllm

## Installation

```bash
npm install @swarmdo/providers
```

## Quick Start

```typescript
import { createProviderManager } from '@swarmdo/providers';
...
```typescript
import { ProviderManager, createProviderManager } from '@swarmdo/providers';
...
- [@swarmdo/embeddings](../embeddings) - Embedding generation
- [@swarmdo/memory](../memory) - Vector storage and retrieval
