...
// Test configuration
const TEST_PROMPT = 'Say "Hello from Swarmdo V3!" in exactly 5 words.';
...
describe('Provider Integration Tests', () => {
  ...
  describe('SwarmVector Provider (swarmllm)', () => {
    ...
    it('should complete request with CPU-friendly Qwen model', async () => {
      ...
      try {
        ...
        console.log('SwarmVector/Ollama not available, test details:', error);
