...
[![npm version](https://img.shields.io/npm/v/@swarmdo/plugin-iot-cognitum.svg)](https://www.npmjs.com/package/@swarmdo/plugin-iot-cognitum)
[![npm downloads](https://img.shields.io/npm/dm/@swarmdo/plugin-iot-cognitum.svg)](https://www.npmjs.com/package/@swarmdo/plugin-iot-cognitum)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

IoT Cognitum Seed device-agent bridge — treat every Seed as a Swarmdo agent with hardware capabilities.
...
```bash
npx -y -p @swarmdo/plugin-iot-cognitum@latest cognitum-iot --help
```
...
```typescript
import { IoTCognitumPlugin } from '@swarmdo/plugin-iot-cognitum';
