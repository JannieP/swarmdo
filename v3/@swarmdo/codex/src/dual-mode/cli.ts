...
function createTemplateCommand(): Command {
  return new Command('templates')
    ...
    .action(() => {
      ...
      console.log('  Usage: npx swarmdo-codex dual run --template feature --task "Add user auth"');
      console.log();
      ...
      console.log('  Usage: npx swarmdo-codex dual run --template security --task "src/auth/"');
      console.log();
      ...
      console.log('  Usage: npx swarmdo-codex dual run --template refactor --task "src/legacy/"');
      console.log();
