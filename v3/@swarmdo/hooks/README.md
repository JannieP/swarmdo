...
[![npm version](https://img.shields.io/npm/v/@swarmdo/hooks.svg)](https://www.npmjs.com/package/@swarmdo/hooks)
[![npm downloads](https://img.shields.io/npm/dm/@swarmdo/hooks.svg)](https://www.npmjs.com/package/@swarmdo/hooks)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.3+-blue.svg)](https://www.typescriptlang.org/)
[![Node.js](https://img.shields.io/badge/Node.js-20+-green.svg)](https://nodejs.org/)

> Event-driven lifecycle hooks with ReasoningBank learning integration for Swarmdo V3

The `@swarmdo/hooks` package provides a comprehensive hooks system for intercepting and extending Swarmdo operations. It enables intelligent task routing, pattern learning, background metrics collection, and real-time statusline integration.
...
# Using pnpm
pnpm add @swarmdo/hooks

# Using yarn
yarn add @swarmdo/hooks
```
...
```typescript
import { initializeHooks } from '@swarmdo/hooks';
...
```typescript
import { hooksMCPTools, getHooksTool } from '@swarmdo/hooks';
...
swarmdo hooks worker detect --prompt "deep dive into auth" --auto-dispatch --min-confidence 0.6
...
|----------|-------------|---------|
| `SWARMDO_HOOK_TIMEOUT` | Hook execution timeout (ms) | `5000` |
| `SWARMDO_REASONINGBANK_ENABLED` | Enable ReasoningBank | `true` |
| `SWARMDO_HOOKS_NAMESPACE` | Learning namespace | `hooks-learning` |
| `SWARMDO_HOOKS_LOG_LEVEL` | Logging level | `info` |
| `SWARMDO_SHOW_HOOKS_METRICS` | Show hooks in statusline | `true` |
| `SWARMDO_SHOW_SWARM_ACTIVITY` | Show swarm in statusline | `true` |
| `SWARMDO_SHOW_PERFORMANCE` | Show performance targets | `true` |
...
- [@swarmdo/shared](../shared) - Shared utilities and types
- [@swarmdo/neural](../neural) - Neural network and SONA learning
- [@swarmdo/swarm](../swarm) - Multi-agent coordination
- [@swarmdo/memory](../memory) - AgentDB memory system

## License

MIT © [Swarmdo Team](https://github.com/ruvnet/claude-flow)
