...
Environment Variables:
  SWARMDO_STATUSLINE_REFRESH   Refresh interval in ms
  SWARMDO_SHOW_HOOKS_METRICS   Show hooks metrics (true/false)
  SWARMDO_SHOW_SWARM_ACTIVITY  Show swarm activity (true/false)
  SWARMDO_SHOW_PERFORMANCE     Show performance targets (true/false)
...
`);
  ...
  const generator = new StatuslineGenerator({
    enabled: true,
    refreshOnHook: true,
    showHooksMetrics: process.env.SWARMDO_SHOW_HOOKS_METRICS !== 'false',
    showSwarmActivity: process.env.SWARMDO_SHOW_SWARM_ACTIVITY !== 'false',
    showPerformance: process.env.SWARMDO_SHOW_PERFORMANCE !== 'false',
  });
