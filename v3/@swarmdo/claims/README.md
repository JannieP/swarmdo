...
[![npm version](https://img.shields.io/npm/v/@swarmdo/claims.svg)](https://www.npmjs.com/package/@swarmdo/claims)
[![npm downloads](https://img.shields.io/npm/dm/@swarmdo/claims.svg)](https://www.npmjs.com/package/@swarmdo/claims)
...
```bash
npm install @swarmdo/claims
```

Or install via Swarmdo CLI:

```bash
npx swarmdo plugins install @swarmdo/claims
```
...
```typescript
import { ClaimsService } from '@swarmdo/claims';
...
```bash
# Claim an issue
npx swarmdo claims claim --issue ISSUE-123 --claimant "human:alice"

# Release a claim
npx swarmdo claims release --issue ISSUE-123

# View claims board
npx swarmdo claims board

# List stealable issues
npx swarmdo claims stealable

# Rebalance workload
npx swarmdo claims rebalance --dry-run
```
