...
npx swarmdo sparc run debugger "fix authentication issues"

# For alpha features
npx swarmdo@alpha sparc run debugger "fix authentication issues"
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run debugger "fix authentication issues"
```
