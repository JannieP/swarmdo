...
npx swarmdo sparc run analyzer "analyze codebase performance"

# For alpha features
npx swarmdo@alpha sparc run analyzer "analyze codebase performance"
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run analyzer "analyze codebase performance"
```
