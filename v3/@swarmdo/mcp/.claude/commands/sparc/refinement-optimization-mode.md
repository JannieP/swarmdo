...
npx swarmdo sparc run refinement-optimization-mode "optimize database queries"

# For alpha features
npx swarmdo@alpha sparc run refinement-optimization-mode "optimize database queries"

# With namespace
npx swarmdo sparc run refinement-optimization-mode "your task" --namespace refinement-optimization-mode

# Non-interactive mode
npx swarmdo sparc run refinement-optimization-mode "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run refinement-optimization-mode "optimize database queries"
```
...
```bash
# Store mode-specific context
npx swarmdo memory store "refinement-optimization-mode_context" "important decisions" --namespace refinement-optimization-mode

# Query previous work
npx swarmdo memory query "refinement-optimization-mode" --limit 5
```
