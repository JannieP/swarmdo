...
npx swarmdo sparc run designer "create dashboard UI"

# For alpha features
npx swarmdo@alpha sparc run designer "create dashboard UI"
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run designer "create dashboard UI"
```
