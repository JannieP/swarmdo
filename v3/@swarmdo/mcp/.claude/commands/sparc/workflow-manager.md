...
npx swarmdo sparc run workflow-manager "automate deployment"

# For alpha features
npx swarmdo@alpha sparc run workflow-manager "automate deployment"
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run workflow-manager "automate deployment"
```
