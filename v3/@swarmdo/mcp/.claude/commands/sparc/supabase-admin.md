...
npx swarmdo sparc run supabase-admin "create user authentication schema"

# For alpha features
npx swarmdo@alpha sparc run supabase-admin "create user authentication schema"

# With namespace
npx swarmdo sparc run supabase-admin "your task" --namespace supabase-admin

# Non-interactive mode
npx swarmdo sparc run supabase-admin "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run supabase-admin "create user authentication schema"
```
...
```bash
# Store mode-specific context
npx swarmdo memory store "supabase-admin_context" "important decisions" --namespace supabase-admin

# Query previous work
npx swarmdo memory query "supabase-admin" --limit 5
```
