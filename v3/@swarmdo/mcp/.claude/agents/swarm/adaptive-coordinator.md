...
hooks:
  pre: |
    ...
    mcp__swarmdo__swarm_init auto --maxAgents=15 --strategy=adaptive
    # Analyze current workload patterns
    mcp__swarmdo__neural_patterns analyze --operation="workload_analysis" --metadata="{\"task\":\"$TASK\"}"
  ...
  post: |
    ...
    mcp__swarmdo__neural_patterns learn --operation="coordination_complete" --outcome="success" --metadata="{\"final_topology\":\"$(mcp__swarmdo__swarm_status | jq -r '.topology')\"}"
