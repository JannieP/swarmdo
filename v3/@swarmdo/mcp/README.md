...
[![npm version](https://img.shields.io/npm/v/@swarmdo/mcp.svg)](https://www.npmjs.com/package/@swarmdo/mcp)
[![npm downloads](https://img.shields.io/npm/dm/@swarmdo/mcp.svg)](https://www.npmjs.com/package/@swarmdo/mcp)
...
[![Standalone](https://img.shields.io/badge/Module-Standalone-green.svg)](the upstream project (see NOTICE))
...
- **Zero Dependencies** - No @swarmdo/* dependencies

## Installation

```bash
npm install @swarmdo/mcp
```

## Quick Start

```typescript
import { quickStart, defineTool } from '@swarmdo/mcp';
...
```typescript
import { createMCPServer } from '@swarmdo/mcp';
...
```typescript
import { createToolRegistry, defineTool } from '@swarmdo/mcp';
...
```typescript
import { createSessionManager } from '@swarmdo/mcp';
...
```typescript
import { createConnectionPool } from '@swarmdo/mcp';
...
```typescript
import { createMCPServer, createTextResource } from '@swarmdo/mcp';
...
```typescript
import { createMCPServer, definePrompt, textMessage, interpolate } from '@swarmdo/mcp';
