...
[![npm version](https://img.shields.io/npm/v/@swarmdo/security.svg)](https://www.npmjs.com/package/@swarmdo/security)
...
```typescript
import { createSecurityModule } from '@swarmdo/security';
...
```typescript
import { PasswordHasher, createPasswordHasher } from '@swarmdo/security';
...
```typescript
import { CredentialGenerator, generateCredentials } from '@swarmdo/security';
...
```typescript
import { SafeExecutor, createDevelopmentExecutor } from '@swarmdo/security';
...
```typescript
import { PathValidator, createProjectPathValidator } from '@swarmdo/security';
...
// Sanitize HTML
import { sanitizeHtml } from '@swarmdo/security';
...
```typescript
import { TokenGenerator, quickGenerate } from '@swarmdo/security';
...
```typescript
import { auditSecurityConfig } from '@swarmdo/security';
...
- [@swarmdo/swarm](../swarm) - Swarm coordination (secure agent spawning)
