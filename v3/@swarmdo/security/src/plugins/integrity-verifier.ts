 ...
 *
 * Implements P1 of ADR-145 (upstream/swarmdo#2254): Stage-1 Ed25519 signature
 ...
 * Threat model
 * ------------
 * Swarmdo's plugin install path fetches manifests from IPFS via Pinata with
 ...
 * - Backwards compatible: default mode is warn-only. `SWARMDO_STRICT_PLUGINS=true`
...
export interface TrustAnchor {
  ...
  /** Optional plugin id glob this anchor is authoritative for (e.g. `@swarmdo/*`). */
