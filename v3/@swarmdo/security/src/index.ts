...
// Tool-Output Guardrail (ADR-131 — closes OWASP ASI01 gap; upstream/swarmdo#2149)
export {
  ToolOutputGuardrail,
...
// Agent Authorization Propagation (ADR-144 P1 — upstream/swarmdo#2248)
...
// Plugin Integrity Verifier (ADR-145 P1 — upstream/swarmdo#2254)
