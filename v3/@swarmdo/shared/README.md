...
[![npm version](https://img.shields.io/npm/v/@swarmdo/shared.svg)](https://www.npmjs.com/package/@swarmdo/shared)
[![npm downloads](https://img.shields.io/npm/dm/@swarmdo/shared.svg)](https://www.npmjs.com/package/@swarmdo/shared)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Core](https://img.shields.io/badge/Module-Core-blue.svg)](the upstream project (see NOTICE))

> Shared utilities, types, and core infrastructure for Swarmdo V3 - the foundation module used by all other @swarmdo packages.
...
import { ... } from '@swarmdo/shared';

// Submodule exports (for tree-shaking or specific imports)
import { ... } from '@swarmdo/shared/types';      // Type definitions
import { ... } from '@swarmdo/shared/core';       // Config, interfaces, orchestrator
import { ... } from '@swarmdo/shared/events';     // Event sourcing (ADR-007)
import { ... } from '@swarmdo/shared/hooks';      // Hooks system
import { ... } from '@swarmdo/shared/mcp';        // MCP server infrastructure
import { ... } from '@swarmdo/shared/security';   // Security utilities
import { ... } from '@swarmdo/shared/resilience'; // Retry, circuit breaker, rate limiter
```
...
```typescript
import { EventBus, EventCoordinator } from '@swarmdo/shared/events';
...
```typescript
import { HooksManager, Hook } from '@swarmdo/shared/hooks';
...
```typescript
import { HealthMonitor, HealthCheck } from '@swarmdo/shared/core';
...
This package is a dependency of all other @swarmdo modules:

- [@swarmdo/cli](../cli) - CLI module
- [@swarmdo/security](../security) - Security & validation
- [@swarmdo/memory](../memory) - AgentDB & HNSW indexing
- [@swarmdo/neural](../neural) - SONA learning & RL algorithms
- [@swarmdo/performance](../performance) - Benchmarking & optimization
- [@swarmdo/swarm](../swarm) - 15-agent coordination
- [@swarmdo/integration](../integration) - agentic-flow@alpha bridge
- [@swarmdo/testing](../testing) - TDD framework & fixtures
- [@swarmdo/deployment](../deployment) - Release management
- [@swarmdo/embeddings](../embeddings) - Embedding service
- [@swarmdo/hooks](../hooks) - Hooks system
