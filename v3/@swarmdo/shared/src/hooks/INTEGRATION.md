...
```typescript
import { createEventBus } from '@swarmdo/shared/core';
import { createHookRegistry, createHookExecutor } from '@swarmdo/shared/hooks';
import { EventStore } from '@swarmdo/shared/events';
...
```typescript
import { HookEvent, HookContext } from '@swarmdo/shared/hooks';
...
import { Plugin } from '@swarmdo/shared';
import { HookEvent, HookPriority } from '@swarmdo/shared/hooks';
...
```typescript
// v3/@swarmdo/shared/src/mcp/tools/hooks.ts
