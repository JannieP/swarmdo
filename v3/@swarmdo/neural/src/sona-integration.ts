 ...
 *
 * Wraps @swarmvector/sona package for V3 usage with:
...
import { SonaEngine, type JsSonaConfig, type JsLearnedPattern } from '@swarmvector/sona';
import type {
  Trajectory,
  TrajectoryStep,
  TrajectoryVerdict,
...
/**
 * Convert V3 SONA mode to @swarmvector/sona config
 */
...
/**
 * SONA Learning Engine - wraps @swarmvector/sona for V3 usage
 *
 * Performance targets:
 * - learn(): <0.05ms
 * - adapt(): <0.1ms
