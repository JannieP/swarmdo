...
Already installed: `@swarmvector/sona@0.1.5`

## Basic Usage (30 seconds)

```typescript
import { createSONALearningEngine, getModeConfig } from '@swarmdo/neural';
...
**Location**: `/workspaces/swarmdo/v3/@swarmdo/neural/`

**Package**: `@swarmvector/sona@0.1.5`
