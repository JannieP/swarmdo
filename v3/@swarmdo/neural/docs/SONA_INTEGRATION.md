...
Integration of `@swarmvector/sona` package (v0.1.5) into the V3 Neural Module.
...
import { getModeConfig } from '@swarmdo/neural';
...
```typescript
import { SonaEngine, type JsSonaConfig } from '@swarmvector/sona';
...
- [SONA Package](https://www.npmjs.com/package/@swarmvector/sona)
