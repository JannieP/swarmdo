/**
 * @swarmdo/browser - Signed Trajectory Service (ADR-122 Phase 1)
 *
 ...
 * format for the binary RVF format from `@swarmvector/rvf@0.2.1` once we have
  ...
  const envelope = signTrajectory(
    {
      ...
      projectId: input.projectId ?? process.env.SWARMDO_PROJECT_ID ?? 'unknown',
      trajectory: {
