/**
 * @swarmdo/browser - Cookie Vault Service (ADR-122 Phase 3)
 *
 ...
 * Phase 3.5 swaps storage for an RVF cognitive container (`@swarmvector/rvf`).
...
export class CookieVaultService {
  ...
  constructor(options: CookieVaultServiceOptions = {}) {
    ...
    this.projectId = options.projectId ?? process.env.SWARMDO_PROJECT_ID ?? 'unknown';
