/**
 * @swarmdo/browser - Memory Integration
...
// ============================================================================
// Swarmdo Memory Adapter
// ============================================================================

/**
 * Adapter for swarmdo memory system with HNSW indexing
 */
export class ClaudeFlowMemoryAdapter implements IMemoryAdapter {
  ...
  async store(entry: BrowserMemoryEntry): Promise<void> {
    ...
    try {
      // This would call swarmdo memory_store MCP tool
