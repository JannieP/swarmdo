/**
 * @swarmdo/browser - MCP Tools
 * 50+ browser automation tools for swarmdo MCP server
 */
...
const MAX_EVAL_SCRIPT_LENGTH = parseInt(process.env.SWARMDO_MAX_EVAL_SCRIPT_LENGTH || '', 10) || DEFAULT_MAX_EVAL_SCRIPT_LENGTH;
