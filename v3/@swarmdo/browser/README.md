...
[![npm version](https://img.shields.io/npm/v/@swarmdo/browser?style=for-the-badge&logo=npm&color=blue)](https://www.npmjs.com/package/@swarmdo/browser)
[![npm downloads](https://img.shields.io/npm/dm/@swarmdo/browser?style=for-the-badge&logo=npm&color=cb3837)](https://www.npmjs.com/package/@swarmdo/browser)
...
**AI-Optimized Browser Automation for Swarmdo Swarms**

*Integrate [agent-browser](https://github.com/AugmentCode/agent-browser) with swarmdo for intelligent web automation, trajectory learning, security scanning, and multi-agent browser coordination.*
...
`@swarmdo/browser` provides a comprehensive browser automation layer for AI agents, combining Vercel Labs' `agent-browser` CLI with swarmdo's learning, memory, and security capabilities. It enables agents to navigate websites, fill forms, extract data, and learn from successful interaction patterns.
...
npm install @swarmdo/cli@^3.0.0-alpha
...
```typescript
import { createBrowserService, browserTools } from '@swarmdo/browser';
...
Register browser tools with swarmdo's MCP server:

```typescript
import { browserTools } from '@swarmdo/browser';
...
```typescript
import { createMemoryManager } from '@swarmdo/browser';
...
```typescript
import { listWorkflows, getWorkflow, getWorkflowManager } from '@swarmdo/browser';
...
```typescript
import { preBrowseHook, postBrowseHook, browserHooks } from '@swarmdo/browser';
...
```typescript
import { createBrowserSwarm } from '@swarmdo/browser';
...
```typescript
import { createBrowserService, getSecurityScanner } from '@swarmdo/browser';
