...
Swarmdo combines the missing parts.
...
| 2 | Causal-graph self-healing selectors | Surfer-H / Stagehand / Skyvern heal silently; swarmdo records *why* |
...
- Tracking issue: upstream/swarmdo#2041
