 ...
 * remaining 30 stay in @swarmdo/cli for now (they pull in heavy ML
 * deps — sona-optimizer, ewc-consolidation, swarmvector/*).
 *
 * If a session needs a hooks_* not in this list, it falls through to
 * @swarmdo/cli@alpha at the cost of one extra cold-cache hit.
 *
