...
```ts
import type { RunEvent } from '@swarmdo/guidance';
...
// Later, restore it
import { ProofChain } from '@swarmdo/guidance/proof';
...
```ts
import { createTruthAnchorStore } from '@swarmdo/guidance/truth-anchors';
