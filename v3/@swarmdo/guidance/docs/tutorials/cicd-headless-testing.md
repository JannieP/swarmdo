...
```ts
import { createComplianceSuite } from '@swarmdo/guidance/headless';
import type { TestTask } from '@swarmdo/guidance/headless';
...
```ts
import { createHeadlessRunner } from '@swarmdo/guidance/headless';
import { createLedger } from '@swarmdo/guidance/ledger';
...
import { createGuidanceControlPlane } from '@swarmdo/guidance';
import { createComplianceSuite } from '@swarmdo/guidance/headless';
...
```ts
import { createOptimizer } from '@swarmdo/guidance/optimizer';
...
```ts
import { createPersistentLedger, createEventStore } from '@swarmdo/guidance/persistence';

const store = createEventStore({ dataDir: './.swarmdo/guidance/events' });
...
// Event is now on disk at .swarmdo/guidance/events/
