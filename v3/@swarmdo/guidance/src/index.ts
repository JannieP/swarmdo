/**
 * @swarmdo/guidance - Guidance Control Plane
 *
 ...
 * - SwarmVector/HNSW for semantic shard retrieval
 *
 * @module @swarmdo/guidance
 */
...
export {
  ...
  createSwarmBotBridge,
  createAIDefenceGate,
  createSwarmBotMemoryAdapter,
} from './swarmbot-integration.js';
export type {
  SwarmBotInstance,
  SwarmBotAIDefenceGuard,
  SwarmBotMemory,
  AIDefenceThreat,
  AIDefenceResult,
  AIDefenceGateConfig,
  SwarmBotBridgeConfig,
  SwarmBotEvent,
} from './swarmbot-integration.js';
