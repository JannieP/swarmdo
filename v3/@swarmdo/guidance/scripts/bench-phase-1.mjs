#!/usr/bin/env node
/**
 * Phase 1 micro-benchmarks for the @swarmdo/guidance optimization
 ...
 *
 * Usage:
 *   node v3/@swarmdo/cli ... build first
 *   node v3/@swarmdo/guidance/scripts/bench-phase-1.mjs --tag=baseline
 *   node v3/@swarmdo/guidance/scripts/bench-phase-1.mjs --tag=phase-1
 *
