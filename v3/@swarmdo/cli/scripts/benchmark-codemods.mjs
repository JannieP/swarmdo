...
//   plugins/swarmdo-cost-tracker/docs/benchmarks/runs/codemod-<timestamp>.json
...
const RUNS_DIR = join(REPO_ROOT, 'plugins', 'swarmdo-cost-tracker', 'docs', 'benchmarks', 'runs');
...
async function main() {
  const { applyCodemod } = await import('../dist/src/swarmvector/codemods/engine.js');
