# Setting Up swarmdo-swarm Hooks
...
```bash
# Test pre-edit hook
npx swarmdo hook pre-edit --file test.js

# Test session summary
npx swarmdo hook session-end --summary
```
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [{
          "type": "command",
          "command": "npx swarmdo hook pre-write --file '${tool.params.file_path}'"
        }]
      }
    ]
  }
...
# Test specific hook
npx swarmdo hook pre-edit --file app.js --debug
```
