...
npx swarmdo sparc run batch-executor "process multiple files"

# For alpha features
npx swarmdo@alpha sparc run batch-executor "process multiple files"
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run batch-executor "process multiple files"
```
