...
npx swarmdo sparc run tutorial "guide me through SPARC methodology"

# For alpha features
npx swarmdo@alpha sparc run tutorial "guide me through SPARC methodology"

# With namespace
npx swarmdo sparc run tutorial "your task" --namespace tutorial

# Non-interactive mode
npx swarmdo sparc run tutorial "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run tutorial "guide me through SPARC methodology"
```
...
```bash
# Store mode-specific context
npx swarmdo memory store "tutorial_context" "important decisions" --namespace tutorial

# Query previous work
npx swarmdo memory query "tutorial" --limit 5
```
