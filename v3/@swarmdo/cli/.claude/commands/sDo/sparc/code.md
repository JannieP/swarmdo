...
npx swarmdo sparc run code "implement REST API endpoints"

# For alpha features
npx swarmdo@alpha sparc run code "implement REST API endpoints"

# With namespace
npx swarmdo sparc run code "your task" --namespace code

# Non-interactive mode
npx swarmdo sparc run code "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run code "implement REST API endpoints"
```
...
```bash
# Store mode-specific context
npx swarmdo memory store "code_context" "important decisions" --namespace code

# Query previous work
npx swarmdo memory query "code" --limit 5
```
