...
- `mcp__swarmdo__*` tools (preferred)
- `npx swarmdo` commands (as fallback)
...
1. **MCP Tool Usage**: All direct tool calls now use `mcp__swarmdo__*` format
...
The analysis directory is now fully compliant with the Swarmdo command standards.