...
swarmdo pair --start --agent senior-dev

# Start with verification
swarmdo pair --start --verify --threshold 0.98
```
...
```bash
swarmdo pair --start --mode switch --interval 10m
```
...
swarmdo pair --end --save

# End and generate report
swarmdo pair --end --report
```
...
swarmdo pair --start --git --review-commit
```

### With Testing Frameworks
```bash
# Jest integration
swarmdo pair --start --test-framework jest

# Pytest integration
swarmdo pair --start --test-framework pytest
```
...
Configure pair programming in `.swarmdo/config.json`:
