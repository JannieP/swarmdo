...
npx swarmdo sparc run spec-pseudocode "define payment flow requirements"

# For alpha features
npx swarmdo@alpha sparc run spec-pseudocode "define payment flow requirements"

# With namespace
npx swarmdo sparc run spec-pseudocode "your task" --namespace spec-pseudocode

# Non-interactive mode
npx swarmdo sparc run spec-pseudocode "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If swarmdo is installed locally
./swarmdo sparc run spec-pseudocode "define payment flow requirements"
```
...
```bash
# Store mode-specific context
npx swarmdo memory store "spec-pseudocode_context" "important decisions" --namespace spec-pseudocode

# Query previous work
npx swarmdo memory query "spec-pseudocode" --limit 5
```
