...
```
Tool: mcp__swarmdo__agent_spawn
Parameters: {
  "type": "architect",
  "name": "System Design",
...
### 4. Monitor Progress
```
Tool: mcp__swarmdo__task_status
...
npx swarmdo workflow dev "REST API with auth"

# Create custom workflow
npx swarmdo workflow create --name "api-dev" --steps "design,implement,test,deploy"

# Execute saved workflow
npx swarmdo workflow execute api-dev
```