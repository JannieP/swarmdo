...
## Usage
```bash
npx swarmdo neural train [options]
```
...
- **Location**: `.swarmdo/neural/patterns.json`
- **Stats**: `.swarmdo/neural/stats.json`
...
npx swarmdo neural train -p coordination -e 50

# Train with custom learning rate
npx swarmdo neural train -p optimization -l 0.005

# Train from file
npx swarmdo neural train -d ./training-data.json

# Quick training (10 epochs)
npx swarmdo neural train -e 10
```
...
npx swarmdo neural patterns --action list

# Search patterns by query
npx swarmdo neural patterns --action list -q "error handling"

# Analyze patterns
npx swarmdo neural patterns --action analyze -q "coordination"
```
