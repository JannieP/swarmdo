...
```bash
npx swarmdo agent logs <agent-id> [options]
```
...
```bash
# View last 50 lines
npx swarmdo agent logs coder-lx7m9k2

# View last 100 lines
npx swarmdo agent logs coder-lx7m9k2 -n 100

# Follow logs (live)
npx swarmdo agent logs coder-lx7m9k2 --follow

# Filter by level
npx swarmdo agent logs coder-lx7m9k2 -l error

# Logs since time
npx swarmdo agent logs coder-lx7m9k2 --since "1h"
npx swarmdo agent logs coder-lx7m9k2 --since "2026-01-08T10:00:00"

# JSON output
npx swarmdo agent logs coder-lx7m9k2 --format json
```
...
# Last 30 minutes
npx swarmdo agent logs coder-lx7m9k2 --since "30m"

# Specific timestamp
npx swarmdo agent logs coder-lx7m9k2 --since "2026-01-08T09:00:00"

# Today's logs
npx swarmdo agent logs coder-lx7m9k2 --since "today"
```
...
- `npx swarmdo agent status` - Current agent status
- `npx swarmdo agent health` - Health monitoring
- `npx swarmdo agent metrics` - Performance metrics
