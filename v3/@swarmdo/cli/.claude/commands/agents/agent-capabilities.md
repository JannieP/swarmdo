...
### Swarm Tools
```
hierarchical-coordinator: mcp__swarmdo__swarm_*, mcp__swarmdo__agent_*
mesh-coordinator: mcp__swarmdo__swarm_*, mcp__swarmdo__coordination_*
adaptive-coordinator: mcp__swarmdo__topology_*, mcp__swarmdo__swarm_*
```

### GitHub Tools
```
pr-manager: mcp__github__*, Bash (gh CLI)
code-review-swarm: mcp__github__*, mcp__swarmdo__swarm_*
release-manager: mcp__github__*, mcp__swarmdo__workflow_*
```
...
npx swarmdo agent spawn -t coder --help
