...
```bash
npx swarmdo agent health [agent-id] [options]
```
...
npx swarmdo agent health coder-lx7m9k2

# Continuous monitoring
npx swarmdo agent health --watch

# Custom interval
npx swarmdo agent health -w -i 10

# JSON output
npx swarmdo agent health --format json
```
...
- `npx swarmdo agent status` - Detailed agent info
- `npx swarmdo agent metrics` - Performance metrics
- `npx swarmdo doctor` - System-wide health
