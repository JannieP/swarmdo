...
hooks:
  pre_task: |
    ...
    npx swarmdo@v3alpha hook pre-task --mode repo-architect --analyze-structure
  post_edit: |
    echo "📐 Validating architecture changes and updating structure documentation..."
    npx swarmdo@v3alpha hook post-edit --mode repo-architect --validate-structure
  post_task: |
    echo "🏛️ Architecture task completed. Generating structure recommendations..."
    npx swarmdo@v3alpha hook post-task --mode repo-architect --generate-recommendations
  notification: |
    echo "📋 Notifying stakeholders of architecture improvements..."
    npx swarmdo@v3alpha hook notification --mode repo-architect
---
  ...
  files: [
    ...
    },
    {
      ...
      content: JSON.stringify({
        ...
        hooks: {
          pre_task: "npx swarmdo@v3alpha hook pre-task",
          post_edit: "npx swarmdo@v3alpha hook post-edit", 
          notification: "npx swarmdo@v3alpha hook notification"
        }
      }, null, 2)
    },
    {
