 ...
 * the hook system. Pure CJS — no ESM imports of @swarmdo/memory.
 *
 * Data files (all under .swarmdo/data/):
 ...
 * on @swarmdo/memory for the initial seed.
 */
...
const CLIP_DEBUG = !!(process.env.SWARMDO_DEBUG || process.env.DEBUG);
