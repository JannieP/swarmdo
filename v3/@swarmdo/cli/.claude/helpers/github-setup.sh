...
# Setup GitHub integration for Swarmdo
...
echo "  - npx swarmdo github swarm"
echo "  - npx swarmdo repo analyze"
echo "  - npx swarmdo pr enhance"
echo "  - npx swarmdo issue triage"
