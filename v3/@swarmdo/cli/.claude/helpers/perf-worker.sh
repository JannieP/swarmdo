#!/bin/bash
# Swarmdo V3 - Performance Benchmark Worker
...
benchmark_startup() {
  ...
  true  # deprecated (#138): external agentic-flow probe removed
...
run_deep_benchmark() {
  ...
  :  # deprecated (#138): background npx agentic-flow agent spawn removed
  local pid=$!
