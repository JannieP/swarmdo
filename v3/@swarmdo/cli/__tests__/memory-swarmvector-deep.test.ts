/**
 * Deep Tests for Memory and SwarmVector Subsystems
 *
 * Covers:
...
describe('Memory Initializer', () => {
  ...
  describe('HNSW status', () => {
    ...
    // (`initialized`) from "@swarmvector/core capability present" (`available`).
    ...
    // whether @swarmvector/core is resolvable (env-dependent, so not hard-asserted).
  ...
  describe('generateEmbedding backend field', () => {
    const prevDisableBridge = process.env.SWARMDO_DISABLE_BRIDGE;

    afterEach(() => {
      vi.resetModules();
      vi.doUnmock('@huggingface/transformers');
      vi.doUnmock('@xenova/transformers');
      vi.doUnmock('swarmvector');
...
// pull in the optional native @swarmvector/sona engine. Without the binary
...
describe('AST Analyzer', () => {
  ...
  beforeEach(async () => {
    const { ASTAnalyzer } = await import('../src/swarmvector/ast-analyzer.js');
...
`;
  ...
  describe('createASTAnalyzer factory', () => {
    it('should create analyzer with custom config', async () => {
      const { createASTAnalyzer } = await import('../src/swarmvector/ast-analyzer.js');
...
describe('Diff Classifier', () => {
  ...
  beforeEach(async () => {
    const { DiffClassifier } = await import('../src/swarmvector/diff-classifier.js');
...
`;
  ...
  describe('assessFileRisk', () => {
    it('should assess security files as high risk', async () => {
      const { assessFileRisk } = await import('../src/swarmvector/diff-classifier.js');
  ...
  describe('assessOverallRisk', () => {
    it('should compute overall risk from file risks', async () => {
      const { assessOverallRisk } = await import('../src/swarmvector/diff-classifier.js');
      const files = [
  ...
  describe('validateGitRef', () => {
    it('should reject refs with shell metacharacters', async () => {
      const mod = await import('../src/swarmvector/diff-classifier.js');
...
describe('Coverage Router', () => {
  ...
  beforeEach(async () => {
    const { CoverageRouter } = await import('../src/swarmvector/coverage-router.js');
...
end_of_record`;
  ...
  describe('clearCoverageCache', () => {
    it('should clear cache without error', async () => {
      const { clearCoverageCache, getCoverageCacheStats } = await import('../src/swarmvector/coverage-router.js');
      clearCoverageCache();
...
describe('Graph Analyzer', () => {
  describe('detectCircularDependencies', () => {
    it('should detect simple cycles', async () => {
      const { detectCircularDependencies } = await import('../src/swarmvector/graph-analyzer.js');
      const graph = {
        nodes: new Map([
  ...
  describe('fallbackMinCut', () => {
    it('should partition graph into two groups', async () => {
      const { fallbackMinCut } = await import('../src/swarmvector/graph-analyzer.js');
      const nodes = ['a', 'b', 'c', 'd'];
  ...
  describe('fallbackLouvain', () => {
    it('should detect communities in connected graph', async () => {
      const { fallbackLouvain } = await import('../src/swarmvector/graph-analyzer.js');
      const nodes = ['a', 'b', 'c', 'd'];
      const edges: Array<[string, string, number]> = [
        ['a', 'b', 10],
        ['c', 'd', 10],
  ...
  describe('exportToDot', () => {
    it('should generate valid DOT format', async () => {
      const { exportToDot } = await import('../src/swarmvector/graph-analyzer.js');
      const result = {
        graph: {
          nodes: new Map([
  ...
  describe('clearGraphCaches / getGraphCacheStats', () => {
    it('should clear and report cache', async () => {
      const { clearGraphCaches, getGraphCacheStats } = await import('../src/swarmvector/graph-analyzer.js');
      clearGraphCaches();
...
describe('Q-Learning Router', () => {
  ...
  beforeEach(async () => {
    const { QLearningRouter } = await import('../src/swarmvector/q-learning-router.js');
  ...
  describe('export / import', () => {
    it('should export and import Q-table', async () => {
      ...
      const mod = await import('../src/swarmvector/q-learning-router.js');
  ...
  describe('createQLearningRouter factory', () => {
    it('should create router with defaults', async () => {
      const { createQLearningRouter } = await import('../src/swarmvector/q-learning-router.js');
...
describe('Registry API', () => {
  ...
  it('should reject invalid ratings', async () => {
    const api = await import('../src/services/registry-api.js');
    await expect(api.rateItem('@swarmdo/test', 0)).rejects.toThrow('Rating must be integer 1-5');
    await expect(api.rateItem('@swarmdo/test', 6)).rejects.toThrow('Rating must be integer 1-5');
  });

  it('should reject non-integer ratings', async () => {
    const api = await import('../src/services/registry-api.js');
    await expect(api.rateItem('@swarmdo/test', 3.5)).rejects.toThrow('Rating must be integer 1-5');
  });
  ...
  it('should accept valid item IDs with scopes', async () => {
    ...
    try {
      await api.getRating('@swarmdo/test-plugin', 'plugin');
    } catch (e: any) {
...
// =============================================================================
// SwarmVector Index Module
// =============================================================================

describe('SwarmVector Index', () => {
  it('should export all major components', async () => {
    const swarmvector = await import('../src/swarmvector/index.js');
    expect(swarmvector.ASTAnalyzer).toBeDefined();
    expect(swarmvector.DiffClassifier).toBeDefined();
    expect(swarmvector.CoverageRouter).toBeDefined();
    expect(swarmvector.QLearningRouter).toBeDefined();
    expect(swarmvector.createASTAnalyzer).toBeDefined();
    expect(swarmvector.createDiffClassifier).toBeDefined();
    expect(swarmvector.createCoverageRouter).toBeDefined();
    expect(swarmvector.createQLearningRouter).toBeDefined();
  });

  it('should export factory functions', async () => {
    const swarmvector = await import('../src/swarmvector/index.js');
    expect(typeof swarmvector.createASTAnalyzer).toBe('function');
    expect(typeof swarmvector.createDiffClassifier).toBe('function');
    expect(typeof swarmvector.createCoverageRouter).toBe('function');
    expect(typeof swarmvector.createQLearningRouter).toBe('function');
  });

  it('should export isSwarmvectorAvailable', async () => {
    const swarmvector = await import('../src/swarmvector/index.js');
    expect(typeof swarmvector.isSwarmvectorAvailable).toBe('function');
    const available = await swarmvector.isSwarmvectorAvailable();
    expect(typeof available).toBe('boolean');
  });

  it('should export graph analyzer utilities', async () => {
    const swarmvector = await import('../src/swarmvector/index.js');
    expect(typeof swarmvector.detectCircularDependencies).toBe('function');
    expect(typeof swarmvector.fallbackMinCut).toBe('function');
    expect(typeof swarmvector.fallbackLouvain).toBe('function');
    expect(typeof swarmvector.exportToDot).toBe('function');
  });

  it('should export diff analysis tools', async () => {
    const swarmvector = await import('../src/swarmvector/index.js');
    expect(typeof swarmvector.assessFileRisk).toBe('function');
    expect(typeof swarmvector.assessOverallRisk).toBe('function');
    expect(typeof swarmvector.classifyDiff).toBe('function');
  });

  it('should export cache control functions', async () => {
    const swarmvector = await import('../src/swarmvector/index.js');
    expect(typeof swarmvector.clearDiffCache).toBe('function');
    expect(typeof swarmvector.clearAllDiffCaches).toBe('function');
    expect(typeof swarmvector.clearCoverageCache).toBe('function');
    expect(typeof swarmvector.clearGraphCaches).toBe('function');
  });
});
