...
} from '../../src/swarmvector/graph-analyzer.js';
import { mkdir, writeFile, rm } from 'fs/promises';
import { join } from 'path';
import { tmpdir } from 'os';

// Mock the @swarmvector/wasm module
...
describe('Graph Analyzer', () => {
  ...
  describe('loadSwarmVector', () => {
    it('should return null when swarmvector is not installed', async () => {
      const result = await loadSwarmVector();
      // Returns null or ISwarmVectorGraph interface
