/**
 * Tests for swarmllm-wasm integration module.
 * Mocks @swarmvector/swarmllm-wasm since it may not be installed in CI.
 */
...
vi.mock('@swarmvector/swarmllm-wasm', () => ({
  default: vi.fn(),
  initSync: vi.fn(),
  SwarmLLMWasm: class {
    initialize = vi.fn();
...
vi.mock('node:module', () => ({
  createRequire: vi.fn().mockReturnValue({
    resolve: vi.fn().mockReturnValue('/fake/path/swarmllm_wasm_bg.wasm'),
  }),
}));
...
// real `await import('@swarmvector/swarmllm-wasm')` still resolves to the actual
...
describe.skipIf(__SKIP_WASM_TESTS)('swarmllm-wasm integration', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  describe('isSwarmllmWasmAvailable', () => {
    it('should return true when module is available', async () => {
      const { isSwarmllmWasmAvailable } = await import('../../src/swarmvector/swarmllm-wasm.js');
      const available = await isSwarmllmWasmAvailable();
      expect(available).toBe(true);
    });
  });

  describe('getSwarmllmStatus', () => {
    it('should return status with version', async () => {
      const { getSwarmllmStatus } = await import('../../src/swarmvector/swarmllm-wasm.js');
      const status = await getSwarmllmStatus();
  ...
  describe('createHnswRouter', () => {
    it('should create router with dimensions and maxPatterns', async () => {
      const { createHnswRouter } = await import('../../src/swarmvector/swarmllm-wasm.js');
    ...
    it('should enforce HNSW_MAX_SAFE_PATTERNS limit', async () => {
      const { createHnswRouter, HNSW_MAX_SAFE_PATTERNS } = await import('../../src/swarmvector/swarmllm-wasm.js');
  ...
  describe('createSonaInstant', () => {
    it('should create with default config', async () => {
      const { createSonaInstant } = await import('../../src/swarmvector/swarmllm-wasm.js');
  ...
  describe('createMicroLora', () => {
    it('should create with config', async () => {
      const { createMicroLora } = await import('../../src/swarmvector/swarmllm-wasm.js');
  ...
  describe('formatChat', () => {
    it('should format with preset template', async () => {
      const { formatChat } = await import('../../src/swarmvector/swarmllm-wasm.js');
  ...
  describe('createKvCache', () => {
    it('should create with defaults', async () => {
      const { createKvCache } = await import('../../src/swarmvector/swarmllm-wasm.js');
  ...
  describe('createGenerateConfig', () => {
    it('should create config JSON', async () => {
      const { createGenerateConfig } = await import('../../src/swarmvector/swarmllm-wasm.js');
  ...
  describe('createBufferPool', () => {
    it('should create with capacity', async () => {
      const { createBufferPool } = await import('../../src/swarmvector/swarmllm-wasm.js');
  ...
  describe('createInferenceArena', () => {
    it('should create with raw capacity', async () => {
      const { createInferenceArena } = await import('../../src/swarmvector/swarmllm-wasm.js');
  ...
  describe('HNSW_MAX_SAFE_PATTERNS', () => {
    it('should be 1024', async () => {
      const { HNSW_MAX_SAFE_PATTERNS } = await import('../../src/swarmvector/swarmllm-wasm.js');
