/**
 * Tests for @swarmvector/rvagent-wasm integration module
 *
...
const mockTemplates = [
  { id: 'coder', name: 'Coder Agent', description: 'Coding assistant', category: 'development', tags: ['code'], version: '1.0.0', author: 'SwarmVector', builtin: true },
  { id: 'tester', name: 'Testing Agent', description: 'QA agent', category: 'testing', tags: ['test'], version: '1.0.0', author: 'SwarmVector', builtin: true },
];
...
vi.mock('@swarmvector/rvagent-wasm', () => ({
...
} from '../../src/swarmvector/agent-wasm.js';
