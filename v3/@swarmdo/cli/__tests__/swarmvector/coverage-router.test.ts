...
import { CoverageRouter, createCoverageRouter, type CoverageReport, type FileCoverage } from '../../src/swarmvector/coverage-router';

// Mock the @swarmvector/coverage module
