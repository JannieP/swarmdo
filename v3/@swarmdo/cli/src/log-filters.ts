 ...
 *    libraries (swarmvector ONNX loader, swarmvector-onnx-embeddings-wasm
 ...
 *    agentdb's embedder to delegate to our working swarmvector ONNX pipeline
 ...
 * point so the patch is in place before agentic-flow / swarmvector / agentdb
...
const STDERR_REDIRECT_PREFIXES = [
  'Loading model: ',                // swarmvector + swarmvector-onnx-embeddings-wasm loader.js
  '  Downloading: ',                // swarmvector + swarmvector-onnx-embeddings-wasm loader.js
  '  Cache hit: ',                  // swarmvector + swarmvector-onnx-embeddings-wasm loader.js
  'Model cache cleared',            // swarmvector + swarmvector-onnx-embeddings-wasm loader.js
  '🚀 Initializing ',               // swarmvector-onnx-embeddings-wasm parallel-embedder.mjs
  '✅ ',                            // swarmvector-onnx-embeddings-wasm parallel-embedder.mjs (workers ready)
  '  Disk cache hit: ',             // swarmvector-onnx-embeddings-wasm parallel-embedder.mjs
];
