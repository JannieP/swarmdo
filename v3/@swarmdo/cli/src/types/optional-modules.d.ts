...
declare module 'swarmvector' {
  const swarmvector: any;
  export default swarmvector;
  export const VectorDB: any;
  export const VectorDb: any;
  export function isWasm(): boolean;

  // ONNX Embedder (swarmvector >= 0.2.15, bundled MiniLM-L6-v2)
  ...
  // AdaptiveEmbedder (swarmvector >= 0.2.16, LoRA B=0 fix — identity when untrained)
...
declare module '@swarmvector/core' {
  const core: any;
  export default core;
}

declare module '@swarmvector/rvagent-wasm' {
...
declare module '@swarmvector/swarmllm-wasm' {
  export default function init(): Promise<void>;
  ...
  export class SwarmLLMWasm {
    ...
    getPoolStats(): string;
    reset(): void;
    // NOTE: version() is NOT on SwarmLLMWasm — use standalone getVersion()
  }
...
// Optional @swarmdo sibling packages (installed separately)
// Using permissive `any` types since these are runtime-resolved optional deps
declare module '@swarmdo/embeddings' {
  const mod: any;
  export default mod;
...
declare module '@swarmdo/aidefence' {
