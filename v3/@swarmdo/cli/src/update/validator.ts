...
// Known compatibility matrix between @swarmdo packages
const COMPATIBILITY_MATRIX: Record<string, Record<string, PackageCompatibility>> = {
  '@swarmdo/cli': {
    '@swarmdo/embeddings': { minVersion: '3.0.0-alpha.1' },
    '@swarmdo/security': { minVersion: '3.0.0-alpha.1' },
    '@swarmdo/integration': { minVersion: '3.0.0-alpha.1' },
  },
  '@swarmdo/embeddings': {
    '@swarmdo/cli': { minVersion: '3.0.0-alpha.50' },
  },
  '@swarmdo/integration': {
    '@swarmdo/cli': { minVersion: '3.0.0-alpha.70' },
