 ...
 *
 * Usage:
 *   npx @swarmdo/cli headless --worker <type>
 *   npx @swarmdo/cli headless --daemon
 *   npx @swarmdo/cli headless --benchmark
 *
 * Environment:
 *   SWARMDO_HEADLESS=true
...
function showHelp(): void {
  console.log(`
Headless Runtime for Swarmdo V3
...
Environment:
  SWARMDO_HEADLESS=true   Enable headless mode
...
async function runBenchmarks(): Promise<BenchmarkResults> {
  console.log('=== Swarmdo V3 Performance Benchmarks ===\n');
...
async function showStatus(): Promise<void> {
  console.log('=== Swarmdo V3 System Status ===\n');
  ...
  console.log('\nEnvironment:');
  console.log(`  SWARMDO_HEADLESS: ${process.env.SWARMDO_HEADLESS || 'not set'}`);
...
async function main(): Promise<void> {
  ...
  process.env.SWARMDO_HEADLESS = 'true';
