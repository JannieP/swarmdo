...
import {
  ...
  type DiffFile,
  type RiskLevel,
} from '../swarmvector/diff-classifier.js';
...
export const analyzeDiffTool: MCPTool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      useSwarmVector: {
        type: 'boolean',
        description: 'Attempt to use swarmvector for analysis (graceful fallback if unavailable)',
        default: true,
      },
    },
  },
  handler: async (params: Record<string, unknown>) => {
    ...
    const useSwarmVector = params.useSwarmVector !== false;
