...
async function main() {
  ...
  if (failed === 0) {
    ...
    console.log('    npx @swarmdo/cli patterns list');
    console.log('    npx @swarmdo/cli patterns list --featured');
    console.log('    npx @swarmdo/cli patterns search -q "agent"');
    console.log('    npx @swarmdo/cli patterns info -n <pattern-id>');
    console.log('');
  }
