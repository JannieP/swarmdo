 ...
 *  - Update plugins/swarmdo-workflows/commands/gaia-run.md with --enable-critic flag.
 *  - Update plugins/swarmdo-workflows/skills/gaia-debugging/SKILL.md: add critic
