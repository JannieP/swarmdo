...
export const DEFAULT_PLUGIN_STORE_CONFIG: PluginStoreConfig = {
  registries: [
    {
      ...
      description: 'Official Swarmdo plugin registry',
  ...
  defaultRegistry: 'swarmdo-official',
  gateway: 'https://gateway.pinata.cloud',
  timeout: 30000,
  cacheDir: '.swarmdo/plugins/cache',
...
export class PluginDiscoveryService {
  ...
  private async createDemoRegistryAsync(registry: KnownPluginRegistry): Promise<PluginDiscoveryResult> {
    ...
    const demoRegistry: PluginRegistry = {
      ...
      totalDownloads: plugins.reduce((sum, p) => sum + p.downloads, 0),
      totalAuthors: 1,
      featured: ['@swarmdo/plugin-iot-cognitum', '@swarmdo/plugin-agent-federation', '@swarmdo/plugin-agentic-qe', '@swarmdo/plugin-prime-radiant', '@swarmdo/security', '@swarmdo/claims', '@swarmdo/teammate-plugin'],
      trending: ['@swarmdo/plugin-iot-cognitum', '@swarmdo/plugin-agent-federation', '@swarmdo/plugin-agentic-qe', '@swarmdo/plugin-prime-radiant'],
      newest: ['@swarmdo/plugin-iot-cognitum', '@swarmdo/plugin-agent-federation', '@swarmdo/plugin-agentic-qe', '@swarmdo/plugin-prime-radiant'],
      official: ['@swarmdo/plugin-iot-cognitum', '@swarmdo/plugin-agent-federation', '@swarmdo/plugin-agentic-qe', '@swarmdo/plugin-prime-radiant', '@swarmdo/security', '@swarmdo/claims'],
      compatibilityMatrix: [
        { pluginId: '@swarmdo/neural', pluginVersion: '3.0.0', claudeFlowVersions: ['3.x'], tested: true },
        { pluginId: '@swarmdo/security', pluginVersion: '3.0.0', claudeFlowVersions: ['3.x'], tested: true },
      ],
    };
    ...
    return [
      {
        ...
        dependencies: [{ name: '@swarmdo/core', version: '^3.0.0' }],
        type: 'core',
      ...
      {
        id: '@swarmdo/embeddings',
        name: '@swarmdo/embeddings',
        ...
        minClaudeFlowVersion: '3.0.0',
        dependencies: [
          { name: '@swarmdo/core', version: '^3.0.0' },
      ...
      {
        id: '@swarmdo/performance',
        name: '@swarmdo/performance',
      ...
      },
      {
        ...
        description: 'Analytics and metrics visualization for Swarmdo operations',
        version: '1.2.0',
      ...
      {
        id: '@swarmdo/plugins',
        name: '@swarmdo/plugins',
        displayName: 'Plugin SDK',
        description: 'Unified Plugin SDK for Swarmdo V3 - Worker, Hook, and Provider Integration. Create, test, and publish Swarmdo plugins.',
      ...
      {
        id: '@swarmdo/plugin-prime-radiant',
        name: '@swarmdo/plugin-prime-radiant',
      ...
      {
        id: '@swarmdo/plugin-healthcare-clinical',
      ...
      {
        id: '@swarmdo/plugin-financial-risk',
      ...
      {
        id: '@swarmdo/plugin-legal-contracts',
        name: '@swarmdo/plugin-legal-contracts',
      ...
      {
        id: '@swarmdo/plugin-code-intelligence',
      ...
      {
        id: '@swarmdo/plugin-test-intelligence',
      ...
      {
        id: '@swarmdo/plugin-perf-optimizer',
      ...
      {
        id: '@swarmdo/plugin-neural-coordination',
        name: '@swarmdo/plugin-neural-coordination',
      ...
      {
        id: '@swarmdo/plugin-quantum-optimizer',
      ...
      {
        id: '@swarmdo/plugin-hyperbolic-reasoning',
      ...
      {
        id: '@swarmdo/plugin-gastown-bridge',
      ...
      {
        id: '@swarmdo/plugin-agent-federation',
        name: '@swarmdo/plugin-agent-federation',
        ...
        minClaudeFlowVersion: '3.0.0',
        dependencies: [{ name: '@swarmdo/security', version: '^3.0.0' }],
        type: 'integration',
      ...
      {
        id: '@swarmdo/plugin-iot-cognitum',
        name: '@swarmdo/plugin-iot-cognitum',
        displayName: 'IoT Cognitum',
        description: 'Cognitum Seed device-agent bridge — treat every Seed as a Swarmdo agent with 5-tier trust scoring, Ed25519 witness chains, mesh networking, and fleet management.',
        version: '1.0.0-alpha.1',
        ...
        minClaudeFlowVersion: '3.0.0',
        dependencies: [
          { name: '@swarmdo/shared', version: '^3.0.0' },
      ...
      {
        id: '@swarmdo/teammate-plugin',
        name: '@swarmdo/teammate-plugin',
  ...
  private async getDemoPluginsWithStats(): Promise<PluginEntry[]> {
    ...
    const realNpmPackages = [
      '@swarmdo/plugin-agentic-qe',
      '@swarmdo/plugin-prime-radiant',
      '@swarmdo/claims',
      '@swarmdo/security',
      '@swarmdo/plugins',
      '@swarmdo/embeddings',
