...
async function demo() {
  ...
  if (pluginCreator) {
    ...
    console.log('   $ swarmdo plugins install -n plugin-creator');
    console.log('');
  }
  ...
  console.log('   $ swarmdo plugins list              # List all plugins');
  console.log('   $ swarmdo plugins list --official   # Official only');
  console.log('   $ swarmdo plugins search -q neural  # Search plugins');
  console.log('   $ swarmdo plugins info -n plugin-creator');
  console.log('   $ swarmdo plugins install -n plugin-creator');
  console.log('');
}
