...
const preEditCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks pre-edit -f src/utils.ts', description: 'Get context before editing' },
    { command: 'swarmdo hooks pre-edit -f src/api.ts -o refactor', description: 'Pre-edit with operation type' }
  ],
...
const postEditCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks post-edit -f src/utils.ts --success true', description: 'Record successful edit' },
    { command: 'swarmdo hooks post-edit -f src/api.ts --success false -o "Type error"', description: 'Record failed edit' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    // Default file to 'unknown' for backward compatibility (env var may be empty)
    const filePath = (ctx.flags.file as string) || ctx.args[0] || 'unknown';
...
const preCommandCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks pre-command -c "rm -rf dist"', description: 'Assess command risk' },
    { command: 'swarmdo hooks pre-command -c "npm install lodash"', description: 'Check package install' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const postCommandCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks post-command -c "npm test" --success true', description: 'Record successful test run' },
    { command: 'swarmdo hooks post-command -c "npm build" --success false -e 1', description: 'Record failed build' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const command = (ctx.flags.command as string) || ctx.args[0];
...
const routeCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks route -t "Fix authentication bug"', description: 'Route task to optimal agent' },
    { command: 'swarmdo hooks route -t "Optimize database queries" -K 5', description: 'Get top 5 suggestions' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const explainCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks explain -t "Fix authentication bug"', description: 'Explain routing decision' },
    { command: 'swarmdo hooks explain -t "Optimize queries" -a coder --verbose', description: 'Verbose explanation for specific agent' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const task = (ctx.flags.task as string) || ctx.args[0];
...
const pretrainCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks pretrain', description: 'Pretrain with embeddings indexing' },
    { command: 'swarmdo hooks pretrain -p ../my-project --depth deep', description: 'Deep analysis of specific project' },
    { command: 'swarmdo hooks pretrain --no-with-embeddings', description: 'Skip embedding indexing' },
    { command: 'swarmdo hooks pretrain --file-types ts,tsx,js', description: 'Index only TypeScript/JS files' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      output.writeln(output.dim('  Next step: Run "swarmdo hooks build-agents" to generate optimized configs'));
...
const buildAgentsCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks build-agents', description: 'Build all agent configs' },
    { command: 'swarmdo hooks build-agents --focus security -o ./config/agents', description: 'Build security-focused configs' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const metricsCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks metrics', description: 'View 24h metrics' },
    { command: 'swarmdo hooks metrics --period 7d --v3-dashboard', description: 'V3 metrics for 7 days' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const transferFromProjectCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks transfer from-project -s ../old-project', description: 'Transfer all patterns' },
    { command: 'swarmdo hooks transfer from-project -s ../prod --filter security -m 0.9', description: 'Transfer high-confidence security patterns' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const transferCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks transfer store list', description: 'List patterns from registry' },
    { command: 'swarmdo hooks transfer store search -q routing', description: 'Search patterns' },
    { command: 'swarmdo hooks transfer store download -p seraphine-genesis', description: 'Download pattern' },
    { command: 'swarmdo hooks transfer store publish', description: 'Publish pattern to registry' },
    { command: 'swarmdo hooks transfer from-project -s ../other-project', description: 'Transfer from project' },
  ],
  action: async (): Promise<CommandResult> => {
    ...
    output.writeln();
    output.writeln('Run "swarmdo hooks transfer <subcommand> --help" for details');
    return { success: true };
  }
};
...
const preTaskCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks pre-task -i task-123 -d "Fix auth bug"', description: 'Record task start' },
    { command: 'swarmdo hooks pre-task -i task-456 -d "Implement feature" --auto-spawn', description: 'With auto-spawn' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const postTaskCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks post-task -i task-123 --success true', description: 'Record successful completion' },
    { command: 'swarmdo hooks post-task -i task-456 --success false -q 0.3', description: 'Record failed task' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const sessionEndCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks session-end', description: 'End and save session' },
    { command: 'swarmdo hooks session-end --save-state false', description: 'End without saving' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const sessionRestoreCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks session-restore', description: 'Restore latest session' },
    { command: 'swarmdo hooks session-restore -i session-12345', description: 'Restore specific session' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const intelligenceCommand: Command = {
  name: 'intelligence',
  description: 'SwarmVector intelligence system (SONA, MoE, HNSW 150x faster)',
  options: [
    {
      name: 'mode',
      short: 'm',
  ...
  examples: [
    { command: 'swarmdo hooks intelligence --status', description: 'Show intelligence status' },
    { command: 'swarmdo hooks intelligence -m real-time', description: 'Enable real-time mode' },
    { command: 'swarmdo hooks intelligence --train', description: 'Force training cycle' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    output.writeln();
    output.writeln(output.bold('SwarmVector Intelligence System'));
    output.writeln();
...
const workerListCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks worker list', description: 'List all workers' },
    { command: 'swarmdo hooks worker list --active', description: 'Show active instances' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerDispatchCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks worker dispatch -t optimize -c src/', description: 'Dispatch optimize worker' },
    { command: 'swarmdo hooks worker dispatch -t audit -p critical', description: 'Security audit with critical priority' },
    { command: 'swarmdo hooks worker dispatch -t testgaps --sync', description: 'Test coverage analysis (sync)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      if (background) {
        output.writeln();
        output.writeln(output.dim(`Check status: swarmdo hooks worker status --id ${result.workerId}`));
      }
...
const workerStatusCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks worker status', description: 'Show running workers' },
    { command: 'swarmdo hooks worker status --id worker_audit_1', description: 'Check specific worker' },
    { command: 'swarmdo hooks worker status --all', description: 'Include completed workers' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerDetectCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks worker detect -p "optimize performance"', description: 'Detect triggers in prompt' },
    { command: 'swarmdo hooks worker detect -p "security audit" --auto-dispatch', description: 'Detect and dispatch' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerCancelCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks worker cancel --id worker_audit_1', description: 'Cancel specific worker' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const workerId = ctx.flags['id'] as string;
...
const coverageRouteCommand: Command = {
  name: 'coverage-route',
  description: 'Route task to agents based on test coverage gaps (swarmvector integration)',
  options: [
    {
      name: 'task',
      short: 't',
    ...
    {
      name: 'no-swarmvector',
      description: 'Disable swarmvector integration',
      type: 'boolean',
      default: false
    }
  ],
  examples: [
    { command: 'swarmdo hooks coverage-route -t "fix bug in auth"', description: 'Route with coverage awareness' },
    { command: 'swarmdo hooks coverage-route -t "add tests" --threshold 90', description: 'Route with custom threshold' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const task = (ctx.flags.task as string) || ctx.args[0];
    const threshold = ctx.flags.threshold as number || 80;
    const useSwarmvector = !ctx.flags['no-swarmvector'];
...
const coverageSuggestCommand: Command = {
  ...
  description: 'Suggest coverage improvements for a path (swarmvector integration)',
  options: [
    {
      name: 'path',
      short: 'p',
  ...
  examples: [
    { command: 'swarmdo hooks coverage-suggest -p src/', description: 'Suggest improvements for src/' },
    { command: 'swarmdo hooks coverage-suggest -p src/services --threshold 90', description: 'Stricter threshold' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      output.printBox(
        [
          ...
          `Branch Coverage: ${result.summary.overallBranchCoverage.toFixed(1)}%`,
          `Below Threshold: ${result.summary.filesBelowThreshold} files`,
          `SwarmVector: ${result.swarmvectorAvailable ? output.success('Available') : output.dim('Not installed')}`
        ].join('\n'),
        'Coverage Summary'
      );
...
const coverageGapsCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks coverage-gaps', description: 'List all coverage gaps' },
    { command: 'swarmdo hooks coverage-gaps --critical-only', description: 'Only critical gaps' },
    { command: 'swarmdo hooks coverage-gaps --threshold 90', description: 'Stricter threshold' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const threshold = ctx.flags.threshold as number || 80;
...
const progressHookCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks progress', description: 'Check current progress' },
    { command: 'swarmdo hooks progress -d', description: 'Detailed breakdown' },
    { command: 'swarmdo hooks progress --sync', description: 'Sync progress to file' },
    { command: 'swarmdo hooks progress --summary', description: 'Human-readable summary' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      if (sync) {
        ...
        output.writeln(output.dim(`  Persisted to .swarmdo/metrics/v3-progress.json`));
...
const workerCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks worker list', description: 'List all workers' },
    { command: 'swarmdo hooks worker dispatch -t optimize', description: 'Dispatch optimizer' },
    { command: 'swarmdo hooks worker detect -p "test coverage"', description: 'Detect from prompt' },
  ],
  action: async (): Promise<CommandResult> => {
    output.writeln();
    ...
    output.writeln();
    output.writeln('Run "swarmdo hooks worker <subcommand> --help" for details');
...
const statuslineCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks statusline', description: 'Display full statusline' },
    { command: 'swarmdo hooks statusline --json', description: 'JSON output for hooks' },
    { command: 'swarmdo hooks statusline --compact', description: 'Single-line status' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    function getSystemMetrics() {
      ...
      const learningJsonPaths = [
        path.join(process.cwd(), '.swarmdo', 'learning.json'),
        path.join(process.cwd(), '.claude', '.swarmdo', 'learning.json'),
      ...
      if (intelligencePct === 0) {
        ...
        if (fs.existsSync(path.join(process.cwd(), '.swarmdo'))) maturityScore += 15;
        if (fs.existsSync(path.join(process.cwd(), 'CLAUDE.md'))) maturityScore += 10;
        if (fs.existsSync(path.join(process.cwd(), 'swarmdo.config.json'))) maturityScore += 10;
    ...
    // Generate lines
    let header = `${c.bold}${c.brightPurple}▊ Swarmdo V3 ${c.reset}`;
    ...
    const dbPaths = [
      path.join(process.cwd(), '.swarm', 'memory.db'),
      path.join(process.cwd(), '.swarmdo', 'memory.db'),
      path.join(process.cwd(), '.claude', 'memory.db'),
      path.join(process.cwd(), 'data', 'memory.db'),
      path.join(process.cwd(), 'memory.db'),
      path.join(process.cwd(), '.agentdb', 'memory.db'),
      path.join(process.cwd(), '.swarmdo', 'memory', 'agentdb.db'),
    ];
    ...
    if (agentdbStats.vectorCount === 0) {
      const agentdbDirs = [
        path.join(process.cwd(), '.swarmdo', 'agentdb'),
    ...
    const hnswPaths = [
      path.join(process.cwd(), '.swarmdo', 'hnsw'),
    ...
    const vectorsPath = path.join(process.cwd(), '.swarmdo', 'vectors.json');
...
const routeTaskCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks route-task --auto-swarm true', description: 'Route with auto-swarm (v2 compat)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const sessionStartCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks session-start --auto-configure true', description: 'Start session (v2 compat)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const tokenOptimizeCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks token-optimize --stats', description: 'Show token savings stats' },
    { command: 'swarmdo hooks token-optimize -q "auth patterns"', description: 'Get compact context' },
    { command: 'swarmdo hooks token-optimize -A 8 --report', description: 'Config for 8 agents + report' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const modelRouteCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks model-route -t "fix typo"', description: 'Route simple task (likely haiku)' },
    { command: 'swarmdo hooks model-route -t "architect auth system"', description: 'Route complex task (likely opus)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const task = (ctx.flags.task as string) || ctx.args[0];
    if (!task) {
...
const modelOutcomeCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks model-outcome -t "fix typo" -m haiku -o success', description: 'Record successful haiku task' },
    { command: 'swarmdo hooks model-outcome -t "auth system" -m sonnet -o escalated', description: 'Record escalation to opus' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const modelStatsCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks model-stats', description: 'View routing stats' },
    { command: 'swarmdo hooks model-stats --detailed', description: 'Show detailed breakdown' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
      const result = await callMCPTool<{
...
const teammateIdleCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks teammate-idle --auto-assign true', description: 'Auto-assign tasks to idle teammate' },
    { command: 'swarmdo hooks teammate-idle -t worker-1 --check-task-list', description: 'Check tasks for specific teammate' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const taskCompletedCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks task-completed -i task-123 --train-patterns', description: 'Complete task and train patterns' },
    { command: 'swarmdo hooks task-completed -i task-456 --notify-lead --quality 0.95', description: 'Complete with quality score' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
export const hooksCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo hooks pre-edit -f src/utils.ts', description: 'Get context before editing' },
    { command: 'swarmdo hooks route -t "Fix authentication bug"', description: 'Route task to optimal agent' },
    { command: 'swarmdo hooks pretrain', description: 'Bootstrap intelligence from repository' },
    { command: 'swarmdo hooks metrics --v3-dashboard', description: 'View V3 performance metrics' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    output.writeln();
    ...
    output.writeln();
    output.writeln('Usage: swarmdo hooks <subcommand> [options]');
    output.writeln();
    output.writeln('Subcommands:');
    output.printList([
    ...
    output.writeln();
    output.writeln('Run "swarmdo hooks <subcommand> --help" for subcommand help');
    output.writeln();
