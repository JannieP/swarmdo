...
export const autopilotCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo autopilot status', description: 'Show current state and progress' },
    { command: 'swarmdo autopilot enable', description: 'Enable persistent completion' },
    { command: 'swarmdo autopilot config --max-iterations 100 --timeout 180', description: 'Configure limits' },
    { command: 'swarmdo autopilot predict', description: 'Get recommended next action' },
  ],
  action: async (): Promise<CommandResult> => {
