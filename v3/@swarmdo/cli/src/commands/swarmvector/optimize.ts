/**
 * V3 CLI SwarmVector Optimize Command
...
export const optimizeCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo swarmvector optimize --analyze', description: 'Analyze and show recommendations' },
    { command: 'swarmdo swarmvector optimize --apply', description: 'Apply optimizations' },
    { command: 'swarmdo swarmvector optimize --vacuum', description: 'Run VACUUM ANALYZE' },
    { command: 'swarmdo swarmvector optimize --reindex', description: 'Rebuild all indexes' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    output.writeln();
    output.writeln(output.bold('SwarmVector Optimization Analysis'));
    ...
    try {
      ...
      output.printBox([
        ...
        '',
        'Quick commands:',
        `  swarmdo swarmvector optimize --vacuum    # Clean up tables`,
        `  swarmdo swarmvector optimize --reindex  # Rebuild indexes`,
        `  swarmdo swarmvector optimize --apply    # Apply critical fixes`,
