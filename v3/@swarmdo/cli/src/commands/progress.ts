 ...
 *
 * @module @swarmdo/cli/commands/progress
 */
...
export const progressCommand: Command = {
  ...
  examples: [
    {
      command: 'swarmdo progress',
      description: 'Check current progress',
    },
    {
      command: 'swarmdo progress --detailed',
      description: 'Show detailed breakdown',
    },
    {
      command: 'swarmdo progress sync',
      description: 'Sync and persist progress',
    },
    {
      command: 'swarmdo progress watch',
      description: 'Watch for changes',
    },
    {
      command: 'swarmdo progress --json',
