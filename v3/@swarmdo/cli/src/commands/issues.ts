...
export const issuesCommand: Command = {
  ...
  examples: [
    { command: 'swarmdo issues list', description: 'List all claims' },
    { command: 'swarmdo issues claim 123 --agent coder:coder-1', description: 'Claim as agent' },
    { command: 'swarmdo issues handoff 123 --to agent:tester:tester-1', description: 'Handoff to tester' },
    { command: 'swarmdo issues stealable', description: 'List stealable' },
    { command: 'swarmdo issues steal 123 --agent coder:coder-2', description: 'Steal issue' },
    { command: 'swarmdo issues board', description: 'Visual board' },
  ],
