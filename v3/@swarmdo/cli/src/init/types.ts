...
export interface InitComponents {
  ...
  mcp: boolean;
  /** Create .swarmdo/ directory (V3 runtime) */
  runtime: boolean;
...
export interface MCPConfig {
  /** Include swarmdo MCP server */
  claudeFlow: boolean;
  /** Include swarmdo-swarm MCP server */
  swarmdoSwarm: boolean;
...
export interface InitOptions {
  ...
  /**
   * Skip the user-global ~/.claude/CLAUDE.md "Swarmdo Integration" pointer block.
