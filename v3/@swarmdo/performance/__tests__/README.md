...
Comprehensive test coverage for the `@swarmdo/performance` module, focusing on Flash Attention optimization and benchmark validation.
...
- V3 target validation (unverified (no benchmark))
