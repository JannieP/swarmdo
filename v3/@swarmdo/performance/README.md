...
[![npm version](https://img.shields.io/npm/v/@swarmdo/performance.svg)](https://www.npmjs.com/package/@swarmdo/performance)
[![npm downloads](https://img.shields.io/npm/dm/@swarmdo/performance.svg)](https://www.npmjs.com/package/@swarmdo/performance)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-Vitest-green.svg)](https://vitest.dev/)

> Comprehensive performance benchmarking module for Swarmdo V3 - statistical analysis, memory tracking, regression detection, and Flash Attention validation.
...
- **Flash Attention Validation** - Validate unverified (no benchmark) speedup targets
- **Multiple Output Formats** - Console, JSON, and programmatic access

## Installation

```bash
npm install @swarmdo/performance
```
...
```typescript
import { benchmark } from '@swarmdo/performance';
...
import type {
  ...
  ComparisonResult,
  PerformanceTarget
} from '@swarmdo/performance';
```

## Dependencies

- `@swarmvector/attention` - Flash Attention implementation
- `@swarmvector/sona` - SONA learning engine
- `vitest` - Test/benchmark runner

## Related Packages

- [@swarmdo/memory](../memory) - Memory operations to benchmark
- [@swarmdo/swarm](../swarm) - Swarm coordination to benchmark
- [@swarmdo/neural](../neural) - Neural operations to benchmark
