 ...
 *
 * Verifies @swarmvector/attention integration is working correctly.
 * Run with: npx tsx v3/@swarmdo/performance/src/examples/quick-test.ts
 */
...
async function quickTest() {
  ...
  try {
    // Test 1: Direct @swarmvector/attention usage
    console.log('\n✓ Test 1: Direct @swarmvector/attention usage');
