...
[![npm version](https://img.shields.io/npm/v/@swarmdo/deployment.svg)](https://www.npmjs.com/package/@swarmdo/deployment)
[![npm downloads](https://img.shields.io/npm/dm/@swarmdo/deployment.svg)](https://www.npmjs.com/package/@swarmdo/deployment)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![CI/CD](https://img.shields.io/badge/CI%2FCD-Automated-green.svg)](the upstream project (see NOTICE))
[![Semantic Release](https://img.shields.io/badge/Semantic-Release-brightgreen.svg)](https://semantic-release.gitbook.io/)

> Release management, CI/CD, and versioning module for Swarmdo v3.
...
```bash
npm install @swarmdo/deployment
```
...
```typescript
import { prepareRelease } from '@swarmdo/deployment';
...
```typescript
import { publishToNpm } from '@swarmdo/deployment';
...
```typescript
import { validate } from '@swarmdo/deployment';
...
```typescript
import { Publisher } from '@swarmdo/deployment';
...
```typescript
import { Validator } from '@swarmdo/deployment';
