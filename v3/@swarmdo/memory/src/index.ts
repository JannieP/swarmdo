/**
 * @swarmdo/memory - V3 Unified Memory System
 *
 ...
 *
 * @module @swarmdo/memory
 *
 * @example
 * ```typescript
 * import { UnifiedMemoryService, query, QueryTemplates } from '@swarmdo/memory';
 *
 ...
 *   continue to work through `@swarmdo/memory@3.0.0-rc`. Both names refer
 *   to the same class.
 *
 ...
 *
 * `MemoryService` is the preferred name as of `@swarmdo/memory@3.0.0-alpha.18`.
 ...
 * `import type { MemoryService } from '@swarmdo/memory'` works alongside the
 * value import.
 */
