/**
 * Vitest global setup — ADR-125 Phase 7 (SwarmVector boundary cleanup).
 *
 * The agentdb / @swarmvector/rvf native bindings write a `vector.db` redb file
 * (legacy pre-fork name: `swarmvector.db`) to the package's cwd as a side-effect
