...
/**
 * Base error class for all ruf-swarm MCP errors
 */
class RufSwarmError extends Error {
 ...
 */
class ValidationError extends RufSwarmError {
 ...
 */
class SwarmError extends RufSwarmError {
 ...
 */
class AgentError extends RufSwarmError {
 ...
 * Task-related errors
 */
class TaskError extends RufSwarmError {
 ...
 */
class NeuralError extends RufSwarmError {
 ...
 * WASM-related errors
 */
class WasmError extends RufSwarmError {
 ...
 */
class ConfigurationError extends RufSwarmError {
 ...
 */
class NetworkError extends RufSwarmError {
 ...
 */
class PersistenceError extends RufSwarmError {
 ...
 */
class ResourceError extends RufSwarmError {
 ...
 */
class ConcurrencyError extends RufSwarmError {
...
class ErrorFactory {
  ...
  static createError(type, message, details = {}) {
    ...
    default:
      return new RufSwarmError(message, 'GENERAL_ERROR', details);
    }
  }
...
class ErrorContext {
   ...
   */
  enrichError(error) {
    if (error instanceof RufSwarmError) {
      error.details = {
        ...error.details,
