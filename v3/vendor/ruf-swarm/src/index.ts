/**
 * RufSwarm - WASM-based swarm orchestration with cognitive diversity
 */
...
/**
 * Main RufSwarm class for orchestrating swarm operations
 */
export class RufSwarm implements SwarmEventEmitter {
  ...
  constructor(options: SwarmOptions = {}) {
    ...
    this.options = {
      ...
      wasmPath: options.wasmPath || './wasm/ruf_swarm_wasm.js',
    };
   ...
   */
  static async create(options?: SwarmOptions): Promise<RufSwarm> {
    const swarm = new RufSwarm(options);
    await swarm.init();
    return swarm;
  }
