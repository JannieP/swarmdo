# GitHub Coordinator for ruf-swarm
...
# Use the coordinator
npx ruf-swarm github-coordinate
...
{
  "hooks": {
    "pre-task": "npx ruf-swarm hook github pre-task",
    "post-edit": "npx ruf-swarm hook github post-edit",
    "post-task": "npx ruf-swarm hook github post-task"
  }
}
```
...
npx ruf-swarm github status

# List available tasks
npx ruf-swarm github tasks --available

# Claim a specific task
npx ruf-swarm github claim 123

# Release a task
npx ruf-swarm github release 123

# Show dashboard URLs
npx ruf-swarm github dashboard
```
