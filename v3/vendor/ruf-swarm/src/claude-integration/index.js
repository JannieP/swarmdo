...
class ClaudeIntegrationOrchestrator {
  constructor(options = {}) {
    this.options = {
      ...
      packageName: options.packageName || 'ruf-swarm',
      ...options,
    };
    ...
    try {
      ...
      if (this.options.autoSetup) {
        ...
        results.modules.core = {
          ...
          manualSetup: true,
          instructions: [
            'Run: claude mcp add ruf-swarm npx ruf-swarm mcp start',
            'Test with: mcp__ruf-swarm__agent_spawn',
          ],
        };
      }
      ...
      if (results.modules.core.manualSetup) {
        console.log('   1. claude mcp add ruf-swarm npx ruf-swarm mcp start');
        console.log('   2. Test with MCP tools: mcp__ruf-swarm__agent_spawn');
      } else {
