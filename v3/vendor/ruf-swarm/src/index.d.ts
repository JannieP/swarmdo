...
/**
 * Main RufSwarm class for neural network swarm orchestration
 */
export declare class RufSwarm {
  /** Swarm name */
  ...
  /**
   * Create a new RufSwarm instance
   * @param config Swarm configuration
   */
  constructor(config: SwarmConfig);

  /**
   * Initialize RufSwarm with WASM module
   * @param options Initialization options
   * @returns Initialized RufSwarm instance
   */
  static initialize(options?: InitOptions): Promise<RufSwarm>;
