/**
 * TypeScript definitions for enhanced ruf-swarm NPX package
 * Complete WASM integration with neural networks and forecasting
 */

declare module 'ruf-swarm' {
  // Main RufSwarm class
  export class RufSwarm {
    constructor();
    
    static initialize(options?: RufSwarmOptions): Promise<RufSwarm>;
  ...
  export interface RufSwarmOptions {
    wasmPath?: string;
