...
// ruf-swarm — renamed fork of ruv-swarm@1.0.20 (github.com/ruvnet/ruv-FANN),
// the optional MCP swarm server (`npx ruf-swarm mcp start`; tools surface as
// mcp__ruf-swarm__*). Upstream quirks preserved verbatim: the main module
...
test('bin prints a semver version (then killed — upstream never exits)', async () => {
  const child = spawn('node', [join(pkgDir, 'bin/ruf-swarm-secure.js'), '--version']);
  let out = '';
