...
```html
<script type="module">
import init, { SimdVectorOps } from 'https://unpkg.com/ruf-swarm-wasm/ruf_swarm_wasm.js';
...
```javascript
import init, { SimdVectorOps } from 'ruf-swarm-wasm';
...
```javascript
import init, { WasmNeuralNetwork, ActivationFunction } from 'ruf-swarm-wasm';
...
```javascript
import init, { SimdMatrixOps } from 'ruf-swarm-wasm';
...
```javascript
import init, { detect_simd_capabilities } from 'ruf-swarm-wasm';
...
We welcome contributions to improve ruf-swarm-wasm! Areas of focus:
...
- **Documentation**: [https://docs.rs/ruf-swarm-wasm](https://docs.rs/ruf-swarm-wasm)
- **NPM Package**: [https://www.npmjs.com/package/ruf-swarm-wasm](https://www.npmjs.com/package/ruf-swarm-wasm)
