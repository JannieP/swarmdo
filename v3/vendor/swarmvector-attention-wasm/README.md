...
WebAssembly bindings for the swarmvector-attention package, providing high-performance attention mechanisms for browser and Node.js environments.
...
```typescript
import { initialize, MultiHeadAttention, utils } from 'swarmvector-attention-wasm';
...
```typescript
import { HyperbolicAttention } from 'swarmvector-attention-wasm';
...
```typescript
import { MoEAttention } from 'swarmvector-attention-wasm';
...
```typescript
import { InfoNCELoss, Adam } from 'swarmvector-attention-wasm';
...
```typescript
import { LRScheduler, AdamW } from 'swarmvector-attention-wasm';
...
```typescript
import { CGTSheafAttention } from 'swarmvector-attention-wasm';
