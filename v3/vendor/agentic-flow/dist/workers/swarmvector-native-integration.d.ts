/**
 * SwarmVector Native Integration
 *
...
export interface SwarmVectorNativeConfig {
...
/**
 * Register a native swarmvector phase
 */
...
export declare class SwarmVectorNativeRunner {
    private config;
    constructor(config?: Partial<SwarmVectorNativeConfig>);
    /**
...
export declare const nativeRunner: SwarmVectorNativeRunner;
...
//# sourceMappingURL=swarmvector-native-integration.d.ts.map