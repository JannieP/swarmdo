...
const CONFIG_DEFINITIONS = [
    ...
    },
    {
        ...
        required: false,
        validation: (val) => ['anthropic', 'openrouter', 'gemini', 'onnx', 'ollama'].includes(val) ||
...
export class ConfigWizard {
    ...
    showSummary() {
        ...
        const hasOllama = this.currentConfig.has('OLLAMA_API_KEY') || this.currentConfig.has('OLLAMA_BASE_URL');
