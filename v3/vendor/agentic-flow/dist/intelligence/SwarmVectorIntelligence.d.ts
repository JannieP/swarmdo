 ...
 */
export interface SwarmVectorIntelligenceConfig {
...
export declare class SwarmVectorIntelligence {
    private config;
    private initialized;
    private initPromise;
    private sona;
    ...
    private stats;
    constructor(config?: SwarmVectorIntelligenceConfig);
    /**
 ...
 */
export declare function createIntelligenceLayer(config?: SwarmVectorIntelligenceConfig): SwarmVectorIntelligence;
/**
...
//# sourceMappingURL=SwarmVectorIntelligence.d.ts.map