 ...
 *
 * @rufvector/attention - Advanced Attention:
 ...
 *
 * @rufvector/core - Vector Database:
...
// Try to load @rufvector/sona
try {
    const sonaModule = await import('@rufvector/sona');
    SonaEngine = sonaModule.SonaEngine;
    sonaAvailable = true;
}
catch {
    console.warn('[RuVectorIntelligence] @rufvector/sona not available - self-learning disabled');
}
// Try to load @rufvector/attention
try {
    const attentionModule = await import('@rufvector/attention');
    ...
    console.warn('[RuVectorIntelligence] @rufvector/attention not available - attention features disabled');
}
// Import from ruvector core (for HNSW)
import ruvector from 'rufvector';
