/**
 * Model Loader for RufVector ONNX Embeddings WASM
 *
...
export class ModelLoader {
    constructor(options = {}) {
        ...
        this.cacheStorage = options.cacheStorage ?? 'rufvector-models';
    ...
    async _diskCacheDir(modelName) {
        ...
        return path.join(home, '.rufvector', 'models', modelName);
    }
