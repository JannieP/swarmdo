/**
 * rufvector smoke test (node:test).
 * Vendored fork of the upstream `ruvector` package (renamed ruv->ruf).
 * rufflo loads it via `await import('rufvector').catch(()=>null)`.
 */
...
test('dynamic import (rufflo usage) resolves', async () => {
