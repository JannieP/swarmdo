"use strict";
/**
 * Attention Fallbacks - Safe wrapper around @rufvector/attention with automatic array conversion
 *
 ...
 *
 * @rufvector/attention requires Float32Array inputs.
...
function getAttentionModule() {
    ...
    try {
        ...
        loadError = new Error(`@rufvector/attention is not installed or failed to load: ${e.message}\n` +
            `Install with: npm install @rufvector/attention`);
        throw loadError;
    }
}
/**
