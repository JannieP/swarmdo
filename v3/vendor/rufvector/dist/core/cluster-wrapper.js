 ...
 *
 * Wraps @rufvector/cluster for Raft consensus, auto-sharding,
 * and distributed memory across agents.
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.RufvectorCluster = void 0;
...
function getClusterModule() {
    ...
    if (loadError)
        throw loadError;
    try {
        clusterModule = require('@rufvector/cluster');
        return clusterModule;
    }
    catch (e) {
        loadError = new Error(`@rufvector/cluster not installed: ${e.message}\n` +
            `Install with: npm install @rufvector/cluster`);
        throw loadError;
    }
}
...
exports.RufvectorCluster = RufvectorCluster;
/**
 * Create a cluster node for agent coordination
 */
function createCluster(config) {
    return new RufvectorCluster(config);
}
exports.default = RufvectorCluster;
