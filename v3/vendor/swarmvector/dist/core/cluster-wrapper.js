 ...
 *
 * Wraps @swarmvector/cluster for Raft consensus, auto-sharding,
 * and distributed memory across agents.
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.SwarmvectorCluster = void 0;
...
function getClusterModule() {
    ...
    if (loadError)
        throw loadError;
    try {
        clusterModule = require('@swarmvector/cluster');
        return clusterModule;
    }
    catch (e) {
        loadError = new Error(`@swarmvector/cluster not installed: ${e.message}\n` +
            `Install with: npm install @swarmvector/cluster`);
        throw loadError;
    }
}
...
exports.SwarmvectorCluster = SwarmvectorCluster;
/**
 * Create a cluster node for agent coordination
 */
function createCluster(config) {
    return new SwarmvectorCluster(config);
}
exports.default = SwarmvectorCluster;
