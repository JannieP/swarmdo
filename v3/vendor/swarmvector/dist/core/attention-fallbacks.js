"use strict";
/**
 * Attention Fallbacks - Safe wrapper around @swarmvector/attention with automatic array conversion
 *
 ...
 *
 * @swarmvector/attention requires Float32Array inputs.
...
function getAttentionModule() {
    ...
    try {
        ...
        loadError = new Error(`@swarmvector/attention is not installed or failed to load: ${e.message}\n` +
            `Install with: npm install @swarmvector/attention`);
        throw loadError;
    }
}
/**
