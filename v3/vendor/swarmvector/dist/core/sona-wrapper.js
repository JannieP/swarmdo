 ...
 *
 * Provides a safe, flexible interface to @swarmvector/sona with:
...
function getSonaModule() {
    ...
    if (sonaLoadError)
        throw sonaLoadError;
    try {
        sonaModule = require('@swarmvector/sona');
        return sonaModule;
    }
    catch (e) {
        sonaLoadError = new Error(`@swarmvector/sona is not installed. Install it with:\n` +
