 ...
 *
 * Comprehensive test suite for AgentDB's SwarmVector-powered features:
 * - SIMD Vector Operations
 * - Vector Quantization (8-bit, 4-bit, Product Quantization)
 * - SwarmVectorBackend Enhancements
 * - Enhanced Embedding Service
 * - Attention Optimized Modules
 *
 * @module swarmvector-integration.test
 */
...
// SwarmVector Backend
import { SwarmVectorBackend, Semaphore, BufferPool } from '../backends/swarmvector/SwarmVectorBackend.js';
...
// ============================================================================
// 3. SwarmVectorBackend Enhancement Tests
// ============================================================================

describe('SwarmVectorBackend Enhancements', () => {
  describe('Semaphore', () => {
  ...
  describe('Adaptive parameters', () => {
    it('should return small dataset params for < 1000 vectors', () => {
      const params = SwarmVectorBackend.getRecommendedParams(500);
    ...
    it('should return medium dataset params for 1000-100000 vectors', () => {
      const params = SwarmVectorBackend.getRecommendedParams(50000);
    ...
    it('should return large dataset params for > 100000 vectors', () => {
      const params = SwarmVectorBackend.getRecommendedParams(500000);
