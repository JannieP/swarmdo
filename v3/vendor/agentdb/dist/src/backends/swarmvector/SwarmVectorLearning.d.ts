...
export declare class SwarmVectorLearning {
    private gnnLayer;
    private config;
    private initialized;
     ...
     */
    static fromJson(json: string, config: LearningConfig): Promise<SwarmVectorLearning>;
    /**
     * Get current state
     */
    getState(): {
...
//# sourceMappingURL=SwarmVectorLearning.d.ts.map