...
export class SwarmVectorLearning {
    ...
    async initialize() {
        ...
        try {
            ...
            throw new Error(`GNN initialization failed. Please install: npm install @swarmvector/gnn\n` +
                `Error: ${error.message}`);
        }
    }
    /**
    ...
    enhance(query, neighbors, weights) {
        ...
        try {
            ...
            console.warn(`[SwarmVectorLearning] Enhancement failed: ${error.message}`);
            return query;
        }
    }
    /**
    ...
    search(query, candidates, options = {}) {
        ...
        try {
            ...
            console.warn(`[SwarmVectorLearning] Differentiable search failed: ${error.message}`);
    ...
    enhanceHierarchical(query, layerEmbeddings) {
        ...
        try {
            ...
            console.warn(`[SwarmVectorLearning] Hierarchical enhancement failed: ${error.message}`);
            return query;
        }
    }
    /**
...
//# sourceMappingURL=SwarmVectorLearning.js.map