# swarmvector-graph-transformer-wasm

[![Crates.io](https://img.shields.io/crates/v/swarmvector-graph-transformer-wasm.svg)](https://crates.io/crates/swarmvector-graph-transformer-wasm)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)

**WebAssembly bindings for SwarmVector Graph Transformer — proof-gated graph attention, verified training, and 8 specialized graph layers running client-side in the browser.**
...
wasm-pack build crates/swarmvector-graph-transformer-wasm --target web

# Or from npm (when published)
npm install swarmvector-graph-transformer-wasm
```

## Quick Start

```javascript
import init, { JsGraphTransformer } from "swarmvector-graph-transformer-wasm";
...
# Node.js target
wasm-pack build crates/swarmvector-graph-transformer-wasm --target nodejs

# Cargo check
cargo check -p swarmvector-graph-transformer-wasm
```
...
| Package | Description |
|---------|-------------|
| [`swarmvector-graph-transformer`](../swarmvector-graph-transformer) | Core Rust crate (186 tests) |
| [`@swarmvector/graph-transformer`](../swarmvector-graph-transformer-node) | Node.js NAPI-RS bindings |
| [`swarmvector-verified-wasm`](../swarmvector-verified-wasm) | Formal verification WASM bindings |
