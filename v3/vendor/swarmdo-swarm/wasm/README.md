...
```bash
npm install swarmdo-swarm-wasm
```
...
```html
<script type="module">
import init, { SimdVectorOps } from 'https://unpkg.com/swarmdo-swarm-wasm/swarmdo_swarm_wasm.js';
...
```javascript
import init, { SimdVectorOps } from 'swarmdo-swarm-wasm';
...
```javascript
import init, { WasmNeuralNetwork, ActivationFunction } from 'swarmdo-swarm-wasm';
...
```javascript
import init, { SimdMatrixOps } from 'swarmdo-swarm-wasm';
...
```javascript
import init, { detect_simd_capabilities } from 'swarmdo-swarm-wasm';
...
We welcome contributions to improve swarmdo-swarm-wasm! Areas of focus:
