/**
 * TypeScript definitions for enhanced swarmdo-swarm NPX package
 * Complete WASM integration with neural networks and forecasting
 */

declare module 'swarmdo-swarm' {
  // Main SwarmdoSwarm class
  export class SwarmdoSwarm {
    constructor();
    
    static initialize(options?: SwarmdoSwarmOptions): Promise<SwarmdoSwarm>;
  ...
  export interface SwarmdoSwarmOptions {
    wasmPath?: string;
  ...
  export class EnhancedMCPTools {
    ...
    initialize(): Promise<SwarmdoSwarm>;
