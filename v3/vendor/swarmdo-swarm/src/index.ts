/**
 * SwarmdoSwarm - WASM-based swarm orchestration with cognitive diversity
 */
...
/**
 * Main SwarmdoSwarm class for orchestrating swarm operations
 */
export class SwarmdoSwarm implements SwarmEventEmitter {
  ...
  constructor(options: SwarmOptions = {}) {
    ...
    this.options = {
      ...
      wasmPath: options.wasmPath || './wasm/swarmdo_swarm_wasm.js',
    };
   ...
   */
  static async create(options?: SwarmOptions): Promise<SwarmdoSwarm> {
    const swarm = new SwarmdoSwarm(options);
    await swarm.init();
    return swarm;
  }
