#!/usr/bin/env node
/**
 * Diagnostic CLI for swarmdo-swarm
 * Usage: npx swarmdo-swarm diagnose [options]
 */
...
function showLoggingConfig(logger) {
  ...
  console.log('\n💡 Examples:');
  console.log('   LOG_LEVEL=DEBUG npx swarmdo-swarm mcp start');
  console.log('   MCP_LOG_LEVEL=TRACE TOOLS_LOG_LEVEL=DEBUG npx swarmdo-swarm mcp start');
  console.log('   LOG_TO_FILE=true LOG_DIR=./mylogs npx swarmdo-swarm mcp start');
}
...
function formatReportAsMarkdown(report) {
  const lines = [
    '# swarmdo-swarm Diagnostic Report',
    '',
...
function showHelp() {
  console.log(`
🔍 swarmdo-swarm Diagnostics

Usage: npx swarmdo-swarm diagnose <command> [options]
...
Examples:
  npx swarmdo-swarm diagnose test
  npx swarmdo-swarm diagnose report --output=report.json
  npx swarmdo-swarm diagnose monitor --duration=120
  npx swarmdo-swarm diagnose logs --pattern="connection.*failed"
  npx swarmdo-swarm diagnose config
`);
}
