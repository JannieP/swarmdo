...
class WasmModuleLoader {
  constructor() {
    ...
    this.moduleManifest = {
      ...
      core: {
        path: '../wasm/swarmdo_swarm_wasm_bg.wasm',
        jsBindings: '../wasm/swarmdo_swarm_wasm.js',
        size: 512 * 1024,
        priority: 'high',
        dependencies: [],
        exists: true,
      ...
      neural: { path: '../wasm/swarm-fann.wasm', size: 1024 * 1024, priority: 'medium', dependencies: ['core'], exists: false, optional: true },
      forecasting: { path: '../wasm/neuro-divergent.wasm', size: 1536 * 1024, priority: 'medium', dependencies: ['core'], exists: false, optional: true },
      swarm: { path: '../wasm/swarmdo-swarm-orchestration.wasm', size: 768 * 1024, priority: 'high', dependencies: ['core'], exists: false, optional: true },
      persistence: { path: '../wasm/swarmdo-swarm-persistence.wasm', size: 256 * 1024, priority: 'high', dependencies: ['core'], exists: false, optional: true },
    };
  }
      ...
      const approaches = [
        ...
        () => {
          ...
          const potentialPaths = [
            path.join(cwd, 'node_modules', 'swarmdo-swarm', 'wasm'),
            path.join(cwd, '..', 'wasm'),
            path.join(cwd, 'wasm'),
          ];
        ...
        () => process.env.SWARMDO_SWARM_WASM_PATH,
      ];
    ...
    return [
      {
        ...
        wasmBinary: path.join(this.baseDir, '..', 'wasm', 'swarmdo_swarm_wasm_bg.wasm'),
        jsBindings: path.join(this.baseDir, '..', 'wasm', 'swarmdo_swarm_wasm.js'),
      },
      {
      ...
      },
      {
        ...
        get wasmBinary() {
          return this.wasmDir ? path.join(this.wasmDir, 'swarmdo_swarm_wasm_bg.wasm') : null;
        },
        get jsBindings() {
          return this.wasmDir ? path.join(this.wasmDir, 'swarmdo_swarm_wasm.js') : null;
        },
      },
      {
