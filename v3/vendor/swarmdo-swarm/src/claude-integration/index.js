...
class ClaudeIntegrationOrchestrator {
  constructor(options = {}) {
    this.options = {
      ...
      packageName: options.packageName || 'swarmdo-swarm',
      ...options,
    };
    ...
    try {
      ...
      if (this.options.autoSetup) {
        ...
        results.modules.core = {
          ...
          manualSetup: true,
          instructions: [
            'Run: claude mcp add swarmdo-swarm npx swarmdo-swarm mcp start',
            'Test with: mcp__swarmdo-swarm__agent_spawn',
          ],
        };
      }
      ...
      if (results.modules.core.manualSetup) {
        console.log('   1. claude mcp add swarmdo-swarm npx swarmdo-swarm mcp start');
        console.log('   2. Test with MCP tools: mcp__swarmdo-swarm__agent_spawn');
      } else {
