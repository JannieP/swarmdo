...
/**
 * Main SwarmdoSwarm class for neural network swarm orchestration
 */
export declare class SwarmdoSwarm {
  /** Swarm name */
  ...
  /**
   * Create a new SwarmdoSwarm instance
   * @param config Swarm configuration
   */
  constructor(config: SwarmConfig);

  /**
   * Initialize SwarmdoSwarm with WASM module
   * @param options Initialization options
   * @returns Initialized SwarmdoSwarm instance
   */
  static initialize(options?: InitOptions): Promise<SwarmdoSwarm>;
