...
/**
 * Base error class for all swarmdo-swarm MCP errors
 */
class SwarmdoSwarmError extends Error {
 ...
 */
class ValidationError extends SwarmdoSwarmError {
 ...
 */
class SwarmError extends SwarmdoSwarmError {
 ...
 */
class AgentError extends SwarmdoSwarmError {
 ...
 * Task-related errors
 */
class TaskError extends SwarmdoSwarmError {
 ...
 */
class NeuralError extends SwarmdoSwarmError {
 ...
 * WASM-related errors
 */
class WasmError extends SwarmdoSwarmError {
 ...
 */
class ConfigurationError extends SwarmdoSwarmError {
 ...
 */
class NetworkError extends SwarmdoSwarmError {
 ...
 */
class PersistenceError extends SwarmdoSwarmError {
 ...
 */
class ResourceError extends SwarmdoSwarmError {
 ...
 */
class ConcurrencyError extends SwarmdoSwarmError {
...
class ErrorFactory {
  ...
  static createError(type, message, details = {}) {
    ...
    default:
      return new SwarmdoSwarmError(message, 'GENERAL_ERROR', details);
    }
  }
...
class ErrorContext {
   ...
   */
  enrichError(error) {
    if (error instanceof SwarmdoSwarmError) {
      error.details = {
        ...error.details,
