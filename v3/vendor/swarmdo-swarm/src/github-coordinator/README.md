# GitHub Coordinator for swarmdo-swarm
...
# Use the coordinator
npx swarmdo-swarm github-coordinate
...
{
  "hooks": {
    "pre-task": "npx swarmdo-swarm hook github pre-task",
    "post-edit": "npx swarmdo-swarm hook github post-edit",
    "post-task": "npx swarmdo-swarm hook github post-task"
  }
}
```
...
npx swarmdo-swarm github status

# List available tasks
npx swarmdo-swarm github tasks --available

# Claim a specific task
npx swarmdo-swarm github claim 123

# Release a task
npx swarmdo-swarm github release 123

# Show dashboard URLs
npx swarmdo-swarm github dashboard
```
