# SwarmVector ONNX Embeddings WASM

[![npm version](https://img.shields.io/npm/v/swarmvector-onnx-embeddings-wasm.svg)](https://www.npmjs.com/package/swarmvector-onnx-embeddings-wasm)
[![crates.io](https://img.shields.io/crates/v/swarmvector-onnx-embeddings-wasm.svg)](https://crates.io/crates/swarmvector-onnx-embeddings-wasm)
...
| 🎯 **Same API** | Compatible with native `swarmvector-onnx-embeddings` |
...
```html
<script type="module">
import init, { WasmEmbedder } from 'https://unpkg.com/swarmvector-onnx-embeddings-wasm/swarmvector_onnx_embeddings_wasm.js';
import { createEmbedder } from 'https://unpkg.com/swarmvector-onnx-embeddings-wasm/loader.js';
...
```javascript
import { createEmbedder, similarity, embed } from 'swarmvector-onnx-embeddings-wasm/loader.js';
...
```javascript
import { WasmEmbedder, WasmEmbedderConfig } from 'swarmvector-onnx-embeddings-wasm';
...
const knowledge = [
  "SwarmVector is a vector database",
...
|---------|---------|----------|
| [swarmvector-onnx-embeddings](https://crates.io/crates/swarmvector-onnx-embeddings) | Native | High-performance servers |
| **swarmvector-onnx-embeddings-wasm** | WASM | Browsers, edge, portable |
...
<p align="center">
  <b>Part of the SwarmVector ecosystem</b><br>
