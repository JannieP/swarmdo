/**
 * @swarmvector/rabitq-wasm smoke test (node:test).
 * Fork of the upstream @swarmvector/rabitq-wasm (prebuilt WASM/dist; package renamed
...
test('package.json name is the @swarmvector fork name', async () => {
  ...
  assert.equal(pkg.name, '@swarmvector/rabitq-wasm', 'name renamed to fork');
});
