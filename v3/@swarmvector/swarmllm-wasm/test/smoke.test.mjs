/**
 * @swarmvector/swarmllm-wasm smoke test (node:test).
 * Fork of the upstream @swarmvector/swarmllm-wasm (prebuilt WASM/dist; package renamed
...
test('package.json name is the @swarmvector fork name', async () => {
  ...
  assert.equal(pkg.name, '@swarmvector/swarmllm-wasm', 'name renamed to fork');
});
