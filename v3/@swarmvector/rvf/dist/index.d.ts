/**
 * @swarmvector/rvf — Unified TypeScript SDK for the SwarmVector Format.
 *
 * Works with both the native Node.js backend (`@swarmvector/rvf-node`) and
 * the browser WASM backend (`@swarmvector/rvf-wasm`).
 *
 * @example
 * ```ts
...
export { RvfSolver } from '@swarmvector/rvf-solver';
export type { TrainOptions, TrainResult, AcceptanceOptions, AcceptanceManifest, AcceptanceModeResult, CycleMetrics, PolicyState, SkipMode, SkipModeStats, CompiledConfig, } from '@swarmvector/rvf-solver';
