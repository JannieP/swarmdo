/**
 * @swarmvector/rvf smoke test (node:test).
 * Fork of the upstream @swarmvector/rvf (prebuilt WASM/dist; package renamed
...
test('package loads via its published entry', async () => {
  const mod = await import('@swarmvector/rvf');
...
test('package.json name is the @swarmvector fork name', async () => {
  ...
  assert.equal(pkg.name, '@swarmvector/rvf', 'name renamed to fork');
});
