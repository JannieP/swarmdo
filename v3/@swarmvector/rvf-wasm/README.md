# @swarmvector/rvf-wasm

SwarmVector Format (RVF) WASM build for browsers and edge functions. Query vectors directly in the browser with zero backend.
...
```html
<script type="module">
  import init, { WasmRvfStore } from '@swarmvector/rvf-wasm';
  await init();
