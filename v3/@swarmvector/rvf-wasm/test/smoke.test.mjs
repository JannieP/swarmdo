/**
 * @swarmvector/rvf-wasm smoke test (node:test).
 * Fork of upstream @swarmvector/rvf-wasm (package renamed @swarmvector/* -> @swarmvector/*).
...
test('package loads via its published entry', async () => {
  const mod = await import('@swarmvector/rvf-wasm');
...
test('package.json name is the @swarmvector fork name', async () => {
  ...
  assert.equal(pkg.name, '@swarmvector/rvf-wasm', 'name renamed to fork');
});
