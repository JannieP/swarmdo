...
export declare function getNativeModule(): NativeSwarmLLM | null;
export declare function version(): string;
export declare function hasSimdSupport(): boolean;
export type { NativeSwarmLLM, NativeConfig, NativeEngine, NativeGenConfig, NativeQueryResponse, NativeRoutingDecision, NativeMemoryResult, NativeStats, NativeSimdOps, };
