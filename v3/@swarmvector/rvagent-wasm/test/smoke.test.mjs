/**
 * @swarmvector/rvagent-wasm smoke test (node:test).
 * Fork of the upstream @swarmvector/rvagent-wasm (prebuilt WASM/dist; package renamed
...
test('package.json name is the @swarmvector fork name', async () => {
  ...
  assert.equal(pkg.name, '@swarmvector/rvagent-wasm', 'name renamed to fork');
});
