 ...
 *
 * Integration module for RufVector - a PostgreSQL extension providing
...
export { RufVectorBridge, createRufVectorBridge } from './rufvector-bridge.js';
export { default as RufVectorBridgeDefault } from './rufvector-bridge.js';
...
export type {
  ...
  RufVectorEventType,
  RufVectorEvent,
  RufVectorEventHandler,
  RufVectorEventEmitter,
...
// Export namespace
export { RufVector } from './types.js';
