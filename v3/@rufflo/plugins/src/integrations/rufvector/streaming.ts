/**
 * RufVector PostgreSQL Bridge - Streaming and Transaction Support
 *
 ...
 *
 * @module @rufflo/plugins/integrations/rufvector/streaming
 * @version 1.0.0
 */
...
const DEFAULT_CURSOR_PREFIX = 'rufvector_cursor_';
...
// ============================================================================
// RufVectorStream Class
// ============================================================================

/**
 * Streaming support for RufVector operations.
 *
 ...
 * @example
 * ```typescript
 * const stream = new RufVectorStream(pool, config);
 *
 ...
 * ```
 */
export class RufVectorStream extends EventEmitter {
...
// ============================================================================
// RufVectorTransaction Class
// ============================================================================

/**
 * Enhanced transaction support for RufVector operations.
 *
 ...
 * @example
 * ```typescript
 * const tx = new RufVectorTransaction(client);
 ...
 * ```
 */
export class RufVectorTransaction extends EventEmitter {
...
/**
 * Create a new RufVectorStream instance.
 */
export function createRufVectorStream(
  pool: Pool,
  options?: {
    schema?: string;
    defaultTableName?: string;
  ...
  return new RufVectorStream(pool, options);
}

/**
 * Create a new RufVectorTransaction instance.
 */
export function createRufVectorTransaction(
  client: PoolClient,
  options?: {
    schema?: string;
    defaultTableName?: string;
  }
): RufVectorTransaction {
  return new RufVectorTransaction(client, options);
}
...
export default {
  ...
  BatchProcessor,
  PoolEventEmitter,
  createRufVectorStream,
  createRufVectorTransaction,
