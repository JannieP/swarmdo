/**
 * RufVector PostgreSQL Bridge - Type Definitions
 *
 * Comprehensive TypeScript types for the RufVector PostgreSQL vector database
 * integration, supporting advanced neural search, attention mechanisms,
 * graph neural networks, and hyperbolic embeddings.
 *
 * @module @rufflo/plugins/integrations/rufvector
 * @version 1.0.0
 */
...
/**
 * Primary configuration for RufVector PostgreSQL connection.
 */
export interface RufVectorConfig {
...
/**
 * Index types supported by RufVector/pgvector.
 */
...
/**
 * All 39 attention mechanism types supported by RufVector.
 *
 * These mechanisms enable sophisticated neural search and pattern matching
 * directly within PostgreSQL using RufVector's attention functions.
 */
...
/**
 * GNN layer types supported by RufVector.
 */
...
/**
 * Hyperbolic space models supported by RufVector.
 */
...
/**
 * RufVector SQL function categories.
 */
export type RufVectorFunctionCategory =
...
export interface VectorFunctions {
  ...
  'rufvector.vector_add': VectorBinaryOp;
  'rufvector.vector_sub': VectorBinaryOp;
  'rufvector.vector_mul': VectorScalarOp;
  'rufvector.vector_div': VectorScalarOp;
  'rufvector.vector_neg': VectorUnaryOp;
  'rufvector.vector_dot': VectorBinaryScalarOp;
  'rufvector.vector_cross': VectorBinaryOp;
  'rufvector.vector_norm': VectorNormOp;
  'rufvector.vector_normalize': VectorUnaryOp;
  'rufvector.vector_scale': VectorScalarOp;
  'rufvector.vector_lerp': VectorLerpOp;
  'rufvector.vector_slerp': VectorSlerpOp;

  // Distance Functions
  'rufvector.cosine_distance': DistanceFunction;
  'rufvector.cosine_similarity': DistanceFunction;
  'rufvector.euclidean_distance': DistanceFunction;
  'rufvector.l2_distance': DistanceFunction;
  'rufvector.manhattan_distance': DistanceFunction;
  'rufvector.l1_distance': DistanceFunction;
  'rufvector.hamming_distance': DistanceFunction;
  'rufvector.jaccard_distance': DistanceFunction;
  'rufvector.inner_product': DistanceFunction;
  'rufvector.dot_product': DistanceFunction;

  // Aggregation Functions
  'rufvector.vector_avg': VectorAggregateOp;
  'rufvector.vector_sum': VectorAggregateOp;
  'rufvector.vector_min': VectorAggregateOp;
  'rufvector.vector_max': VectorAggregateOp;
  'rufvector.vector_centroid': VectorAggregateOp;
  'rufvector.vector_median': VectorAggregateOp;
}
...
export interface IndexFunctions {
  'rufvector.create_hnsw_index': CreateIndexOp;
  'rufvector.create_ivfflat_index': CreateIndexOp;
  'rufvector.drop_index': DropIndexOp;
  'rufvector.reindex': ReindexOp;
  'rufvector.index_stats': IndexStatsOp;
  'rufvector.set_ef_search': SetParamOp;
  'rufvector.set_probes': SetParamOp;
}
...
export interface AttentionFunctions {
  'rufvector.multi_head_attention': AttentionOp;
  'rufvector.self_attention': AttentionOp;
  'rufvector.cross_attention': CrossAttentionOp;
  'rufvector.flash_attention': FlashAttentionOp;
  'rufvector.linear_attention': LinearAttentionOp;
  'rufvector.sparse_attention': SparseAttentionOp;
  'rufvector.compute_attention_weights': AttentionWeightsOp;
}
...
export interface GNNFunctions {
  'rufvector.gcn_layer': GNNLayerOp;
  'rufvector.gat_layer': GNNLayerOp;
  'rufvector.sage_layer': GNNLayerOp;
  'rufvector.message_passing': MessagePassingOp;
  'rufvector.aggregate_neighbors': AggregateOp;
  'rufvector.graph_pooling': PoolingOp;
}
...
export interface HyperbolicFunctions {
  'rufvector.poincare_distance': HyperbolicDistanceOp;
  'rufvector.lorentz_distance': HyperbolicDistanceOp;
  'rufvector.exp_map': ExpMapOp;
  'rufvector.log_map': LogMapOp;
  'rufvector.mobius_add': MobiusOp;
  'rufvector.parallel_transport': TransportOp;
  'rufvector.hyperbolic_centroid': HyperbolicCentroidOp;
}
...
export interface EmbeddingFunctions {
  'rufvector.embed_text': EmbedTextOp;
  'rufvector.embed_batch': EmbedBatchOp;
  'rufvector.embed_image': EmbedImageOp;
  'rufvector.embed_chunk': EmbedChunkOp;
}
...
export interface QuantizationFunctions {
  'rufvector.quantize_scalar': QuantizeOp;
  'rufvector.quantize_product': ProductQuantizeOp;
  'rufvector.dequantize': DequantizeOp;
  'rufvector.binary_quantize': BinaryQuantizeOp;
}
...
export interface UtilityFunctions {
  'rufvector.version': VersionOp;
  'rufvector.config': ConfigOp;
  'rufvector.stats': StatsOp;
  'rufvector.health_check': HealthCheckOp;
  'rufvector.vacuum_vectors': VacuumOp;
  'rufvector.analyze_vectors': AnalyzeOp;
}
...
/**
 * RufVector statistics.
 */
export interface RufVectorStats {
  /** Version string */
...
/**
 * RufVector event types.
 */
export type RufVectorEventType =
  // Connection Events
  | 'connection:open'
  | 'connection:close'
  | 'connection:error'
 ...
 */
export interface RufVectorEvent<T extends RufVectorEventType = RufVectorEventType> {
  /** Event type */
  readonly type: T;
  /** Timestamp */
 ...
 * Event handler type.
 */
export type RufVectorEventHandler<T extends RufVectorEventType = RufVectorEventType> =
  (event: RufVectorEvent<T>) => void | Promise<void>;

/**
 * Event emitter interface.
 */
export interface RufVectorEventEmitter {
  on<T extends RufVectorEventType>(event: T, handler: RufVectorEventHandler<T>): () => void;
  off<T extends RufVectorEventType>(event: T, handler: RufVectorEventHandler<T>): void;
  once<T extends RufVectorEventType>(event: T, handler: RufVectorEventHandler<T>): () => void;
  emit<T extends RufVectorEventType>(event: T, data: EventDataMap[T]): void;
  removeAllListeners(event?: RufVectorEventType): void;
}
...
export interface ConnectionResult {
  ...
  /** RufVector extension version */
  readonly rufVectorVersion: string;
...
/**
 * RufVector client configuration options.
 */
export interface RufVectorClientOptions extends RufVectorConfig {
  ...
  readonly eventHandlers?: Partial<{
    [K in RufVectorEventType]: RufVectorEventHandler<K>;
  }>;
  /** Custom logger */
  readonly logger?: RufVectorLogger;
}

/**
 * Logger interface.
 */
export interface RufVectorLogger {
...
/**
 * RufVector client interface.
 */
export interface IRufVectorClient extends RufVectorEventEmitter {
  ...
  // Transaction Support
  transaction<T>(fn: (tx: IRufVectorTransaction) => Promise<T>): Promise<TransactionResult<T>>;

  // Admin Operations
  vacuum(tableName?: string): Promise<void>;
  analyze(tableName?: string): Promise<AnalysisResult>;
  healthCheck(): Promise<HealthStatus>;
  getStats(): Promise<RufVectorStats>;
}

/**
 * Transaction interface.
 */
export interface IRufVectorTransaction {
...
/**
 * Factory function for creating RufVector clients.
 */
export type RufVectorClientFactory = (options: RufVectorClientOptions) => IRufVectorClient;

/**
 * Plugin registration type for the RufVector integration.
 */
export interface RufVectorPluginRegistration {
  /** Plugin name */
  readonly name: 'rufvector';
  /** Plugin version */
  readonly version: string;
  /** Client factory */
  readonly createClient: RufVectorClientFactory;
  /** Supported features */
  readonly features: RufVectorFeature[];
}

/**
 * RufVector feature flags.
 */
export type RufVectorFeature =
  | 'vector_search'
  | 'hnsw_index'
  | 'ivf_index'
  | 'attention'
 ...
 */
export interface RufVectorSQLFunctions
 ...
 */
export namespace RufVector {
  export type Config = RufVectorConfig;
  export type Client = IRufVectorClient;
  export type ClientOptions = RufVectorClientOptions;
  ...
  export type Event = RufVectorEventType;
  export type EventData<T extends RufVectorEventType> = EventDataMap[T];
  export type Feature = RufVectorFeature;
}
