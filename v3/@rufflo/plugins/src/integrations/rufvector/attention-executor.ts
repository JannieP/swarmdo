/**
 * RufVector PostgreSQL Bridge - Attention Executor and Factory
 *
 * Provides execution layer and factory for attention mechanisms.
 *
 * @module @rufflo/plugins/integrations/rufvector/attention-executor
 */
...
/**
 * Executes attention operations via PostgreSQL RufVector functions.
 */
...
export class AttentionSQLBuilder {
  ...
  constructor(schema: string = 'rufvector') {
    this.schema = schema;
  }
