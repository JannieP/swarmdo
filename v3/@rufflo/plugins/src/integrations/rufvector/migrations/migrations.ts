/**
 * RufVector PostgreSQL Bridge - Migration Manager
 *
 * Handles database migrations for the RufVector PostgreSQL integration.
 * Supports up/down migrations, rollback, and migration tracking.
 *
 * @module @rufflo/plugins/integrations/rufvector/migrations
 * @version 1.0.0
 */
...
/**
 * Manages database migrations for RufVector PostgreSQL Bridge
 */
