/**
 * RufVector PostgreSQL Bridge Tests
 *
 * Comprehensive test suite for the RufVector PostgreSQL vector database
 ...
 *
 * @module @rufflo/plugins/__tests__/rufvector-bridge
 */
 ...
 */
function createTestConfig(overrides: Partial<RufVectorConfig> = {}): RufVectorConfig {
  return {
    host: 'localhost',
    port: 5432,
    database: 'test_db',
...
// ============================================================================
// Mock RufVector Client Implementation for Testing
// ============================================================================

/**
 * Mock RufVector client for unit testing
 */
  ...
  describe('Connection Management', () => {
    describe('Pool Creation and Configuration', () => {
      ...
      it('should apply custom pool configuration', async () => {
        const customConfig: RufVectorClientOptions = {
          ...config,
          pool: {
            min: 5,
            max: 20,
      ...
      it('should respect pool size limits', async () => {
        ...
        const limitedClient = new MockRufVectorClient({
          ...config,
          pool: poolConfig,
        });
    ...
    describe('Connection Health Checks', () => {
      it('should report healthy status when connected', async () => {
        ...
        expect(health.components.rufvector.healthy).toBe(true);
...
describe('Edge Cases', () => {
  ...
  beforeEach(async () => {
    client = new MockRufVectorClient(createTestConfig());
    await client.connect();
  });
