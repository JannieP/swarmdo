...
[![npm version](https://img.shields.io/npm/v/@rufflo/plugins.svg)](https://www.npmjs.com/package/@rufflo/plugins)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/plugins.svg)](https://www.npmjs.com/package/@rufflo/plugins)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

**Unified Plugin SDK for Rufflo V3**

A comprehensive plugin development framework providing workers, hooks, providers, and security utilities for building Rufflo extensions.

## Installation

```bash
npm install @rufflo/plugins
```
...
const myPlugin = new PluginBuilder('my-awesome-plugin', '1.0.0')
  .withDescription('My awesome plugin for Rufflo')
...
import { getDefaultRegistry } from '@rufflo/plugins';
...
```typescript
import { createToolPlugin, createHooksPlugin, createWorkerPlugin } from '@rufflo/plugins';
...
```typescript
import { MCPToolBuilder } from '@rufflo/plugins';
...
```typescript
import { HookBuilder, HookFactory, HookRegistry, HookEvent, HookPriority } from '@rufflo/plugins';
...
```typescript
import { WorkerPool, WorkerFactory } from '@rufflo/plugins';
...
```typescript
import { ProviderRegistry, ProviderFactory, BaseLLMProvider } from '@rufflo/plugins';
...
```typescript
import { AgenticFlowBridge, AgentDBBridge } from '@rufflo/plugins';
...
```typescript
import { Security, createRateLimiter, createResourceLimiter } from '@rufflo/plugins';
