/**
 * RufVector Plugin Collection
 *
 * High-value plugins using @rufvector WASM packages for Rufflo.
 *
...
/**
 * Register all RufVector plugins with the default registry.
 */
export async function registerAllRufVectorPlugins(): Promise<void> {
