/**
 * RufVector Plugins Test Suite
 *
 * Tests for all RufVector-powered plugins.
 */
...
describe('Plugin Integration Types', () => {
  it('should export all plugin types', async () => {
    ...
    expect(exports.registerAllRufVectorPlugins).toBeDefined();
  });
...
describe('Plugin Metadata', () => {
  it('reasoningBankPlugin should have correct metadata', async () => {
    ...
    expect(metadata.id).toBe('rufvector-reasoning-bank');
    expect(metadata.name).toBe('RufVector Reasoning Bank');
  ...
  it('semanticCodeSearchPlugin should have correct metadata', async () => {
    ...
    expect(metadata.id).toBe('rufvector-semantic-code-search');
    expect(metadata.name).toBe('RufVector Semantic Code Search');
  ...
  it('sonaLearningPlugin should have correct metadata', async () => {
    ...
    expect(metadata.id).toBe('rufvector-sona-learning');
    expect(metadata.name).toBe('RufVector SONA Learning');
    expect(metadata.capabilities).toContain('learning');
  ...
  it('intentRouterPlugin should have correct metadata', async () => {
    ...
    expect(metadata.id).toBe('rufvector-intent-router');
    expect(metadata.name).toBe('RufVector Intent Router');
  ...
  it('mcpToolOptimizerPlugin should have correct metadata', async () => {
    ...
    expect(metadata.id).toBe('rufvector-mcp-tool-optimizer');
    expect(metadata.name).toBe('RufVector MCP Tool Optimizer');
  ...
  it('hookPatternLibraryPlugin should have correct metadata', async () => {
    ...
    expect(metadata.id).toBe('rufvector-hook-pattern-library');
    expect(metadata.name).toBe('RufVector Hook Pattern Library');
