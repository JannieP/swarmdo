/**
 * RufVector PostgreSQL Bridge - Quantization Example
 *
 ...
 *
 * Run with: npx ts-node examples/rufvector/quantization.ts
 *
 * @module @rufflo/plugins/examples/rufvector/quantization
 */
...
async function main(): Promise<void> {
  console.log('RufVector PostgreSQL Bridge - Quantization Example');
  console.log('===================================================\n');
