/**
 * RufVector PostgreSQL Bridge - Graph Neural Network Analysis Example
 *
 ...
 *
 * Run with: npx ts-node examples/rufvector/gnn-analysis.ts
 *
 * @module @rufflo/plugins/examples/rufvector/gnn-analysis
 */
...
} from '../../src/integrations/rufvector/gnn.js';
...
async function main(): Promise<void> {
  console.log('RufVector PostgreSQL Bridge - Graph Neural Network Analysis Example');
  console.log('===================================================================\n');
