/**
 * RufVector PostgreSQL Bridge - Transactions Example
 *
 ...
 *
 * Run with: npx ts-node examples/rufvector/transactions.ts
 *
 * @module @rufflo/plugins/examples/rufvector/transactions
 */
...
async function main(): Promise<void> {
  console.log('RufVector PostgreSQL Bridge - Transactions Example');
  console.log('===================================================\n');
