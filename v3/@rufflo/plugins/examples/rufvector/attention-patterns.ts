/**
 * RufVector PostgreSQL Bridge - Attention Mechanisms Example
 *
 ...
 *
 * Run with: npx ts-node examples/rufvector/attention-patterns.ts
 *
 * @module @rufflo/plugins/examples/rufvector/attention-patterns
 */
...
} from '../../src/integrations/rufvector/attention.js';
...
async function main(): Promise<void> {
  console.log('RufVector PostgreSQL Bridge - Attention Mechanisms Example');
  console.log('==========================================================\n');
