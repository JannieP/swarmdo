 ...
 *
 * Run with: npx ts-node examples/rufvector/basic-usage.ts
 *
 * @module @rufflo/plugins/examples/rufvector/basic-usage
 */
...
async function main(): Promise<void> {
  console.log('RufVector PostgreSQL Bridge - Basic Usage Example');
  console.log('================================================\n');
