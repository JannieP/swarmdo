/**
 * RufVector PostgreSQL Bridge - Streaming Large Data Example
 *
 ...
 *
 * Run with: npx ts-node examples/rufvector/streaming-large-data.ts
 *
 * @module @rufflo/plugins/examples/rufvector/streaming-large-data
 */
...
async function main(): Promise<void> {
  console.log('RufVector PostgreSQL Bridge - Streaming Large Data Example');
  console.log('============================================================\n');
