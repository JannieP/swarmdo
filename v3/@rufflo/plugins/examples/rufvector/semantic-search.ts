/**
 * RufVector PostgreSQL Bridge - Semantic Code Search Example
 *
 ...
 *
 * Run with: npx ts-node examples/rufvector/semantic-search.ts
 *
 * @module @rufflo/plugins/examples/rufvector/semantic-search
 */
...
async function main(): Promise<void> {
  console.log('RufVector PostgreSQL Bridge - Semantic Code Search Example');
  console.log('=========================================================\n');
