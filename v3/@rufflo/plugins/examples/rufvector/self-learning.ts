/**
 * RufVector PostgreSQL Bridge - Self-Learning Example
 *
 ...
 *
 * Run with: npx ts-node examples/rufvector/self-learning.ts
 *
 * @module @rufflo/plugins/examples/rufvector/self-learning
 */
...
} from '../../src/integrations/rufvector/self-learning.js';
...
async function main(): Promise<void> {
  console.log('RufVector PostgreSQL Bridge - Self-Learning Example');
  console.log('====================================================\n');
