# RufVector PostgreSQL Bridge Examples

Comprehensive examples demonstrating the RufVector PostgreSQL Bridge plugin features.
...
npx ts-node examples/rufvector/basic-usage.ts

# Semantic code search
npx ts-node examples/rufvector/semantic-search.ts

# Attention mechanisms
npx ts-node examples/rufvector/attention-patterns.ts

# Graph neural networks
npx ts-node examples/rufvector/gnn-analysis.ts

# Hyperbolic embeddings
npx ts-node examples/rufvector/hyperbolic-hierarchies.ts

# Self-learning optimization
npx ts-node examples/rufvector/self-learning.ts

# Large-scale streaming
npx ts-node examples/rufvector/streaming-large-data.ts

# Quantization methods
npx ts-node examples/rufvector/quantization.ts

# Transaction patterns
npx ts-node examples/rufvector/transactions.ts
```
...
Getting started with RufVector PostgreSQL Bridge:
...
**Expected output:**
```
RufVector PostgreSQL Bridge - Basic Usage Example
================================================
...
- [RufVector Plugin Documentation](../../src/integrations/rufvector/README.md)
