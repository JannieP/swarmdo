/**
 * RufVector PostgreSQL Bridge - Hyperbolic Embeddings Example
 *
 ...
 *
 * Run with: npx ts-node examples/rufvector/hyperbolic-hierarchies.ts
 *
 * @module @rufflo/plugins/examples/rufvector/hyperbolic-hierarchies
 */

import {
  createRufVectorBridge,
  type RufVectorBridge,
} from '../../src/integrations/rufvector/index.js';
...
import {
  ...
  type HierarchyNode,
} from '../../src/integrations/rufvector/hyperbolic.js';
...
async function main(): Promise<void> {
  console.log('RufVector PostgreSQL Bridge - Hyperbolic Embeddings Example');
  console.log('============================================================\n');

  const bridge: RufVectorBridge = createRufVectorBridge({
