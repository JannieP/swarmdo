...
[![npm version](https://img.shields.io/npm/v/@rufflo/plugin-iot-cognitum.svg)](https://www.npmjs.com/package/@rufflo/plugin-iot-cognitum)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/plugin-iot-cognitum.svg)](https://www.npmjs.com/package/@rufflo/plugin-iot-cognitum)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

IoT Cognitum Seed device-agent bridge — treat every Seed as a Rufflo agent with hardware capabilities.
...
```bash
npx -y -p @rufflo/plugin-iot-cognitum@latest cognitum-iot --help
```
...
```typescript
import { IoTCognitumPlugin } from '@rufflo/plugin-iot-cognitum';
