...
export class IoTCognitumPlugin implements ClaudeFlowPlugin {
  ...
  readonly dependencies = ['@rufflo/shared'];
    ...
    return [
      {
        ...
        description: 'Manages Cognitum Seed device fleet as Rufflo agent swarm members',
        defaultConfig: {
          id: '',
          name: 'device-coordinator',
          type: 'coordinator',
          ...
          priority: 85,
          timeout: 300_000,
          metadata: { pluginSource: '@rufflo/plugin-iot-cognitum' },
        },
