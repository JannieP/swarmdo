...
[![npm version](https://img.shields.io/npm/v/@rufflo/hooks.svg)](https://www.npmjs.com/package/@rufflo/hooks)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/hooks.svg)](https://www.npmjs.com/package/@rufflo/hooks)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.3+-blue.svg)](https://www.typescriptlang.org/)
[![Node.js](https://img.shields.io/badge/Node.js-20+-green.svg)](https://nodejs.org/)

> Event-driven lifecycle hooks with ReasoningBank learning integration for Rufflo V3

The `@rufflo/hooks` package provides a comprehensive hooks system for intercepting and extending Rufflo operations. It enables intelligent task routing, pattern learning, background metrics collection, and real-time statusline integration.
...
# Using pnpm
pnpm add @rufflo/hooks

# Using yarn
yarn add @rufflo/hooks
```
...
```typescript
import { initializeHooks } from '@rufflo/hooks';
...
```typescript
import { hooksMCPTools, getHooksTool } from '@rufflo/hooks';
...
rufflo hooks worker detect --prompt "deep dive into auth" --auto-dispatch --min-confidence 0.6
...
- [@rufflo/shared](../shared) - Shared utilities and types
- [@rufflo/neural](../neural) - Neural network and SONA learning
- [@rufflo/swarm](../swarm) - Multi-agent coordination
- [@rufflo/memory](../memory) - AgentDB memory system

## License

MIT © [Rufflo Team](https://github.com/ruvnet/claude-flow)
