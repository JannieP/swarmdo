#!/usr/bin/env node
/**
 * Phase 1 micro-benchmarks for the @rufflo/guidance optimization
 ...
 *
 * Usage:
 *   node v3/@rufflo/cli ... build first
 *   node v3/@rufflo/guidance/scripts/bench-phase-1.mjs --tag=baseline
 *   node v3/@rufflo/guidance/scripts/bench-phase-1.mjs --tag=phase-1
 *
