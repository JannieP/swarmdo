...
All exports from `@rufflo/guidance`. Each module is also available as a standalone import.

## Import Map

| Import Path | Key Exports |
|-------------|-------------|
| `@rufflo/guidance` | `GuidanceControlPlane`, `createGuidanceControlPlane` |
| `@rufflo/guidance/compiler` | `GuidanceCompiler`, `createCompiler` |
| `@rufflo/guidance/retriever` | `ShardRetriever`, `createRetriever`, `HashEmbeddingProvider` |
| `@rufflo/guidance/gates` | `EnforcementGates`, `createGates` |
| `@rufflo/guidance/hooks` | `GuidanceHookProvider`, `createGuidanceHooks` |
| `@rufflo/guidance/ledger` | `RunLedger`, `createLedger`, `TestsPassEvaluator`, `ForbiddenCommandEvaluator`, `ForbiddenDependencyEvaluator`, `ViolationRateEvaluator`, `DiffQualityEvaluator` |
| `@rufflo/guidance/optimizer` | `OptimizerLoop`, `createOptimizer` |
| `@rufflo/guidance/persistence` | `PersistentLedger`, `EventStore`, `createPersistentLedger`, `createEventStore` |
| `@rufflo/guidance/headless` | `HeadlessRunner`, `createHeadlessRunner`, `createComplianceSuite` |
| `@rufflo/guidance/gateway` | `DeterministicToolGateway`, `createToolGateway` |
| `@rufflo/guidance/artifacts` | `ArtifactLedger`, `createArtifactLedger` |
| `@rufflo/guidance/evolution` | `EvolutionPipeline`, `createEvolutionPipeline` |
| `@rufflo/guidance/manifest-validator` | `ManifestValidator`, `ConformanceSuite`, `createManifestValidator`, `createConformanceSuite` |
| `@rufflo/guidance/proof` | `ProofChain`, `createProofChain` |
| `@rufflo/guidance/memory-gate` | `MemoryWriteGate`, `createMemoryWriteGate`, `createMemoryEntry` |
...
| `@rufflo/guidance/truth-anchors` | `TruthAnchorStore`, `TruthResolver`, `createTruthAnchorStore`, `createTruthResolver` |
| `@rufflo/guidance/uncertainty` | `UncertaintyLedger`, `UncertaintyAggregator`, `createUncertaintyLedger`, `createUncertaintyAggregator` |
| `@rufflo/guidance/temporal` | `TemporalStore`, `TemporalReasoner`, `createTemporalStore`, `createTemporalReasoner` |
| `@rufflo/guidance/authority` | `AuthorityGate`, `IrreversibilityClassifier`, `createAuthorityGate`, `createIrreversibilityClassifier`, `isHigherAuthority`, `getAuthorityHierarchy` |
| `@rufflo/guidance/continue-gate` | `ContinueGate`, `createContinueGate` |
| `@rufflo/guidance/wasm-kernel` | `getKernel`, `isWasmAvailable`, `resetKernel` |
| `@rufflo/guidance/generators` | `generateClaudeMd`, `generateClaudeLocalMd`, `generateSkillMd`, `generateAgentMd`, `generateAgentIndex`, `scaffold` |
| `@rufflo/guidance/analyzer` | `analyze`, `benchmark`, `autoOptimize`, `optimizeForSize`, `headlessBenchmark`, `validateEffect`, `abBenchmark`, `getDefaultABTasks`, `formatReport`, `formatBenchmark` |
...
```ts
import { generateClaudeMd, scaffold } from '@rufflo/guidance/generators';
```
...
```ts
import { analyze, validateEffect } from '@rufflo/guidance/analyzer';
```
