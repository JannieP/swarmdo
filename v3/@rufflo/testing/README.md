...
[![npm version](https://img.shields.io/npm/v/@rufflo/testing.svg)](https://www.npmjs.com/package/@rufflo/testing)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/testing.svg)](https://www.npmjs.com/package/@rufflo/testing)
...
> Comprehensive testing framework for V3 Rufflo modules. Implements London School TDD patterns with behavior verification, shared fixtures, and mock services.
...
```bash
npm install @rufflo/testing vitest --save-dev
```
...
```typescript
import { createMockClock, measureTime } from '@rufflo/testing';
...
```typescript
import { createTestEmitter } from '@rufflo/testing';
...
```typescript
import { MockAgentDB } from '@rufflo/testing';
...
```typescript
import { MockSwarmCoordinator } from '@rufflo/testing';
...
```typescript
import { MockMCPClient, createStandardMockMCPClient } from '@rufflo/testing';
...
```typescript
import { registerCustomMatchers } from '@rufflo/testing';
...
```typescript
import { setupV3Tests, configureTestEnvironment } from '@rufflo/testing';
...
```typescript
import { createSetupContext, createTestScope } from '@rufflo/testing';
...
```typescript
import { createPerformanceTestHelper } from '@rufflo/testing';
...
```typescript
import { assertV3PerformanceTargets, TEST_CONFIG } from '@rufflo/testing';
