...
npx rufflo sparc run batch-executor "process multiple files"

# For alpha features
npx rufflo@alpha sparc run batch-executor "process multiple files"
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run batch-executor "process multiple files"
```
