...
npx rufflo sparc run refinement-optimization-mode "optimize database queries"

# For alpha features
npx rufflo@alpha sparc run refinement-optimization-mode "optimize database queries"

# With namespace
npx rufflo sparc run refinement-optimization-mode "your task" --namespace refinement-optimization-mode

# Non-interactive mode
npx rufflo sparc run refinement-optimization-mode "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run refinement-optimization-mode "optimize database queries"
```
...
```bash
# Store mode-specific context
npx rufflo memory store "refinement-optimization-mode_context" "important decisions" --namespace refinement-optimization-mode

# Query previous work
npx rufflo memory query "refinement-optimization-mode" --limit 5
```
