...
npx rufflo sparc run supabase-admin "create user authentication schema"

# For alpha features
npx rufflo@alpha sparc run supabase-admin "create user authentication schema"

# With namespace
npx rufflo sparc run supabase-admin "your task" --namespace supabase-admin

# Non-interactive mode
npx rufflo sparc run supabase-admin "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run supabase-admin "create user authentication schema"
```
...
```bash
# Store mode-specific context
npx rufflo memory store "supabase-admin_context" "important decisions" --namespace supabase-admin

# Query previous work
npx rufflo memory query "supabase-admin" --limit 5
```
