...
npx rufflo sparc run memory-manager "organize project knowledge"

# For alpha features
npx rufflo@alpha sparc run memory-manager "organize project knowledge"
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run memory-manager "organize project knowledge"
```
