...
npx rufflo sparc run code "implement REST API endpoints"

# For alpha features
npx rufflo@alpha sparc run code "implement REST API endpoints"

# With namespace
npx rufflo sparc run code "your task" --namespace code

# Non-interactive mode
npx rufflo sparc run code "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run code "implement REST API endpoints"
```
...
```bash
# Store mode-specific context
npx rufflo memory store "code_context" "important decisions" --namespace code

# Query previous work
npx rufflo memory query "code" --limit 5
```
