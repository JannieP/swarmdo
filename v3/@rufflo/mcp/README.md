...
[![npm version](https://img.shields.io/npm/v/@rufflo/mcp.svg)](https://www.npmjs.com/package/@rufflo/mcp)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/mcp.svg)](https://www.npmjs.com/package/@rufflo/mcp)
...
- **Zero Dependencies** - No @rufflo/* dependencies

## Installation

```bash
npm install @rufflo/mcp
```

## Quick Start

```typescript
import { quickStart, defineTool } from '@rufflo/mcp';
...
```typescript
import { createMCPServer } from '@rufflo/mcp';
...
```typescript
import { createToolRegistry, defineTool } from '@rufflo/mcp';
...
```typescript
import { createSessionManager } from '@rufflo/mcp';
...
```typescript
import { createConnectionPool } from '@rufflo/mcp';
...
```typescript
import { createMCPServer, createTextResource } from '@rufflo/mcp';
...
```typescript
import { createMCPServer, definePrompt, textMessage, interpolate } from '@rufflo/mcp';
