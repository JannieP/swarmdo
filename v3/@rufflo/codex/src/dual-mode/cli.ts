...
function createTemplateCommand(): Command {
  return new Command('templates')
    ...
    .action(() => {
      ...
      console.log('  Usage: npx rufflo-codex dual run --template feature --task "Add user auth"');
      console.log();
      ...
      console.log('  Usage: npx rufflo-codex dual run --template security --task "src/auth/"');
      console.log();
      ...
      console.log('  Usage: npx rufflo-codex dual run --template refactor --task "src/legacy/"');
      console.log();
...
function printResults(result: CollaborationResult): void {
  ...
  console.log();
  console.log(chalk.gray('View shared memory: npx rufflo@alpha memory list --namespace collaboration'));
}
