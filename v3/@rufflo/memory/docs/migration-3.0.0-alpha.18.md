# Migration Guide — `@rufflo/memory@3.0.0-alpha.18`
...
```diff
- import { UnifiedMemoryService, createHybridService, HnswLite, RvfBackend } from '@rufflo/memory';
+ import { MemoryService, createHybridService } from '@rufflo/memory';
```
...
```ts
import { MemoryService, UnifiedMemoryService } from '@rufflo/memory';
...
import { HnswLite, RvfBackend } from '@rufflo/memory';

// After — if you actually need them, import from the explicit submodule
import { HnswLite } from '@rufflo/memory/hnsw-lite';
import { RvfBackend } from '@rufflo/memory/rvf-backend';
```
...
```diff
- "@rufflo/memory": "^3.0.0-alpha.17"
+ "@rufflo/memory": "^3.0.0-alpha.18"
```
