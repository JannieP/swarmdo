 ...
 *
 * @module @rufflo/memory/learning-bridge
 */
...
export interface LearningBridgeConfig {
   ...
   * When provided, this replaces the default dynamic import of @rufflo/neural.
...
export class LearningBridge extends EventEmitter {
  ...
  private async loadNeural(): Promise<void> {
    try {
      ...
      const mod = await import('@rufflo/neural' as string);
      ...
      // @rufflo/neural not installed or failed to initialize.
