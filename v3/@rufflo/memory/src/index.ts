/**
 * @rufflo/memory - V3 Unified Memory System
 *
 ...
 *
 * @module @rufflo/memory
 *
 * @example
 * ```typescript
 * import { UnifiedMemoryService, query, QueryTemplates } from '@rufflo/memory';
 *
 ...
 *   continue to work through `@rufflo/memory@3.0.0-rc`. Both names refer
 *   to the same class.
 *
 ...
 *
 * `MemoryService` is the preferred name as of `@rufflo/memory@3.0.0-alpha.18`.
 ...
 * `import type { MemoryService } from '@rufflo/memory'` works alongside the
 * value import.
 */
