...
[![npm version](https://img.shields.io/npm/v/@rufflo/neural.svg)](https://www.npmjs.com/package/@rufflo/neural)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/neural.svg)](https://www.npmjs.com/package/@rufflo/neural)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)

> Self-Optimizing Neural Architecture (SONA) for Rufflo V3 — adaptive learning, trajectory tracking, pattern reuse, and 7 RL algorithms in a single package.

## What this is

A self-contained learning module that records agent execution trajectories, distills them into reusable patterns, retrieves matches for new tasks, and adapts via SONA + LoRA + EWC++. Designed to be the substrate that the Rufflo CLI's intelligence layer composes onto — the package owns the algorithms, the CLI owns the orchestration.

## Install

```bash
npm install @rufflo/neural
```
...
import { getMoERouter } from '@rufflo/neural';
...
```typescript
import { createNeuralLearningSystem } from '@rufflo/neural';
...
```typescript
import { createSONAManager, type Trajectory } from '@rufflo/neural';
...
import { createAlgorithm, getDefaultConfig } from '@rufflo/neural';
...
If you're building a Rufflo plugin that wants neural learning, depend on `@rufflo/neural` directly rather than reaching into cli internals.
...
- [`@rufflo/memory`](../memory) — memory backend
- [`@rufflo/cli`](../cli) — primary consumer + MCP tool surface
- [`@rufflo/cli-core`](../cli-core) — lite path (no neural; for plugin scripts)
