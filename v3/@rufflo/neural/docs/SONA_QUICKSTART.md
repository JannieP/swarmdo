...
Already installed: `@rufvector/sona@0.1.5`

## Basic Usage (30 seconds)

```typescript
import { createSONALearningEngine, getModeConfig } from '@rufflo/neural';
...
**Location**: `/workspaces/rufflo/v3/@rufflo/neural/`

**Package**: `@rufvector/sona@0.1.5`
