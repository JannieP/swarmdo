...
Integration of `@rufvector/sona` package (v0.1.5) into the V3 Neural Module.
...
```bash
npm install @rufvector/sona@0.1.5
```
...
import { getModeConfig } from '@rufflo/neural';
...
```typescript
import { SonaEngine, type JsSonaConfig } from '@rufvector/sona';
...
- [SONA Package](https://www.npmjs.com/package/@rufvector/sona)
