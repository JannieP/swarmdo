/**
 * @rufflo/browser - MCP Tools
 * 50+ browser automation tools for rufflo MCP server
 */
...
const MAX_EVAL_SCRIPT_LENGTH = parseInt(process.env.RUFFLO_MAX_EVAL_SCRIPT_LENGTH || '', 10) || DEFAULT_MAX_EVAL_SCRIPT_LENGTH;
