...
[![npm version](https://img.shields.io/npm/v/@rufflo/browser?style=for-the-badge&logo=npm&color=blue)](https://www.npmjs.com/package/@rufflo/browser)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/browser?style=for-the-badge&logo=npm&color=cb3837)](https://www.npmjs.com/package/@rufflo/browser)
...
**AI-Optimized Browser Automation for Rufflo Swarms**

*Integrate [agent-browser](https://github.com/AugmentCode/agent-browser) with rufflo for intelligent web automation, trajectory learning, security scanning, and multi-agent browser coordination.*
...
`@rufflo/browser` provides a comprehensive browser automation layer for AI agents, combining Vercel Labs' `agent-browser` CLI with rufflo's learning, memory, and security capabilities. It enables agents to navigate websites, fill forms, extract data, and learn from successful interaction patterns.
...
npm install @rufflo/cli@^3.0.0-alpha
...
```typescript
import { createBrowserService, browserTools } from '@rufflo/browser';
...
Register browser tools with rufflo's MCP server:

```typescript
import { browserTools } from '@rufflo/browser';
...
```typescript
import { createMemoryManager } from '@rufflo/browser';
...
```typescript
import { listWorkflows, getWorkflow, getWorkflowManager } from '@rufflo/browser';
...
```typescript
import { preBrowseHook, postBrowseHook, browserHooks } from '@rufflo/browser';
...
```typescript
import { createBrowserSwarm } from '@rufflo/browser';
...
```typescript
import { createBrowserService, getSecurityScanner } from '@rufflo/browser';
...
- [Rufflo Documentation](https://github.com/ruvnet/claude-flow#readme)
...
**Part of the [Rufflo](https://github.com/ruvnet/claude-flow) ecosystem**
