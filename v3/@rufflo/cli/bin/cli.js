#!/usr/bin/env node
/**
 * @rufflo/cli - CLI Entry Point
 *
 * Rufflo V3 Command Line Interface
 *
 * Auto-detects MCP mode when stdin is piped and no args provided.
 * This allows: echo '{"jsonrpc":"2.0",...}' | npx @rufflo/cli
 */
...
//   2. stdin is being piped AND args are "mcp start" (explicit, e.g. npx rufflo@alpha mcp start)
