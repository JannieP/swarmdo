#!/usr/bin/env node
// pretrain-from-github.mjs — pretrain rufflo's self-learning system from its
...
// generalisation testing. Defaults preserve rufflo behaviour.
...
async function main() {
  ...
  if (!process.env.BENCH_JSON) {
    console.log(`# Pretrain from rufflo GitHub history`);
