...
// generalises (vs overfits to the rufflo corpus it was tuned on), nDCG@3
// should stay near 0.96.
//
// Usage:
//   1. cd /tmp/agentdb-bench
//   2. REPO_ROOT=/tmp/agentdb-bench GH_REPO=ruvnet/agentdb \
//        node /path/to/pretrain-from-github.mjs    # writes /tmp/agentdb-bench/.rufflo/neural/
