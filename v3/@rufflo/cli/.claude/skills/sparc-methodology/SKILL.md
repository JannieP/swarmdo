...
SPARC (Specification, Pseudocode, Architecture, Refinement, Completion) is a systematic development methodology integrated with Rufflo's multi-agent orchestration capabilities. It provides 17 specialized modes for comprehensive software development, from initial research through deployment and monitoring.
...
npx rufflo sparc tdd "feature description"

# Batch execution
npx rufflo sparc batch <mode1,mode2,mode3> "task"

# Pipeline execution
npx rufflo sparc pipeline "task description"
```

### Method 3: Local Installation

**Best for**: Projects with local rufflo installation
...
mcp__rufflo__agent_spawn { type: "architect" }
mcp__rufflo__agent_spawn { type: "coder" }
mcp__rufflo__agent_spawn { type: "tester" }
mcp__rufflo__agent_spawn { type: "reviewer" }
```
...
[Single Message]:
  mcp__rufflo__agent_spawn { type: "researcher" }
  mcp__rufflo__agent_spawn { type: "coder" }
  mcp__rufflo__agent_spawn { type: "tester" }
  TodoWrite { todos: [8-10 todos] }

// ❌ WRONG: Multiple messages
Message 1: mcp__rufflo__agent_spawn { type: "researcher" }
Message 2: mcp__rufflo__agent_spawn { type: "coder" }
...
```bash
# Before work
npx rufflo@alpha hooks pre-task --description "implement auth"

# During work
npx rufflo@alpha hooks post-edit --file "auth.js"

# After work
npx rufflo@alpha hooks post-task --task-id "task-123"
```
...
npx rufflo sparc run researcher "authentication patterns"

# Step 2: Architecture design
npx rufflo sparc run architect "design auth system"

# Step 3: TDD implementation
npx rufflo sparc tdd "user authentication feature"

# Step 4: Code review
npx rufflo sparc run reviewer "review auth implementation"

# Step 5: Documentation
npx rufflo sparc run documenter "document auth API"
```
...
npx rufflo sparc run analyzer "investigate bug #456"

# Step 2: Debug systematically
npx rufflo sparc run debugger "fix memory leak in service X"

# Step 3: Create tests
npx rufflo sparc run tester "regression tests for bug #456"

# Step 4: Review fix
npx rufflo sparc run reviewer "validate bug fix"
```
...
npx rufflo sparc run analyzer "profile API response times"

# Step 2: Identify bottlenecks
npx rufflo sparc run optimizer "optimize database queries"

# Step 3: Implement improvements
npx rufflo sparc run coder "implement caching layer"

# Step 4: Benchmark results
npx rufflo sparc run tester "performance benchmarks"
```
...
npx rufflo sparc pipeline "e-commerce checkout feature"
...
- **NPM Package**: https://www.npmjs.com/package/rufflo
...
# Run specific mode
npx rufflo sparc run <mode> "task"

# TDD workflow
npx rufflo sparc tdd "feature"

# Full pipeline
npx rufflo sparc pipeline "task"

# Batch execution
npx rufflo sparc batch <modes> "task"
```
...
```javascript
// Initialize swarm
mcp__rufflo__swarm_init { topology: "hierarchical" }

// Execute mode
mcp__rufflo__sparc_mode { mode: "coder", task_description: "..." }

// Monitor progress
mcp__rufflo__swarm_monitor { interval: 5000 }

// Store in memory
mcp__rufflo__memory_usage { action: "store", key: "...", value: "..." }
```
