 ...
 * the hook system. Pure CJS — no ESM imports of @rufflo/memory.
 *
 * Data files (all under .rufflo/data/):
 ...
 * on @rufflo/memory for the initial seed.
 */
