...
async function loadMemoryPackage() {
  ...
  // Strategy 3: ESM import (works when @rufflo/memory is a direct dependency)
  try {
    return await import('@rufflo/memory');
  } catch { /* fall through */ }

  // Strategy 4: Walk up from PROJECT_ROOT looking for @rufflo/memory in any node_modules
