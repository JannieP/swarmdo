...
rufflo pair --start --agent senior-dev

# Start with verification
rufflo pair --start --verify --threshold 0.98
```
...
```bash
rufflo pair --start --mode switch --interval 10m
```
...
rufflo pair --end --save

# End and generate report
rufflo pair --end --report
```
...
rufflo pair --start --git --review-commit
```

### With Testing Frameworks
```bash
# Jest integration
rufflo pair --start --test-framework jest

# Pytest integration
rufflo pair --start --test-framework pytest
```
...
Configure pair programming in `.rufflo/config.json`:
