...
rufflo verify check --file src/critical.js --threshold 0.99

# Verify and auto-fix issues
rufflo verify check --directory src/ --auto-fix

# Get JSON output for CI/CD
rufflo verify check --json > verification.json
```
