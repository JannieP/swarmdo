...
Main swarm orchestration command for Rufflo V3.
...
## Usage
```bash
npx @rufflo/cli@latest swarm init --topology hierarchical
npx @rufflo/cli@latest swarm status  # Only after completion
```
