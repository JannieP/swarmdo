...
```bash
# Test pre-edit hook
npx rufflo hook pre-edit --file test.js

# Test session summary
npx rufflo hook session-end --summary
```
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [{
          "type": "command",
          "command": "npx rufflo hook pre-write --file '${tool.params.file_path}'"
        }]
      }
    ]
  }
