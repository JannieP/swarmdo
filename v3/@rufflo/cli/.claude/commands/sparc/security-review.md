...
npx rufflo sparc run security-review "audit API security"

# For alpha features
npx rufflo@alpha sparc run security-review "audit API security"

# With namespace
npx rufflo sparc run security-review "your task" --namespace security-review

# Non-interactive mode
npx rufflo sparc run security-review "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run security-review "audit API security"
```
...
```bash
# Store mode-specific context
npx rufflo memory store "security-review_context" "important decisions" --namespace security-review

# Query previous work
npx rufflo memory query "security-review" --limit 5
```
