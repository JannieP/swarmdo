...
npx rufflo sparc run debugger "fix authentication issues"

# For alpha features
npx rufflo@alpha sparc run debugger "fix authentication issues"
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run debugger "fix authentication issues"
```
