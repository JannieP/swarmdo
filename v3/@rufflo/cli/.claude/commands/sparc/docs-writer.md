...
npx rufflo sparc run docs-writer "create API documentation"

# For alpha features
npx rufflo@alpha sparc run docs-writer "create API documentation"

# With namespace
npx rufflo sparc run docs-writer "your task" --namespace docs-writer

# Non-interactive mode
npx rufflo sparc run docs-writer "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run docs-writer "create API documentation"
```
...
```bash
# Store mode-specific context
npx rufflo memory store "docs-writer_context" "important decisions" --namespace docs-writer

# Query previous work
npx rufflo memory query "docs-writer" --limit 5
```
