...
npx rufflo sparc run analyzer "analyze codebase performance"

# For alpha features
npx rufflo@alpha sparc run analyzer "analyze codebase performance"
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run analyzer "analyze codebase performance"
```
