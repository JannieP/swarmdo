...
npx rufflo sparc run tutorial "guide me through SPARC methodology"

# For alpha features
npx rufflo@alpha sparc run tutorial "guide me through SPARC methodology"

# With namespace
npx rufflo sparc run tutorial "your task" --namespace tutorial

# Non-interactive mode
npx rufflo sparc run tutorial "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run tutorial "guide me through SPARC methodology"
```
...
```bash
# Store mode-specific context
npx rufflo memory store "tutorial_context" "important decisions" --namespace tutorial

# Query previous work
npx rufflo memory query "tutorial" --limit 5
```
