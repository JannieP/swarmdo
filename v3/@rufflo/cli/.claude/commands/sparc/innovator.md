...
npx rufflo sparc run innovator "innovative solutions for scaling"

# For alpha features
npx rufflo@alpha sparc run innovator "innovative solutions for scaling"
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run innovator "innovative solutions for scaling"
```
