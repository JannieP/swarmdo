...
npx rufflo sparc run workflow-manager "automate deployment"

# For alpha features
npx rufflo@alpha sparc run workflow-manager "automate deployment"
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run workflow-manager "automate deployment"
```
