...
npx rufflo sparc run spec-pseudocode "define payment flow requirements"

# For alpha features
npx rufflo@alpha sparc run spec-pseudocode "define payment flow requirements"

# With namespace
npx rufflo sparc run spec-pseudocode "your task" --namespace spec-pseudocode

# Non-interactive mode
npx rufflo sparc run spec-pseudocode "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run spec-pseudocode "define payment flow requirements"
```
...
```bash
# Store mode-specific context
npx rufflo memory store "spec-pseudocode_context" "important decisions" --namespace spec-pseudocode

# Query previous work
npx rufflo memory query "spec-pseudocode" --limit 5
```
