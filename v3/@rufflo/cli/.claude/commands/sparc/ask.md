...
npx rufflo sparc run ask "help me choose the right mode"

# For alpha features
npx rufflo@alpha sparc run ask "help me choose the right mode"

# With namespace
npx rufflo sparc run ask "your task" --namespace ask

# Non-interactive mode
npx rufflo sparc run ask "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If rufflo is installed locally
./rufflo sparc run ask "help me choose the right mode"
```
...
```bash
# Store mode-specific context
npx rufflo memory store "ask_context" "important decisions" --namespace ask

# Query previous work
npx rufflo memory query "ask" --limit 5
```
