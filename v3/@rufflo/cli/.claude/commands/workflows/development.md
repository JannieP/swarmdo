...
```
Tool: mcp__rufflo__task_orchestrate
Parameters: {
...
npx rufflo workflow dev "REST API with auth"

# Create custom workflow
npx rufflo workflow create --name "api-dev" --steps "design,implement,test,deploy"

# Execute saved workflow
npx rufflo workflow execute api-dev
```