...
## Usage
```bash
npx rufflo hive-mind spawn <objective> [options]
```
...
## Examples
```bash
npx rufflo hive-mind spawn "Build API"
npx rufflo hive-mind spawn "Research patterns" --queen-type adaptive
npx rufflo hive-mind spawn "Build service" --claude
```
