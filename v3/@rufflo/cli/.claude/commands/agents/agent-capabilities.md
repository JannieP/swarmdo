...
Matrix of agent capabilities and their specializations for Rufflo V3.
...
|------------|--------|------------------|
| Flash Attention | memory-specialist, performance-engineer | unverified (no benchmark) |
| HNSW Search | memory-specialist | ~1.9x-4.7x measured |
...
### Swarm Tools
```
hierarchical-coordinator: mcp__rufflo__swarm_*, mcp__rufflo__agent_*
mesh-coordinator: mcp__rufflo__swarm_*, mcp__rufflo__coordination_*
adaptive-coordinator: mcp__rufflo__topology_*, mcp__rufflo__swarm_*
```

### GitHub Tools
```
pr-manager: mcp__github__*, Bash (gh CLI)
code-review-swarm: mcp__github__*, mcp__rufflo__swarm_*
release-manager: mcp__github__*, mcp__rufflo__workflow_*
```
...
npx rufflo agent spawn -t coder --help
