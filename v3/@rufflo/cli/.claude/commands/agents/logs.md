...
```bash
npx rufflo agent logs <agent-id> [options]
```
...
```bash
# View last 50 lines
npx rufflo agent logs coder-lx7m9k2

# View last 100 lines
npx rufflo agent logs coder-lx7m9k2 -n 100

# Follow logs (live)
npx rufflo agent logs coder-lx7m9k2 --follow

# Filter by level
npx rufflo agent logs coder-lx7m9k2 -l error

# Logs since time
npx rufflo agent logs coder-lx7m9k2 --since "1h"
npx rufflo agent logs coder-lx7m9k2 --since "2026-01-08T10:00:00"

# JSON output
npx rufflo agent logs coder-lx7m9k2 --format json
```
...
# Last 30 minutes
npx rufflo agent logs coder-lx7m9k2 --since "30m"

# Specific timestamp
npx rufflo agent logs coder-lx7m9k2 --since "2026-01-08T09:00:00"

# Today's logs
npx rufflo agent logs coder-lx7m9k2 --since "today"
```
...
- `npx rufflo agent status` - Current agent status
- `npx rufflo agent health` - Health monitoring
- `npx rufflo agent metrics` - Performance metrics
