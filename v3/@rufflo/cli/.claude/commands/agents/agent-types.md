---
name: agent-types
description: Complete guide to all 87 available agent types in Rufflo V3
type: reference
---

# Agent Types Reference

Complete guide to all 87 available agent types in Rufflo V3.
...
| `memory-specialist` | AgentDB unification | ~1.9x-4.7x measured search |
| `performance-engineer` | Optimization targets | unverified (no benchmark) speedup |
...
npx rufflo agent spawn --help

# Spawn any agent
npx rufflo agent spawn -t <agent-type>
```
