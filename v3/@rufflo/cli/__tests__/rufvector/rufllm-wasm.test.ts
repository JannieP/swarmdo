/**
 * Tests for rufllm-wasm integration module.
...
vi.mock('node:module', () => ({
  createRequire: vi.fn().mockReturnValue({
    resolve: vi.fn().mockReturnValue('/fake/path/rufllm_wasm_bg.wasm'),
  }),
}));
...
const __WASM_AVAILABLE = await import('../../src/rufvector/rufllm-wasm.js')
  .then((m) => m.isRufllmWasmAvailable())
  .catch(() => false);
const __SKIP_WASM_TESTS = !__WASM_AVAILABLE;

describe.skipIf(__SKIP_WASM_TESTS)('rufllm-wasm integration', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  describe('isRufllmWasmAvailable', () => {
    it('should return true when module is available', async () => {
      const { isRufllmWasmAvailable } = await import('../../src/rufvector/rufllm-wasm.js');
      const available = await isRufllmWasmAvailable();
      expect(available).toBe(true);
    });
  });

  describe('getRufllmStatus', () => {
    it('should return status with version', async () => {
      const { getRufllmStatus } = await import('../../src/rufvector/rufllm-wasm.js');
      const status = await getRufllmStatus();
  ...
  describe('createHnswRouter', () => {
    it('should create router with dimensions and maxPatterns', async () => {
      const { createHnswRouter } = await import('../../src/rufvector/rufllm-wasm.js');
    ...
    it('should enforce HNSW_MAX_SAFE_PATTERNS limit', async () => {
      const { createHnswRouter, HNSW_MAX_SAFE_PATTERNS } = await import('../../src/rufvector/rufllm-wasm.js');
  ...
  describe('createSonaInstant', () => {
    it('should create with default config', async () => {
      const { createSonaInstant } = await import('../../src/rufvector/rufllm-wasm.js');
  ...
  describe('createMicroLora', () => {
    it('should create with config', async () => {
      const { createMicroLora } = await import('../../src/rufvector/rufllm-wasm.js');
  ...
  describe('formatChat', () => {
    it('should format with preset template', async () => {
      const { formatChat } = await import('../../src/rufvector/rufllm-wasm.js');
  ...
  describe('createKvCache', () => {
    it('should create with defaults', async () => {
      const { createKvCache } = await import('../../src/rufvector/rufllm-wasm.js');
  ...
  describe('createGenerateConfig', () => {
    it('should create config JSON', async () => {
      const { createGenerateConfig } = await import('../../src/rufvector/rufllm-wasm.js');
  ...
  describe('createBufferPool', () => {
    it('should create with capacity', async () => {
      const { createBufferPool } = await import('../../src/rufvector/rufllm-wasm.js');
  ...
  describe('createInferenceArena', () => {
    it('should create with raw capacity', async () => {
      const { createInferenceArena } = await import('../../src/rufvector/rufllm-wasm.js');
  ...
  describe('HNSW_MAX_SAFE_PATTERNS', () => {
    it('should be 1024', async () => {
      const { HNSW_MAX_SAFE_PATTERNS } = await import('../../src/rufvector/rufllm-wasm.js');
