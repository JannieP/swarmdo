...
} from '../../src/rufvector/graph-analyzer.js';
...
describe('Graph Analyzer', () => {
  ...
  describe('loadRufVector', () => {
    it('should return null when rufvector is not installed', async () => {
      const result = await loadRufVector();
      // Returns null or IRufVectorGraph interface
