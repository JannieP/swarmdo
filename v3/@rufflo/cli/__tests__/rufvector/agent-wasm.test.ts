...
const mockTemplates = [
  { id: 'coder', name: 'Coder Agent', description: 'Coding assistant', category: 'development', tags: ['code'], version: '1.0.0', author: 'RufVector', builtin: true },
  { id: 'tester', name: 'Testing Agent', description: 'QA agent', category: 'testing', tags: ['test'], version: '1.0.0', author: 'RufVector', builtin: true },
];
...
} from '../../src/rufvector/agent-wasm.js';

// ── Tests ────────────────────────────────────────────────────

// Gate on ACTUAL WASM availability rather than a CI-env guess (see
// rufllm-wasm.test.ts for the rationale): run wherever @rufvector/rvagent-wasm
