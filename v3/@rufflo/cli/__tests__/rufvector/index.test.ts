/**
 * RufVector Integration Tests
 *
 * Tests for the main rufvector module exports and integration.
 */
...
import {
  ...
  fallbackMinCut,
  fallbackLouvain,
} from '../../src/rufvector/index.js';

// Mock all rufvector modules
...
describe('RufVector Module Exports', () => {
  afterEach(() => {
    vi.clearAllMocks();
  });

  describe('isRufvectorAvailable', () => {
    it('should return boolean', async () => {
      const result = await isRufvectorAvailable();
      expect(typeof result).toBe('boolean');
    });

    it('returns true when rufvector resolves (mocked at top of file)', async () => {
      // The top-level vi.mock('@rufvector/core', ...) makes the dynamic
      // import inside isRufvectorAvailable resolve, so the value must be
  ...
  describe('getRufvectorVersion', () => {
    it('should return version string or null', async () => {
      const version = await getRufvectorVersion();
  ...
  describe('Graph Analyzer Functions', () => {
    ...
    it('should export loadRufVector', () => {
      expect(typeof loadRufVector).toBe('function');
    });
...
describe('RufVector Integration Scenarios', () => {
