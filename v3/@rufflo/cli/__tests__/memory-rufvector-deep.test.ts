/**
 * Deep Tests for Memory and RufVector Subsystems
 *
 * Covers:
...
describe('AST Analyzer', () => {
  ...
  beforeEach(async () => {
    const { ASTAnalyzer } = await import('../src/rufvector/ast-analyzer.js');
...
`;
  ...
  describe('createASTAnalyzer factory', () => {
    it('should create analyzer with custom config', async () => {
      const { createASTAnalyzer } = await import('../src/rufvector/ast-analyzer.js');
...
describe('Diff Classifier', () => {
  ...
  beforeEach(async () => {
    const { DiffClassifier } = await import('../src/rufvector/diff-classifier.js');
...
`;
  ...
  describe('assessFileRisk', () => {
    it('should assess security files as high risk', async () => {
      const { assessFileRisk } = await import('../src/rufvector/diff-classifier.js');
  ...
  describe('assessOverallRisk', () => {
    it('should compute overall risk from file risks', async () => {
      const { assessOverallRisk } = await import('../src/rufvector/diff-classifier.js');
      const files = [
  ...
  describe('validateGitRef', () => {
    it('should reject refs with shell metacharacters', async () => {
      const mod = await import('../src/rufvector/diff-classifier.js');
...
describe('Coverage Router', () => {
  ...
  beforeEach(async () => {
    const { CoverageRouter } = await import('../src/rufvector/coverage-router.js');
...
end_of_record`;
  ...
  describe('clearCoverageCache', () => {
    it('should clear cache without error', async () => {
      const { clearCoverageCache, getCoverageCacheStats } = await import('../src/rufvector/coverage-router.js');
      clearCoverageCache();
...
describe('Graph Analyzer', () => {
  describe('detectCircularDependencies', () => {
    it('should detect simple cycles', async () => {
      const { detectCircularDependencies } = await import('../src/rufvector/graph-analyzer.js');
      const graph = {
        nodes: new Map([
  ...
  describe('fallbackMinCut', () => {
    it('should partition graph into two groups', async () => {
      const { fallbackMinCut } = await import('../src/rufvector/graph-analyzer.js');
      const nodes = ['a', 'b', 'c', 'd'];
  ...
  describe('fallbackLouvain', () => {
    it('should detect communities in connected graph', async () => {
      const { fallbackLouvain } = await import('../src/rufvector/graph-analyzer.js');
      const nodes = ['a', 'b', 'c', 'd'];
      const edges: Array<[string, string, number]> = [
        ['a', 'b', 10],
        ['c', 'd', 10],
  ...
  describe('exportToDot', () => {
    it('should generate valid DOT format', async () => {
      const { exportToDot } = await import('../src/rufvector/graph-analyzer.js');
      const result = {
        graph: {
          nodes: new Map([
  ...
  describe('clearGraphCaches / getGraphCacheStats', () => {
    it('should clear and report cache', async () => {
      const { clearGraphCaches, getGraphCacheStats } = await import('../src/rufvector/graph-analyzer.js');
      clearGraphCaches();
...
describe('Q-Learning Router', () => {
  ...
  beforeEach(async () => {
    const { QLearningRouter } = await import('../src/rufvector/q-learning-router.js');
  ...
  describe('export / import', () => {
    it('should export and import Q-table', async () => {
      ...
      const mod = await import('../src/rufvector/q-learning-router.js');
  ...
  describe('createQLearningRouter factory', () => {
    it('should create router with defaults', async () => {
      const { createQLearningRouter } = await import('../src/rufvector/q-learning-router.js');
...
describe('Registry API', () => {
  ...
  it('should reject invalid ratings', async () => {
    const api = await import('../src/services/registry-api.js');
    await expect(api.rateItem('@rufflo/test', 0)).rejects.toThrow('Rating must be integer 1-5');
    await expect(api.rateItem('@rufflo/test', 6)).rejects.toThrow('Rating must be integer 1-5');
  });

  it('should reject non-integer ratings', async () => {
    const api = await import('../src/services/registry-api.js');
    await expect(api.rateItem('@rufflo/test', 3.5)).rejects.toThrow('Rating must be integer 1-5');
  });
  ...
  it('should accept valid item IDs with scopes', async () => {
    ...
    try {
      await api.getRating('@rufflo/test-plugin', 'plugin');
    } catch (e: any) {
...
// =============================================================================
// RufVector Index Module
// =============================================================================

describe('RufVector Index', () => {
  it('should export all major components', async () => {
    const rufvector = await import('../src/rufvector/index.js');
    expect(rufvector.ASTAnalyzer).toBeDefined();
    expect(rufvector.DiffClassifier).toBeDefined();
    expect(rufvector.CoverageRouter).toBeDefined();
    expect(rufvector.QLearningRouter).toBeDefined();
    expect(rufvector.createASTAnalyzer).toBeDefined();
    expect(rufvector.createDiffClassifier).toBeDefined();
    expect(rufvector.createCoverageRouter).toBeDefined();
    expect(rufvector.createQLearningRouter).toBeDefined();
  });

  it('should export factory functions', async () => {
    const rufvector = await import('../src/rufvector/index.js');
    expect(typeof rufvector.createASTAnalyzer).toBe('function');
    expect(typeof rufvector.createDiffClassifier).toBe('function');
    expect(typeof rufvector.createCoverageRouter).toBe('function');
    expect(typeof rufvector.createQLearningRouter).toBe('function');
  });

  it('should export isRufvectorAvailable', async () => {
    const rufvector = await import('../src/rufvector/index.js');
    expect(typeof rufvector.isRufvectorAvailable).toBe('function');
    const available = await rufvector.isRufvectorAvailable();
    expect(typeof available).toBe('boolean');
  });

  it('should export graph analyzer utilities', async () => {
    const rufvector = await import('../src/rufvector/index.js');
    expect(typeof rufvector.detectCircularDependencies).toBe('function');
    expect(typeof rufvector.fallbackMinCut).toBe('function');
    expect(typeof rufvector.fallbackLouvain).toBe('function');
    expect(typeof rufvector.exportToDot).toBe('function');
  });

  it('should export diff analysis tools', async () => {
    const rufvector = await import('../src/rufvector/index.js');
    expect(typeof rufvector.assessFileRisk).toBe('function');
    expect(typeof rufvector.assessOverallRisk).toBe('function');
    expect(typeof rufvector.classifyDiff).toBe('function');
  });

  it('should export cache control functions', async () => {
    const rufvector = await import('../src/rufvector/index.js');
    expect(typeof rufvector.clearDiffCache).toBe('function');
    expect(typeof rufvector.clearAllDiffCaches).toBe('function');
    expect(typeof rufvector.clearCoverageCache).toBe('function');
    expect(typeof rufvector.clearGraphCaches).toBe('function');
  });
});
