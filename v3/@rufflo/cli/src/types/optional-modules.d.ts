...
// Optional @rufflo sibling packages (installed separately)
// Using permissive `any` types since these are runtime-resolved optional deps
declare module '@rufflo/embeddings' {
  const mod: any;
  export default mod;
...
declare module '@rufflo/aidefence' {
