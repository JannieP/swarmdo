...
// Known compatibility matrix between @rufflo packages
const COMPATIBILITY_MATRIX: Record<string, Record<string, PackageCompatibility>> = {
  '@rufflo/cli': {
    '@rufflo/embeddings': { minVersion: '3.0.0-alpha.1' },
    '@rufflo/security': { minVersion: '3.0.0-alpha.1' },
    '@rufflo/integration': { minVersion: '3.0.0-alpha.1' },
  },
  '@rufflo/embeddings': {
    '@rufflo/cli': { minVersion: '3.0.0-alpha.50' },
  },
  '@rufflo/integration': {
    '@rufflo/cli': { minVersion: '3.0.0-alpha.70' },
