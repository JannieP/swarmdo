...
async function main() {
  ...
  if (failed === 0) {
    ...
    console.log('    npx @rufflo/cli patterns list');
    console.log('    npx @rufflo/cli patterns list --featured');
    console.log('    npx @rufflo/cli patterns search -q "agent"');
    console.log('    npx @rufflo/cli patterns info -n <pattern-id>');
    console.log('');
  }
