...
export const DEFAULT_PLUGIN_STORE_CONFIG: PluginStoreConfig = {
  registries: [
    {
      name: 'rufflo-official',
      description: 'Official Rufflo plugin registry',
  ...
  defaultRegistry: 'rufflo-official',
  gateway: 'https://gateway.pinata.cloud',
  timeout: 30000,
  cacheDir: '.rufflo/plugins/cache',
...
export class PluginDiscoveryService {
  ...
  private async createDemoRegistryAsync(registry: KnownPluginRegistry): Promise<PluginDiscoveryResult> {
    ...
    const demoRegistry: PluginRegistry = {
      ...
      totalDownloads: plugins.reduce((sum, p) => sum + p.downloads, 0),
      totalAuthors: 1,
      featured: ['@rufflo/plugin-iot-cognitum', '@rufflo/plugin-agent-federation', '@rufflo/plugin-agentic-qe', '@rufflo/plugin-prime-radiant', '@rufflo/security', '@rufflo/claims', '@rufflo/teammate-plugin'],
      trending: ['@rufflo/plugin-iot-cognitum', '@rufflo/plugin-agent-federation', '@rufflo/plugin-agentic-qe', '@rufflo/plugin-prime-radiant'],
      newest: ['@rufflo/plugin-iot-cognitum', '@rufflo/plugin-agent-federation', '@rufflo/plugin-agentic-qe', '@rufflo/plugin-prime-radiant'],
      official: ['@rufflo/plugin-iot-cognitum', '@rufflo/plugin-agent-federation', '@rufflo/plugin-agentic-qe', '@rufflo/plugin-prime-radiant', '@rufflo/security', '@rufflo/claims'],
      compatibilityMatrix: [
        { pluginId: '@rufflo/neural', pluginVersion: '3.0.0', claudeFlowVersions: ['3.x'], tested: true },
        { pluginId: '@rufflo/security', pluginVersion: '3.0.0', claudeFlowVersions: ['3.x'], tested: true },
      ],
    };
    ...
    return [
      {
        ...
        dependencies: [{ name: '@rufflo/core', version: '^3.0.0' }],
        type: 'core',
      ...
      {
        id: '@rufflo/embeddings',
        name: '@rufflo/embeddings',
        ...
        minClaudeFlowVersion: '3.0.0',
        dependencies: [
          { name: '@rufflo/core', version: '^3.0.0' },
      ...
      {
        id: '@rufflo/performance',
        name: '@rufflo/performance',
      ...
      },
      {
        ...
        description: 'Analytics and metrics visualization for Rufflo operations',
        version: '1.2.0',
      ...
      // Plugin SDK - Unified Plugin SDK for creating plugins
      {
        ...
        description: 'Unified Plugin SDK for Rufflo V3 - Worker, Hook, and Provider Integration. Create, test, and publish Rufflo plugins.',
      ...
      {
        id: '@rufflo/plugin-prime-radiant',
        name: '@rufflo/plugin-prime-radiant',
      ...
      {
        id: '@rufflo/plugin-healthcare-clinical',
      ...
      {
        id: '@rufflo/plugin-financial-risk',
      ...
      {
        id: '@rufflo/plugin-legal-contracts',
      ...
      {
        id: '@rufflo/plugin-code-intelligence',
      ...
      {
        id: '@rufflo/plugin-test-intelligence',
      ...
      {
        id: '@rufflo/plugin-perf-optimizer',
      ...
      {
        id: '@rufflo/plugin-neural-coordination',
        name: '@rufflo/plugin-neural-coordination',
      ...
      {
        id: '@rufflo/plugin-quantum-optimizer',
      ...
      {
        id: '@rufflo/plugin-hyperbolic-reasoning',
      ...
      {
        id: '@rufflo/plugin-gastown-bridge',
      ...
      {
        id: '@rufflo/plugin-agent-federation',
        name: '@rufflo/plugin-agent-federation',
        ...
        minClaudeFlowVersion: '3.0.0',
        dependencies: [{ name: '@rufflo/security', version: '^3.0.0' }],
        type: 'integration',
      ...
      {
        id: '@rufflo/plugin-iot-cognitum',
        name: '@rufflo/plugin-iot-cognitum',
        displayName: 'IoT Cognitum',
        description: 'Cognitum Seed device-agent bridge — treat every Seed as a Rufflo agent with 5-tier trust scoring, Ed25519 witness chains, mesh networking, and fleet management.',
        version: '1.0.0-alpha.1',
        ...
        minClaudeFlowVersion: '3.0.0',
        dependencies: [
          { name: '@rufflo/shared', version: '^3.0.0' },
      ...
      {
        id: '@rufflo/teammate-plugin',
        name: '@rufflo/teammate-plugin',
  ...
  private async getDemoPluginsWithStats(): Promise<PluginEntry[]> {
    ...
    const realNpmPackages = [
      '@rufflo/plugin-agentic-qe',
      '@rufflo/plugin-prime-radiant',
      '@rufflo/claims',
      '@rufflo/security',
      '@rufflo/plugins',
      '@rufflo/embeddings',
