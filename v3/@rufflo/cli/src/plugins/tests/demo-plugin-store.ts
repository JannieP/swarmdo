...
async function demo() {
  ...
  if (pluginCreator) {
    ...
    console.log('   $ rufflo plugins install -n plugin-creator');
    console.log('');
  }
  ...
  console.log('   $ rufflo plugins list              # List all plugins');
  console.log('   $ rufflo plugins list --official   # Official only');
  console.log('   $ rufflo plugins search -q neural  # Search plugins');
  console.log('   $ rufflo plugins info -n plugin-creator');
  console.log('   $ rufflo plugins install -n plugin-creator');
  console.log('');
}
