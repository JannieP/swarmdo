 ...
 *
 * Usage:
 *   npx @rufflo/cli headless --worker <type>
 *   npx @rufflo/cli headless --daemon
...
function showHelp(): void {
  console.log(`
Headless Runtime for Rufflo V3
...
async function runBenchmarks(): Promise<BenchmarkResults> {
  console.log('=== Rufflo V3 Performance Benchmarks ===\n');
...
async function showStatus(): Promise<void> {
  console.log('=== Rufflo V3 System Status ===\n');
