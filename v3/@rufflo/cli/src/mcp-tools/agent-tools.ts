...
// #1916: hive-mind_spawn writes its workers to `.rufflo/agents.json`
// (a *different* file from the canonical `.rufflo/agents/store.json`
...
// #1916: read hive-mind-spawned workers from `.rufflo/agents.json`.
...
export const agentTools: MCPTool[] = [
  ...
  {
    // #1916 — the `rufflo agent logs <id>` CLI subcommand and the guidance
