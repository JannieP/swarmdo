...
export const sessionTools: MCPTool[] = [
  ...
  },
  {
    ...
    handler: async (input) => {
      ...
      // while the auto-session writer (rufflo daemon) writes
  ...
  {
    // #1916: `rufflo session current` referenced an unregistered
  ...
  {
    // #1916: `rufflo session export <id> -o <file>` referenced an unregistered
  ...
  {
    // #1916: `rufflo session import <file>` referenced an unregistered
