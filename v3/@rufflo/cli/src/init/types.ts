...
export interface InitComponents {
  ...
  mcp: boolean;
  /** Create .rufflo/ directory (V3 runtime) */
  runtime: boolean;
...
export interface InitOptions {
  ...
  /**
   * Skip the user-global ~/.claude/CLAUDE.md "Rufflo Integration" pointer block.
