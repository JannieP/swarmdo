...
const profileCommand: Command = {
  ...
  examples: [
    { command: 'rufflo performance profile -t cpu', description: 'Profile CPU usage' },
    { command: 'rufflo performance profile -d 60', description: 'Profile for 60 seconds' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const metricsCommand: Command = {
  ...
  examples: [
    { command: 'rufflo performance metrics -t 7d', description: 'Show 7-day metrics' },
    { command: 'rufflo performance metrics -f prometheus', description: 'Export as Prometheus format' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const optimizeCommand: Command = {
  ...
  examples: [
    { command: 'rufflo performance optimize -t memory', description: 'Optimize memory usage' },
    { command: 'rufflo performance optimize --apply', description: 'Apply all optimizations' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const bottleneckCommand: Command = {
  ...
  examples: [
    { command: 'rufflo performance bottleneck', description: 'Find bottlenecks' },
    { command: 'rufflo performance bottleneck -d full', description: 'Full analysis' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    output.writeln();
...
export const performanceCommand: Command = {
  ...
  examples: [
    { command: 'rufflo performance benchmark', description: 'Run benchmarks' },
    { command: 'rufflo performance profile', description: 'Profile application' },
    { command: 'rufflo perf metrics', description: 'View metrics (alias)' },
  ],
  action: async (): Promise<CommandResult> => {
    output.writeln();
    output.writeln(output.bold('Rufflo Performance Suite'));
