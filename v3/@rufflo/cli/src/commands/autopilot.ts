...
export const autopilotCommand: Command = {
  ...
  examples: [
    { command: 'rufflo autopilot status', description: 'Show current state and progress' },
    { command: 'rufflo autopilot enable', description: 'Enable persistent completion' },
    { command: 'rufflo autopilot config --max-iterations 100 --timeout 180', description: 'Configure limits' },
    { command: 'rufflo autopilot predict', description: 'Get recommended next action' },
  ],
  action: async (): Promise<CommandResult> => {
