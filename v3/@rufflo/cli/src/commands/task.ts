...
export const taskCommand: Command = {
  ...
  examples: [
    ...
    { command: 'rufflo task list', description: 'List pending/running tasks' },
    { command: 'rufflo task list --all', description: 'List all tasks' },
    { command: 'rufflo task status task-123', description: 'Get task details' },
    { command: 'rufflo task cancel task-123', description: 'Cancel a task' },
    { command: 'rufflo task assign task-123 --agent coder-1', description: 'Assign task to agent' },
    { command: 'rufflo task retry task-123', description: 'Retry a failed task' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    output.writeln();
    output.writeln('Usage: rufflo task <subcommand> [options]');
    output.writeln();
    ...
    output.writeln();
    output.writeln('Run "rufflo task <subcommand> --help" for subcommand help');
