 ...
 *   npx rufflo ruvector setup --output /path/to/dir
 *   npx rufflo ruvector setup --print      # Print to stdout only
 *
...
-- from ruvnet/ruvector-postgres with Rufflo V3 integration.
--
...
This directory contains the Docker configuration for RuVector PostgreSQL with Rufflo V3.
...
export const setupCommand: Command = {
  ...
  examples: [
    { command: 'rufflo ruvector setup', description: 'Output files to ./ruvector-postgres/' },
    { command: 'rufflo ruvector setup --output /path/to/dir', description: 'Output to custom directory' },
    { command: 'rufflo ruvector setup --print', description: 'Print files to stdout' },
    { command: 'rufflo ruvector setup --force', description: 'Overwrite existing files' },
  ],
