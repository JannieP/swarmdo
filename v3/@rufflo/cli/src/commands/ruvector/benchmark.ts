...
export const benchmarkCommand: Command = {
  ...
  examples: [
    { command: 'rufflo ruvector benchmark', description: 'Run default benchmark' },
    { command: 'rufflo ruvector benchmark --vectors 50000', description: 'Benchmark with 50k vectors' },
    { command: 'rufflo ruvector benchmark --index ivfflat', description: 'Test IVFFlat index' },
    { command: 'rufflo ruvector benchmark --dimensions 768 --metric l2', description: 'Custom dimensions and metric' },
  ],
