...
export const optimizeCommand: Command = {
  ...
  examples: [
    { command: 'rufflo ruvector optimize --analyze', description: 'Analyze and show recommendations' },
    { command: 'rufflo ruvector optimize --apply', description: 'Apply optimizations' },
    { command: 'rufflo ruvector optimize --vacuum', description: 'Run VACUUM ANALYZE' },
    { command: 'rufflo ruvector optimize --reindex', description: 'Rebuild all indexes' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      output.printBox([
        ...
        '',
        'Quick commands:',
        `  rufflo ruvector optimize --vacuum    # Clean up tables`,
        `  rufflo ruvector optimize --reindex  # Rebuild indexes`,
        `  rufflo ruvector optimize --apply    # Apply critical fixes`,
