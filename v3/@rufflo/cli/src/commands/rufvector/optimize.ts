/**
 * V3 CLI RufVector Optimize Command
...
export const optimizeCommand: Command = {
  ...
  examples: [
    { command: 'rufflo rufvector optimize --analyze', description: 'Analyze and show recommendations' },
    { command: 'rufflo rufvector optimize --apply', description: 'Apply optimizations' },
    { command: 'rufflo rufvector optimize --vacuum', description: 'Run VACUUM ANALYZE' },
    { command: 'rufflo rufvector optimize --reindex', description: 'Rebuild all indexes' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    output.writeln();
    output.writeln(output.bold('RufVector Optimization Analysis'));
    ...
    try {
      ...
      output.printBox([
        ...
        '',
        'Quick commands:',
        `  rufflo rufvector optimize --vacuum    # Clean up tables`,
        `  rufflo rufvector optimize --reindex  # Rebuild indexes`,
        `  rufflo rufvector optimize --apply    # Apply critical fixes`,
