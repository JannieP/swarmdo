/**
 * V3 CLI RufVector Benchmark Command
 * Performance benchmarking for RufVector PostgreSQL Bridge
 */
...
export const benchmarkCommand: Command = {
  ...
  examples: [
    { command: 'rufflo rufvector benchmark', description: 'Run default benchmark' },
    { command: 'rufflo rufvector benchmark --vectors 50000', description: 'Benchmark with 50k vectors' },
    { command: 'rufflo rufvector benchmark --index ivfflat', description: 'Test IVFFlat index' },
    { command: 'rufflo rufvector benchmark --dimensions 768 --metric l2', description: 'Custom dimensions and metric' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    output.writeln();
    output.writeln(output.bold('RufVector Performance Benchmark'));
