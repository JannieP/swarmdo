...
export const issuesCommand: Command = {
  ...
  examples: [
    { command: 'rufflo issues list', description: 'List all claims' },
    { command: 'rufflo issues claim 123 --agent coder:coder-1', description: 'Claim as agent' },
    { command: 'rufflo issues handoff 123 --to agent:tester:tester-1', description: 'Handoff to tester' },
    { command: 'rufflo issues stealable', description: 'List stealable' },
    { command: 'rufflo issues steal 123 --agent coder:coder-2', description: 'Steal issue' },
    { command: 'rufflo issues board', description: 'Visual board' },
  ],
