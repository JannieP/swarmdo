 ...
 *
 * @module @rufflo/cli/commands/progress
 */
...
export const progressCommand: Command = {
  ...
  examples: [
    {
      command: 'rufflo progress',
      description: 'Check current progress',
    },
    {
      command: 'rufflo progress --detailed',
      description: 'Show detailed breakdown',
    },
    {
      command: 'rufflo progress sync',
      description: 'Sync and persist progress',
    },
    {
      command: 'rufflo progress watch',
      description: 'Watch for changes',
    },
    {
      command: 'rufflo progress --json',
