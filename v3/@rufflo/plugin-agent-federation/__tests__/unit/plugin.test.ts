...
describe('AgentFederationPlugin', () => {
  ...
  describe('interface compliance', () => {
    it('should have name set to @rufflo/plugin-agent-federation', () => {
      expect(plugin.name).toBe('@rufflo/plugin-agent-federation');
    });
    ...
    it('should have author set to Rufflo Team', () => {
      expect(plugin.author).toBe('Rufflo Team');
    });

    it('should declare @rufflo/security as a dependency', () => {
      expect(plugin.dependencies).toContain('@rufflo/security');
    });

    it('should declare @rufflo/aidefence as a dependency', () => {
      expect(plugin.dependencies).toContain('@rufflo/aidefence');
    });
