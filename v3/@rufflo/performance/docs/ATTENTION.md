...
```typescript
import { createFlashAttentionOptimizer } from '@rufflo/performance';
...
```typescript
import { quickBenchmark } from '@rufflo/performance';
...
```typescript
import { quickValidation } from '@rufflo/performance';
...
```typescript
import { runAndDisplaySuite } from '@rufflo/performance';
...
```bash
# Run all examples
npx tsx v3/@rufflo/performance/src/examples/flash-attention-demo.ts
```
...
```typescript
import { FlashAttentionOptimizer } from '@rufflo/performance';
