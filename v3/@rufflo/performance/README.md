...
[![npm version](https://img.shields.io/npm/v/@rufflo/performance.svg)](https://www.npmjs.com/package/@rufflo/performance)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/performance.svg)](https://www.npmjs.com/package/@rufflo/performance)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-Vitest-green.svg)](https://vitest.dev/)

> Comprehensive performance benchmarking module for Rufflo V3 - statistical analysis, memory tracking, regression detection, and Flash Attention validation.
...
```bash
npm install @rufflo/performance
```
...
```typescript
import { benchmark } from '@rufflo/performance';
...
- [@rufflo/memory](../memory) - Memory operations to benchmark
- [@rufflo/swarm](../swarm) - Swarm coordination to benchmark
- [@rufflo/neural](../neural) - Neural operations to benchmark
