...
[![npm version](https://img.shields.io/npm/v/@rufflo/providers.svg)](https://www.npmjs.com/package/@rufflo/providers)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/providers.svg)](https://www.npmjs.com/package/@rufflo/providers)
...
```bash
npm install @rufflo/providers
```

## Quick Start

```typescript
import { createProviderManager } from '@rufflo/providers';
...
```typescript
import { ProviderManager, createProviderManager } from '@rufflo/providers';
...
```typescript
import { createProviderManager } from '@rufflo/providers';
import { createUnifiedSwarmCoordinator } from '@rufflo/swarm';
...
- [@rufflo/embeddings](../embeddings) - Embedding generation
- [@rufflo/memory](../memory) - Vector storage and retrieval
