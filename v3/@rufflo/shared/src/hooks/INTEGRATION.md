...
```typescript
import { createEventBus } from '@rufflo/shared/core';
import { createHookRegistry, createHookExecutor } from '@rufflo/shared/hooks';
import { EventStore } from '@rufflo/shared/events';
...
```typescript
import { HookEvent, HookContext } from '@rufflo/shared/hooks';
...
import { Plugin } from '@rufflo/shared';
import { HookEvent, HookPriority } from '@rufflo/shared/hooks';
...
```typescript
// v3/@rufflo/shared/src/mcp/tools/hooks.ts
