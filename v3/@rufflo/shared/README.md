...
[![npm version](https://img.shields.io/npm/v/@rufflo/shared.svg)](https://www.npmjs.com/package/@rufflo/shared)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/shared.svg)](https://www.npmjs.com/package/@rufflo/shared)
...
> Shared utilities, types, and core infrastructure for Rufflo V3 - the foundation module used by all other @rufflo packages.
...
import { ... } from '@rufflo/shared';

// Submodule exports (for tree-shaking or specific imports)
import { ... } from '@rufflo/shared/types';      // Type definitions
import { ... } from '@rufflo/shared/core';       // Config, interfaces, orchestrator
import { ... } from '@rufflo/shared/events';     // Event sourcing (ADR-007)
import { ... } from '@rufflo/shared/hooks';      // Hooks system
import { ... } from '@rufflo/shared/mcp';        // MCP server infrastructure
import { ... } from '@rufflo/shared/security';   // Security utilities
import { ... } from '@rufflo/shared/resilience'; // Retry, circuit breaker, rate limiter
```
...
```typescript
import { EventBus, EventCoordinator } from '@rufflo/shared/events';
...
```typescript
import { HooksManager, Hook } from '@rufflo/shared/hooks';
...
```typescript
import { HealthMonitor, HealthCheck } from '@rufflo/shared/core';
...
This package is a dependency of all other @rufflo modules:

- [@rufflo/cli](../cli) - CLI module
- [@rufflo/security](../security) - Security & validation
- [@rufflo/memory](../memory) - AgentDB & HNSW indexing
- [@rufflo/neural](../neural) - SONA learning & RL algorithms
- [@rufflo/performance](../performance) - Benchmarking & optimization
- [@rufflo/swarm](../swarm) - 15-agent coordination
- [@rufflo/integration](../integration) - agentic-flow@alpha bridge
- [@rufflo/testing](../testing) - TDD framework & fixtures
- [@rufflo/deployment](../deployment) - Release management
- [@rufflo/embeddings](../embeddings) - Embedding service
- [@rufflo/hooks](../hooks) - Hooks system
