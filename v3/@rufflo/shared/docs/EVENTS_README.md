...
Complete event sourcing implementation for V3 Rufflo with persistent storage, projections, and event replay.
...
Part of rufflo V3 - See root LICENSE file.
