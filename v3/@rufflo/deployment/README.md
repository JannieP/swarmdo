...
[![npm version](https://img.shields.io/npm/v/@rufflo/deployment.svg)](https://www.npmjs.com/package/@rufflo/deployment)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/deployment.svg)](https://www.npmjs.com/package/@rufflo/deployment)
...
> Release management, CI/CD, and versioning module for Rufflo v3.
...
```typescript
import { prepareRelease } from '@rufflo/deployment';
...
```typescript
import { publishToNpm } from '@rufflo/deployment';
...
```typescript
import { validate } from '@rufflo/deployment';
...
```typescript
import { Publisher } from '@rufflo/deployment';
...
```typescript
import { Validator } from '@rufflo/deployment';
