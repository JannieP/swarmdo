...
[![npm version](https://img.shields.io/npm/v/@rufflo/security.svg)](https://www.npmjs.com/package/@rufflo/security)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/security.svg)](https://www.npmjs.com/package/@rufflo/security)
...
> Comprehensive security module for Rufflo V3 - CVE fixes, input validation, path security, and secure credential management.
...
```typescript
import { createSecurityModule } from '@rufflo/security';
...
```typescript
import { PasswordHasher, createPasswordHasher } from '@rufflo/security';
...
```typescript
import { CredentialGenerator, generateCredentials } from '@rufflo/security';
...
```typescript
import { SafeExecutor, createDevelopmentExecutor } from '@rufflo/security';
...
```typescript
import { PathValidator, createProjectPathValidator } from '@rufflo/security';
...
// Sanitize HTML
import { sanitizeHtml } from '@rufflo/security';
...
```typescript
import { TokenGenerator, quickGenerate } from '@rufflo/security';
...
```typescript
import { auditSecurityConfig } from '@rufflo/security';
...
- [@rufflo/swarm](../swarm) - Swarm coordination (secure agent spawning)
