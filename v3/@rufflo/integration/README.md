...
[![npm version](https://img.shields.io/npm/v/@rufflo/integration.svg)](https://www.npmjs.com/package/@rufflo/integration)
[![npm downloads](https://img.shields.io/npm/dm/@rufflo/integration.svg)](https://www.npmjs.com/package/@rufflo/integration)
...
> Deep agentic-flow@alpha integration module for Rufflo V3 - ADR-001 compliance, code deduplication, SONA adapter, and Flash Attention coordinator.
...
- **Flash Attention** - unverified (no benchmark) speedup with attention coordination
...
```bash
npm install @rufflo/integration
...
```typescript
import { AgenticFlowBridge, createAgenticFlowBridge } from '@rufflo/integration';
...
| Metric | Target |
|--------|--------|
| Flash Attention speedup | unverified (no benchmark) |
| AgentDB search | ~1.9x-4.7x measured faster |
...
- [@rufflo/neural](../neural) - SONA learning module
- [@rufflo/memory](../memory) - AgentDB memory
- [@rufflo/performance](../performance) - Benchmarking
