/**
 * @rufflo/integration - V3 Integration Module
 *
 ...
 * Usage:
 * ```typescript
 * import { createAgenticFlowBridge } from '@rufflo/integration';
 *
...
export const METADATA = {
  name: '@rufflo/integration',
  version: VERSION,
  description: 'Deep agentic-flow@alpha integration for rufflo v3',
  implements: ['ADR-001'],
  features: [
