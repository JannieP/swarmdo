# @rufvector/rvf-solver

[![npm](https://img.shields.io/npm/v/@rufvector/rvf-solver)](https://www.npmjs.com/package/@rufvector/rvf-solver)
[![license](https://img.shields.io/npm/l/@rufvector/rvf-solver)](https://github.com/ruvnet/ruvector/blob/main/LICENSE)
...
```bash
npm install @rufvector/rvf-solver
```

Or via the unified SDK:

```bash
npm install @rufvector/rvf
```
...
```typescript
import { RvfSolver } from '@rufvector/rvf-solver';
...
When using the `@rufvector/rvf` unified SDK, the solver is available as a sub-module:

```typescript
import { RvfSolver } from '@rufvector/rvf';
...
| Package | Description |
|---------|-------------|
| [`@rufvector/rvf`](https://www.npmjs.com/package/@rufvector/rvf) | Unified TypeScript SDK |
| [`@rufvector/rvf-node`](https://www.npmjs.com/package/@rufvector/rvf-node) | Native N-API bindings for Node.js |
| [`@rufvector/rvf-wasm`](https://www.npmjs.com/package/@rufvector/rvf-wasm) | Browser WASM package |
| [`@rufvector/rvf-mcp-server`](https://www.npmjs.com/package/@rufvector/rvf-mcp-server) | MCP server for AI agents |
...
- [npm Package](https://www.npmjs.com/package/@rufvector/rvf-solver)
