/**
 * @rufvector/rvagent-wasm smoke test (node:test).
 * Fork of the upstream @ruvector/rvagent-wasm (prebuilt WASM/dist; package renamed
...
test('package.json name is the @rufvector fork name', async () => {
  ...
  assert.equal(pkg.name, '@rufvector/rvagent-wasm', 'name renamed to fork');
});
