...
export declare function getNativeModule(): NativeRufLLM | null;
export declare function version(): string;
export declare function hasSimdSupport(): boolean;
export type { NativeRufLLM, NativeConfig, NativeEngine, NativeGenConfig, NativeQueryResponse, NativeRoutingDecision, NativeMemoryResult, NativeStats, NativeSimdOps, };
