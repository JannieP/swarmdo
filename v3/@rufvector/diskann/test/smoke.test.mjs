/**
 * @rufvector/diskann smoke test (node:test).
 * Mirrors rufflo usage (diskann-backend.ts): construct, insert, build, search.
 */
import { test } from 'node:test';
import assert from 'node:assert/strict';

const { DiskAnn } = await import('@rufvector/diskann');
