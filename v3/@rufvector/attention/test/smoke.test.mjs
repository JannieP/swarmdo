/**
 * @rufvector/attention smoke test (node:test).
 * Mirrors rufflo usage: construct an attention mechanism and call computeRaw.
 */
...
test('compute + computeRaw shim return the same dim-length vector', () => {
  ...
  // compatibility shim: rufflo calls computeRaw, which the fork aliases to compute
  assert.equal(typeof a.computeRaw, 'function', 'computeRaw alias present (rufflo compat)');
