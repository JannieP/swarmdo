/**
 * @rufvector/rabitq-wasm smoke test (node:test).
 * Fork of the upstream @ruvector/rabitq-wasm (prebuilt WASM/dist; package renamed
...
test('package.json name is the @rufvector fork name', async () => {
  ...
  assert.equal(pkg.name, '@rufvector/rabitq-wasm', 'name renamed to fork');
});
