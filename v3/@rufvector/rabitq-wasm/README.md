...
[![npm](https://img.shields.io/npm/v/@rufvector/rabitq-wasm.svg)](https://www.npmjs.com/package/@rufvector/rabitq-wasm)
...
```bash
npm install @rufvector/rabitq-wasm
```

## Usage (browser)

```js
import init, { RabitqIndex } from "@rufvector/rabitq-wasm";
...
```js
import { RabitqIndex } from "@rufvector/rabitq-wasm/node/ruvector_rabitq_wasm.js";
...
```js
import { RabitqIndex } from "@rufvector/rabitq-wasm/bundler/ruvector_rabitq_wasm.js";
...
- [`@rufvector/acorn-wasm`](https://www.npmjs.com/package/@rufvector/acorn-wasm) — predicate-agnostic filtered HNSW (when you also need to filter results by metadata).
- [`@rufvector/graph-wasm`](https://www.npmjs.com/package/@rufvector/graph-wasm) — Cypher-compatible hypergraph database in WASM.
- [`ruvector`](https://www.npmjs.com/package/ruvector), [`@rufvector/core`](https://www.npmjs.com/package/@rufvector/core) — Node.js NAPI bindings for the full ruvector engine.
