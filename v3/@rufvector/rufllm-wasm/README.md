# @rufvector/ruvllm-wasm

[![npm](https://img.shields.io/npm/v/@rufvector/ruvllm-wasm.svg)](https://www.npmjs.com/package/@rufvector/ruvllm-wasm)
...
```bash
npm install @rufvector/ruvllm-wasm
```
...
```javascript
import { ParallelInference, feature_summary } from '@rufvector/ruvllm-wasm';
...
- [`@rufvector/ruvllm`](https://www.npmjs.com/package/@rufvector/ruvllm) — Node.js LLM orchestration
