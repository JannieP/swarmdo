/**
 * @rufvector/rvf smoke test (node:test).
 * Fork of the upstream @ruvector/rvf (prebuilt WASM/dist; package renamed
...
test('package loads via its published entry', async () => {
  const mod = await import('@rufvector/rvf');
...
test('package.json name is the @rufvector fork name', async () => {
  ...
  assert.equal(pkg.name, '@rufvector/rvf', 'name renamed to fork');
});
