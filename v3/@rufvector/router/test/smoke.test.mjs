/**
 * @rufvector/router smoke test (node:test).
 *
 * Locks in the fork and mirrors rufflo's usage (diskann-backend.ts /
...
test('HNSW construct + insert + search (rufflo usage shape)', () => {
