 ...
 *
 * Bridge to rufvector-hyperbolic-hnsw-wasm for hierarchical data representation
...
export class HyperbolicBridge implements WasmBridge<HyperbolicModule> {
  readonly name = 'rufvector-hyperbolic-hnsw-wasm';
  ...
  async init(): Promise<void> {
    ...
    try {
      const wasmModule = await import('@rufvector/hyperbolic-hnsw-wasm').catch(() => null);
