 ...
 *
 * Bridge to rufvector-gnn-wasm for graph-based learning and inference.
 */
...
export class GnnBridge implements WasmBridge<GnnModule> {
  readonly name = 'rufvector-gnn-wasm';
  ...
  async init(): Promise<void> {
    ...
    try {
      const wasmModule = await import('@rufvector/gnn-wasm').catch(() => null);
