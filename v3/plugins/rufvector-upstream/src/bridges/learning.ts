 ...
 *
 * Bridge to rufvector-learning-wasm for RL algorithms including
...
export class LearningBridge implements WasmBridge<LearningModule> {
  readonly name = 'rufvector-learning-wasm';
  ...
  async init(): Promise<void> {
    ...
    try {
      const wasmModule = await import('@rufvector/learning-wasm').catch(() => null);
