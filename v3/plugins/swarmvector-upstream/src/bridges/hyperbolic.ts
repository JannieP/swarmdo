 ...
 *
 * Bridge to swarmvector-hyperbolic-hnsw-wasm for hierarchical data representation
...
export class HyperbolicBridge implements WasmBridge<HyperbolicModule> {
  readonly name = 'swarmvector-hyperbolic-hnsw-wasm';
  ...
  async init(): Promise<void> {
    ...
    try {
      const wasmModule = await import('@swarmvector/hyperbolic-hnsw-wasm').catch(() => null);
