 ...
 *
 * Bridge to swarmvector-learning-wasm for RL algorithms including
...
export class LearningBridge implements WasmBridge<LearningModule> {
  readonly name = 'swarmvector-learning-wasm';
  ...
  async init(): Promise<void> {
    ...
    try {
      const wasmModule = await import('@swarmvector/learning-wasm').catch(() => null);
