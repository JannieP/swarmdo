 ...
 *
 * Bridge to swarmvector-exotic-wasm for quantum-inspired algorithms including
...
export class ExoticBridge implements WasmBridge<ExoticModule> {
  readonly name = 'swarmvector-exotic-wasm';
  ...
  async init(): Promise<void> {
    ...
    try {
      const wasmModule = await import('@swarmvector/exotic-wasm').catch(() => null);
