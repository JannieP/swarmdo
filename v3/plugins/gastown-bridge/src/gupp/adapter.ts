 ...
 *
 * Bridge between GUPP work tracking and Swarmdo session management.
...
/**
 * Session manager interface (Swarmdo compatible)
 */
...
/**
 * GUPP Adapter - Bridge between Gas Town work tracking and Swarmdo sessions
 *
