 ...
 *
 * Bridge between GUPP work tracking and Rufflo session management.
...
/**
 * Session manager interface (Rufflo compatible)
 */
...
/**
 * GUPP Adapter - Bridge between Gas Town work tracking and Rufflo sessions
 *
