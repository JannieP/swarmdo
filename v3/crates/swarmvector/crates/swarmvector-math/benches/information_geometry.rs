...
use swarmvector_math::information_geometry::{FisherInformation, KFACApproximation, NaturalGradient};
...
fn bench_kfac(c: &mut Criterion) {
    ...
    for (input_dim, output_dim) in [(32, 16), (64, 32), (128, 64)] {
        ...
        // K-FAC update
        let mut kfac =
            swarmvector_math::information_geometry::KFACApproximation::new(&[(input_dim, output_dim)]);
