//! Real Benchmarks for SwarmVector Core
//!
//! These are ACTUAL performance measurements, not simulations.
//! Run with: cargo bench -p swarmvector-core --bench real_benchmark
...
fn bench_distance(c: &mut Criterion) {
    use swarmvector_core::distance::{cosine_distance, dot_product_distance, euclidean_distance};
...
fn bench_quantization(c: &mut Criterion) {
    use swarmvector_core::quantization::{QuantizedVector, ScalarQuantized};
