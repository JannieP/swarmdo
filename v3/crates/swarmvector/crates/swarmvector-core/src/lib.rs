...
/// Cross-integration helpers for the upstream crate ecosystem.
///
/// Provides [`integration::FannAdapter`] for the upstream repo layer-embedding storage
...
pub use error::{Result, SwarmvectorError};
