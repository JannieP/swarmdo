...
/// Query configuration for SwarmVector searches
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SwarmvectorQuery {
...
impl Default for SwarmvectorQuery {
    fn default() -> Self {
        Self {
            vector: None,
            text: None,
...
impl SwarmvectorQuery {
    ...
    /// # Example
    /// ```
    /// use swarmvector_gnn::query::SwarmvectorQuery;
    ///
    /// let query = SwarmvectorQuery::vector_search(vec![0.1, 0.2, 0.3], 10);
    ...
    /// use swarmvector_gnn::query::SwarmvectorQuery;
    ///
    /// let query = SwarmvectorQuery::neural_search(vec![0.1, 0.2, 0.3], 10, 3);
    ...
    /// use swarmvector_gnn::query::SwarmvectorQuery;
    ///
    /// let query = SwarmvectorQuery::subgraph_search(vec![0.1, 0.2, 0.3], 20);
...
impl QueryResult {
    ...
    /// # Example
    /// ```
    /// use swarmvector_gnn::query::QueryResult;
    ///
...
mod tests {
    ...
    #[test]
    fn test_swarmvector_query_default() {
        let query = SwarmvectorQuery::default();
        assert_eq!(query.k, 10);
    ...
    fn test_vector_search_query() {
        ...
        let query = SwarmvectorQuery::vector_search(vector.clone(), 5);
    ...
    fn test_neural_search_query() {
        ...
        let query = SwarmvectorQuery::neural_search(vector.clone(), 10, 3);
    ...
    fn test_subgraph_search_query() {
        ...
        let query = SwarmvectorQuery::subgraph_search(vector.clone(), 20);
    ...
    fn test_differentiable_search_query() {
        ...
        let query = SwarmvectorQuery::differentiable_search(vector.clone(), 15, 0.5);
    ...
    fn test_query_builder_pattern() {
        let query = SwarmvectorQuery::vector_search(vec![0.1, 0.2], 5)
    ...
    fn test_query_serialization() {
        let query = SwarmvectorQuery::neural_search(vec![0.1, 0.2], 5, 2);
        let json = serde_json::to_string(&query).unwrap();
        let deserialized: SwarmvectorQuery = serde_json::from_str(&json).unwrap();
