//! # SwarmVector GNN
//!
//! Graph Neural Network capabilities for SwarmVector, providing tensor operations,
...
pub use layer::SwarmvectorLayer;
pub use query::{QueryMode, QueryResult, SwarmvectorQuery, SubGraph};
