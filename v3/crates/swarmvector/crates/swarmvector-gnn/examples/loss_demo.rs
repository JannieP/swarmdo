...
//!
//! Run with: cargo run -p swarmvector-gnn --example loss_demo

use ndarray::Array2;
use swarmvector_gnn::training::{Loss, LossType, Optimizer, OptimizerType};

fn main() {
    println!("=== SwarmVector GNN Loss Functions Demo ===\n");
