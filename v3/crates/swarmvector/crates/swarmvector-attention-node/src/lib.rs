//! swarmvector-attention-node
//!
//! Node.js bindings for swarmvector-attention via NAPI-RS
//!
...
pub fn info() -> LibraryInfo {
    LibraryInfo {
        name: "swarmvector-attention-node".to_string(),
        version: env!("CARGO_PKG_VERSION").to_string(),
        description: "Node.js bindings for swarmvector-attention".to_string(),
        features: vec![
