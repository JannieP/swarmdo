...
```javascript
const { DotProductAttention } = require('@swarmvector/attention');
...
```javascript
const { MultiHeadAttention } = require('@swarmvector/attention');
...
```javascript
const { FlashAttention } = require('@swarmvector/attention');
...
```javascript
const { HyperbolicAttention } = require('@swarmvector/attention');
...
```javascript
const { MoEAttention } = require('@swarmvector/attention');
...
```javascript
const { Trainer, AdamOptimizer } = require('@swarmvector/attention');
...
```javascript
const { BatchProcessor, parallelAttentionCompute } = require('@swarmvector/attention');
