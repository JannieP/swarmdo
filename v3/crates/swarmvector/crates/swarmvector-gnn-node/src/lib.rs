//! Node.js bindings for Swarmvector GNN via NAPI-RS
//!
//! This module provides JavaScript bindings for the Swarmvector GNN library,
...
use swarmvector_gnn::{
    ...
    layer::SwarmvectorLayer as RustSwarmvectorLayer,
    search::{
...
impl SwarmvectorLayer {
    ...
    pub fn new(input_dim: u32, hidden_dim: u32, heads: u32, dropout: f64) -> Result<Self> {
        let inner = RustSwarmvectorLayer::new(
            input_dim as usize,
            hidden_dim as usize,
            heads as usize,
            dropout as f32,
    ...
    pub fn from_json(json: String) -> Result<Self> {
        let inner: RustSwarmvectorLayer = serde_json::from_str(&json).map_err(|e| {
            Error::new(
                Status::GenericFailure,
...
pub fn hierarchical_forward(
    ...
    let gnn_layers: Vec<RustSwarmvectorLayer> = gnn_layers_json
        .iter()
        .map(|json| {
...
#[napi]
pub fn init() -> String {
    "Swarmvector GNN Node.js bindings initialized".to_string()
}
