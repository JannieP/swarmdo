...
//! staleness-weighted window `w(d_t)` from `swarmvector_sona::auto_tuner`: it scores
...
//!
//! Run: `cargo run -p swarmvector-sona --release --example darwin_autotuner`

use rand::rngs::StdRng;
use rand::{Rng, SeedableRng};
use swarmvector_sona::auto_tuner::{StalenessSchedule, StalenessWindow};
use swarmvector_sona::{EwcConfig, EwcPlusPlus};
