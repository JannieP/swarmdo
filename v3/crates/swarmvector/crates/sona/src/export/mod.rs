...
//!
//! ```rust,ignore
//! use swarmvector_sona::export::{HuggingFaceExporter, ExportConfig};
//!
...
This adapter was generated using [SONA (Self-Optimizing Neural Architecture)](https://github.com/ruvnet/swarmvector/tree/main/crates/sona).
...
Generated with [swarmvector-sona](https://crates.io/crates/swarmvector-sona) v0.1.0
"#,
