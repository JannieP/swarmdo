...
use swarmvector_core::advanced::hypergraph::{
    CausalMemory as CoreCausalMemory, Hyperedge as CoreHyperedge,
    HypergraphIndex as CoreHypergraphIndex,
};
use swarmvector_core::DistanceMetric;
use swarmvector_graph::cypher::{parse_cypher, Statement};
use swarmvector_graph::node::NodeBuilder;
use swarmvector_graph::storage::GraphStorage;
use swarmvector_graph::GraphDB;
                ...
                match statement {
                    Statement::Match(match_clause) => {
                        ...
                        for pattern in &match_clause.patterns {
                            if let swarmvector_graph::cypher::ast::Pattern::Node(node_pattern) =
                                pattern
                            {
...
#[napi]
pub fn hello() -> String {
    "Hello from SwarmVector Graph Node.js bindings!".to_string()
}
