# Swarmvector Tiny Dancer Node

[![npm](https://img.shields.io/npm/v/@swarmvector/tiny-dancer-node.svg)](https://www.npmjs.com/package/@swarmvector/tiny-dancer-node)
[![Crates.io](https://img.shields.io/crates/v/swarmvector-tiny-dancer-node.svg)](https://crates.io/crates/swarmvector-tiny-dancer-node)
...
```bash
npm install @swarmvector/tiny-dancer-node
# or
yarn add @swarmvector/tiny-dancer-node
# or
pnpm add @swarmvector/tiny-dancer-node
```
...
```typescript
import { TinyDancer, RouteRequest } from '@swarmvector/tiny-dancer-node';
...
```typescript
import { TinyDancer, TrainingData } from '@swarmvector/tiny-dancer-node';
...
```typescript
import { TinyDancer } from '@swarmvector/tiny-dancer-node';
...
- **[swarmvector-tiny-dancer-core](../swarmvector-tiny-dancer-core/)** - Core Rust implementation
- **[swarmvector-tiny-dancer-wasm](../swarmvector-tiny-dancer-wasm/)** - WebAssembly bindings
