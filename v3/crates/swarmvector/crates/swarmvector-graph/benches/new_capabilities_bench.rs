...
//!
//! Run with: cargo bench --package swarmvector-graph --bench new_capabilities_bench

use criterion::{black_box, criterion_group, criterion_main, BenchmarkId, Criterion};
use swarmvector_graph::cypher::parser::parse_cypher;
use swarmvector_graph::hybrid::semantic_search::{SemanticSearch, SemanticSearchConfig};
use swarmvector_graph::hybrid::vector_index::{EmbeddingConfig, HybridIndex, VectorIndexType};
