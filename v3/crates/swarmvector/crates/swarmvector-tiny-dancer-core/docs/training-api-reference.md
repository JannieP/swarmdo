...
## Module: `swarmvector_tiny_dancer_core::training`
...
```rust
use swarmvector_tiny_dancer_core::training::generate_teacher_predictions;
...
```rust
use swarmvector_tiny_dancer_core::training::BatchIterator;
