...
```rust
use swarmvector_tiny_dancer_core::{Router, RouterConfig};
...
```rust
use swarmvector_tiny_dancer_core::{TracingConfig, TracingSystem};
...
```rust
use swarmvector_tiny_dancer_core::TraceContext;
...
```rust
use swarmvector_tiny_dancer_core::RoutingSpan;
...
async fn metrics_handler(
    router: Arc<swarmvector_tiny_dancer_core::Router>
) -> String {
