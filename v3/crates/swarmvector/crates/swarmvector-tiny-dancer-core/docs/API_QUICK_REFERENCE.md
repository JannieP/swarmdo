...
```toml
[dependencies]
swarmvector-tiny-dancer-core = { version = "0.1", features = ["admin-api"] }
...
```rust
use swarmvector_tiny_dancer_core::api::{
...
- **Core:** `/home/user/swarmvector/crates/swarmvector-tiny-dancer-core/src/api.rs`
- **Example:** `/home/user/swarmvector/crates/swarmvector-tiny-dancer-core/examples/admin-server.rs`
- **Docs:** `/home/user/swarmvector/crates/swarmvector-tiny-dancer-core/docs/API.md`
