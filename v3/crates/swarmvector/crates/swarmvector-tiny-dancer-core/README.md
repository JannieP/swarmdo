...
```toml
[dependencies]
swarmvector-tiny-dancer-core = "0.1.1"
```

### Basic Usage

```rust
use swarmvector_tiny_dancer_core::{
    Router,
...
```rust
use swarmvector_tiny_dancer_core::{Router, types::*};
...
```rust
use swarmvector_tiny_dancer_core::feature_engineering::{FeatureEngineer, FeatureConfig};
...
```rust
use swarmvector_tiny_dancer_core::Router;
...
```rust
use swarmvector_tiny_dancer_core::model::{FastGRNN, FastGRNNConfig};
...
```rust
use swarmvector_tiny_dancer_core::storage::Storage;
...
- **WASM**: [swarmvector-tiny-dancer-wasm](../swarmvector-tiny-dancer-wasm) - Browser/edge deployment
- **Node.js**: [swarmvector-tiny-dancer-node](../swarmvector-tiny-dancer-node) - TypeScript bindings
- **Swarmvector**: [swarmvector-core](../swarmvector-core) - Vector database
