...
//!
//! Demonstrates the full pipeline the way `@swarmvector/tiny-dancer` would use it:
...
//!
//! Run:  cargo run --example train_from_draco -p swarmvector-tiny-dancer-core

use std::collections::HashMap;

use swarmvector_tiny_dancer_core::model::{FastGRNN, FastGRNNConfig};
use swarmvector_tiny_dancer_core::training::{DracoRow, Trainer, TrainingConfig, TrainingDataset};
