//! # RufVector GNN
//!
//! Graph Neural Network capabilities for RufVector, providing tensor operations,
...
pub use layer::RufvectorLayer;
pub use query::{QueryMode, QueryResult, RufvectorQuery, SubGraph};
