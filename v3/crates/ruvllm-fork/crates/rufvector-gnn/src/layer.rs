...
mod tests {
    ...
    #[test]
    fn test_rufvector_layer() {
        let layer = RufvectorLayer::new(4, 8, 2, 0.1).unwrap();
    ...
    #[test]
    fn test_rufvector_layer_no_neighbors() {
        let layer = RufvectorLayer::new(4, 8, 2, 0.1).unwrap();
    ...
    #[test]
    fn test_rufvector_layer_invalid_dropout() {
        let result = RufvectorLayer::new(4, 8, 2, 1.5);
        assert!(result.is_err());
    }

    #[test]
    fn test_rufvector_layer_invalid_heads() {
        let result = RufvectorLayer::new(4, 7, 3, 0.1);
        assert!(result.is_err());
    }
}
