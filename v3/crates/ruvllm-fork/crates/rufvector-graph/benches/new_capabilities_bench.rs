...
//!
//! Run with: cargo bench --package rufvector-graph --bench new_capabilities_bench

use criterion::{black_box, criterion_group, criterion_main, BenchmarkId, Criterion};
use rufvector_graph::cypher::parser::parse_cypher;
use rufvector_graph::hybrid::semantic_search::{SemanticSearch, SemanticSearchConfig};
use rufvector_graph::hybrid::vector_index::{EmbeddingConfig, HybridIndex, VectorIndexType};
