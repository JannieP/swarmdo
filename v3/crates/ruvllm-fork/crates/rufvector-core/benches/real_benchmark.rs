//! Real Benchmarks for RufVector Core
//!
//! These are ACTUAL performance measurements, not simulations.
//! Run with: cargo bench -p rufvector-core --bench real_benchmark
...
fn bench_distance(c: &mut Criterion) {
    use rufvector_core::distance::{cosine_distance, dot_product_distance, euclidean_distance};
...
fn bench_quantization(c: &mut Criterion) {
    use rufvector_core::quantization::{QuantizedVector, ScalarQuantized};
