...
//! cargo bench -p rufllm --bench ruvltra_benchmark
//!
//! # Specific scenario
//! cargo bench -p rufllm --bench ruvltra_benchmark -- short_prompt
//!
//! # With Metal GPU
//! cargo bench -p rufllm --features metal-compute --bench ruvltra_benchmark
//!
//! # With ANE
//! cargo bench -p rufllm --features coreml --bench ruvltra_benchmark
//!
//! # With parallel execution
//! cargo bench -p rufllm --features parallel --bench ruvltra_benchmark
//! ```
...
fn bench_backend_comparison(c: &mut Criterion) {
    ...
    #[cfg(all(target_os = "macos", feature = "coreml"))]
    {
        group.bench_function("ane_gemv_simulated", |b| {
            b.iter(|| {
                // In practice, this would use rufllm::kernels::ane_ops
