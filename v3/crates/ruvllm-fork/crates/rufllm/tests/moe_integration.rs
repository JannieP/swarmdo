...
//!
//! Test commands:
//! - All gates: `cargo test -p rufllm moe_integration`
//! - G1 only: `cargo test -p rufllm gate_1`
//! - G3 only: `cargo test -p rufllm gate_3`
//! - G4 only: `cargo test -p rufllm gate_4`

#[cfg(test)]
mod moe_integration {
    use rufllm::bitnet::expert_cache::{
