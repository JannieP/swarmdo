//! Intelligent Auto-Detection System for RufLLM
//!
...
//!
//! ```rust,ignore
//! use rufllm::autodetect::{SystemCapabilities, InferenceConfig};
//!
...
impl CpuFeatures {
    ...
    fn detect_avx2_runtime() -> bool {
        ...
        {
            // rufllm always links std; no `feature = "std"` gate needed.
