...
//!
//! This module implements QAT infrastructure for rufLLM as specified in ADR-090 Phase 2.
...
//!
//! ```rust,ignore
//! use rufllm::qat::{QatConfig, SteVariant, QuantGranularity};
//!
...
//!
//! ```rust,ignore
//! use rufllm::qat::{QatConfig, DifferentiableQuantizer, PiQuantDifferentiable, create_quantizer};
//!
...
///
/// ```rust,ignore
/// let quantizer = rufllm::qat::piq3_quantizer();
/// ```
...
///
/// ```rust,ignore
/// let quantizer = rufllm::qat::piq2_quantizer();
/// ```
...
///
/// ```rust,ignore
/// let quantizer = rufllm::qat::uniform_quantizer(4);
/// ```
