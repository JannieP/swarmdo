...
//!
//! ```rust,ignore
//! use rufllm::claude_flow::{ModelRouter, SelectionCriteria, ClaudeModel};
//!
...
//!
//! ```rust,ignore
//! use rufllm::claude_flow::{AgentCoordinator, ClaudeModel, AgentType, WorkflowStep};
//!
...
//!
//! ```rust,ignore
//! use rufllm::claude_flow::{PretrainPipeline, PretrainConfig, Phase};
//!
...
//!
//! ```rust,ignore
//! use rufllm::claude_flow::{TaskGenerator, TaskCategory, TaskComplexity};
//!
...
//! using rufvector-core's HNSW index. It supports:
//!
...
//!
//! ```rust,ignore
//! use rufllm::claude_flow::{HnswRouter, HnswRouterConfig, TaskPattern, AgentType, ClaudeFlowTask};
//!
