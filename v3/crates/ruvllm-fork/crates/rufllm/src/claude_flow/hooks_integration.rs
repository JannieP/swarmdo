...
//!
//! Unified interface for Claude Flow CLI hooks to leverage all RufLLM v2.3 capabilities:
//!
...
//!
//! ```rust,ignore
//! use rufllm::claude_flow::{HooksIntegration, HooksConfig, PreTaskInput, PostTaskInput};
//!
