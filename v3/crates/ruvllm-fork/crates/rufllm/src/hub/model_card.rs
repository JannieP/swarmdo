...
impl ModelCard {
    ...
    pub fn to_markdown(&self) -> String {
        ...
        content.push_str("# Download using rufllm CLI\n");
        content.push_str(&format!("rufllm pull {}\n", self.name.to_lowercase()));
        content.push_str("```\n\n");

        content.push_str("```rust\n");
        content.push_str("use rufllm::hub::ModelDownloader;\n\n");
        ...
        // Footer
        content.push_str("---\n\n");
        content.push_str("*This model card was generated automatically by RufLLM*\n");
