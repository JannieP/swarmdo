...
//! - Structurally aware (conditioned on RufVector neighborhood)
...
/// Trait for retrieving neighbors from the evidence store (e.g., RufVector).
...
///
/// For larger corpora, use RufVector's HNSW index as the retriever.
#[derive(Clone)]
