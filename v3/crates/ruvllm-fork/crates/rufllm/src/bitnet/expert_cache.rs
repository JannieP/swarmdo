...
///
/// ```rust,ignore
/// use rufllm::bitnet::expert_cache::{ExpertCache, ExpertCacheConfig};
///
...
impl ExpertCache {
    ...
    /// ```rust,ignore
    /// use rufllm::bitnet::expert_cache::{ExpertCache, ExpertCacheConfig};
    /// use rufllm::moe::{ExpertAffinity, AffinityConfig};
    ///
    /// let mut cache = ExpertCache::new(8, ExpertCacheConfig::default());
...
///
/// ```rust,ignore
/// use rufllm::bitnet::expert_cache::align_to_cache_line;
///
