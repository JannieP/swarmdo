...
//!
//! ```rust,ignore
//! use rufllm::backends::{HybridPipeline, HybridPipelineConfig, AneStrategy};
//!
...
///
/// ```rust,ignore
/// use rufllm::backends::{HybridPipeline, HybridPipelineConfig};
///
...
impl HybridPipeline {
    ...
    pub fn flash_attention(
        ...
        let ctx = self.metal_ctx.as_ref().ok_or_else(|| {
            RufLLMError::HybridPipeline("Metal context not available".to_string())
        })?;
    ...
    pub fn flash_attention(
        ...
        Err(RufLLMError::HybridPipeline(
