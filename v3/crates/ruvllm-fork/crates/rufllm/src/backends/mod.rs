//! LLM inference backends for RufLLM
//!
...
//!
//! ```rust,ignore
//! use rufllm::backends::{CandleBackend, ModelConfig, GenerateParams};
//!
...
//!
//! ```rust,ignore
//! use rufllm::backends::{MistralBackend, MistralBackendConfig, ModelConfig, GenerateParams};
//! use std::path::Path;
//!
...
/// Model architecture types supported by RufLLM.
///
/// RufLLM supports multiple transformer architectures with varying
...
///
/// ```rust,ignore
/// use rufllm::backends::ModelArchitecture;
///
...
/// speed at the cost of some quality. RufLLM supports multiple formats
...
///
/// ```rust,ignore
/// use rufllm::backends::Quantization;
///
...
///
/// ```rust,ignore
/// use rufllm::backends::{ModelConfig, ModelArchitecture, Quantization, DeviceType};
///
/// let config = ModelConfig {
///     architecture: ModelArchitecture::Mistral,
///     quantization: Some(Quantization::Q4K),
...
///
/// ```rust,ignore
/// use rufllm::backends::GenerateParams;
///
...
///
/// ```rust,ignore
/// use rufllm::backends::{TokenStream, StreamEvent};
///
...
///
/// ```rust,ignore
/// use rufllm::backends::{LlmBackend, ModelConfig, GenerateParams, create_backend};
///
