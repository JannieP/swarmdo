...
//!
//! Integrates RufLLM with the SONA (Self-Optimizing Neural Architecture) framework
    ...
    pub fn trigger_background_loop(&self) -> Result<()> {
        ...
        // Add trajectories to reasoning bank for pattern extraction
        {
            ...
            for traj in &trajectories {
                ...
                let query_traj = rufvector_sona::QueryTrajectory::new(
