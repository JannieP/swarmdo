//! SONA Learning Integration for RufLLM
//!
//! This module provides SONA (Self-Optimizing Neural Architecture) integration
//! for the RufLLM inference runtime, including:
//!
...
//!
//! ```rust,ignore
//! use rufllm::sona::{SonaIntegration, SonaConfig, RuvLtraPretrainConfig, RuvLtraPretrainer};
//!
//! // Runtime integration
