...
//!
//! ```rust,ignore
//! use rufllm::moe::precision_allocator::{PrecisionAllocator, PrecisionConfig, ExpertPrecision};
//! use rufllm::gguf::GgufQuantType;
//!
...
///
/// ```rust,ignore
/// use rufllm::moe::precision_allocator::{PrecisionAllocator, PrecisionConfig};
///
/// let config = PrecisionConfig::default();
/// let mut allocator = PrecisionAllocator::new(8, config).unwrap();
///
