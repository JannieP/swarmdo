...
//! RufLLM Evaluation CLI
//!
//! Run real LLM evaluations using SWE-Bench tasks with the full RufLLM stack.
//!
//! ## Usage
//!
//! ```bash
//! # Run evaluation with a GGUF model on sample tasks
//! cargo run -p rufllm --example run_eval --features candle -- \
...
//!
//! - `RUFLLM_MODELS_DIR`: Default directory for model files
//! - `RUFLLM_CACHE_DIR`: Cache directory for downloaded datasets

use rufllm::backends::ModelConfig;
use rufllm::evaluation::{
