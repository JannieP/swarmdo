...
//! RufLLM Hub CLI - Manage models on HuggingFace Hub
//!
...
//! cargo run -p rufllm --example hub_cli -- pull ruvltra-small
//!
//! # Push a custom model to HuggingFace Hub
//! HF_TOKEN=your_token cargo run -p rufllm --example hub_cli -- push \
//!   --model ./my-model.gguf \
//!   --repo username/my-ruvltra \
//!   --description "My custom RuvLTRA model"
//!
//! # List available models in registry
//! cargo run -p rufllm --example hub_cli -- list
//!
//! # Show detailed model information
//! cargo run -p rufllm --example hub_cli -- info ruvltra-small
//! ```
//!
//! ## Environment Variables
//!
//! - `HF_TOKEN`: HuggingFace token (required for push operations)
//! - `RUFLLM_MODELS_DIR`: Default cache directory for downloaded models
...
fn cmd_info(args: &[String]) {
    ...
    println!(
        "  cargo run -p rufllm --example hub_cli -- pull {}",
        model_id
    );
...
fn print_help() {
    println!("RufLLM Hub CLI - Manage models on HuggingFace Hub\n");
    println!("USAGE:");
