...
//!
//! ```rust,ignore
//! use rufvector_sona::export::{HuggingFaceExporter, ExportConfig};
//!
...
This adapter was generated using [SONA (Self-Optimizing Neural Architecture)](https://github.com/ruvnet/rufvector/tree/main/crates/sona).
...
Generated with [rufvector-sona](https://crates.io/crates/rufvector-sona) v0.1.0
"#,
