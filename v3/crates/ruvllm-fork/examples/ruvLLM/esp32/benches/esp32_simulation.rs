...
use rufllm_esp32::quantized::{QuantizationType, matmul_int8, QuantParams};
use rufllm_esp32::attention::MicroAttention;
...
fn benchmark_quantization(c: &mut Criterion) {
    ...
    use rufllm_esp32::quantized::QuantizedTensor;
