//! Simulation Tests for ESP32 RufLLM
//!
...
// Import the crate
use rufllm_esp32::prelude::*;
use rufllm_esp32::model::ModelConfig;
use rufllm_esp32::quantized::{QuantizationType, QuantizedTensor, matmul_int8, binary_xnor_popcount, QuantParams};
use rufllm_esp32::attention::{MicroAttention, LinearAttention, SlidingWindowAttention};
use rufllm_esp32::embedding::{EmbeddingTable, RotaryEmbedding, SimpleTokenizer};
