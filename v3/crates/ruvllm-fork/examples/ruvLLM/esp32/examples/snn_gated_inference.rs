...
//! handle always-on event detection, while RufLLM runs only when needed.
//!
//! # The Key Insight
//! ```text
...
//! ├─────────────────────────────────────────────────────────────────────────┤
//! │                                                                         │
//! │   Sensors ──▶ SNN Front-End ──▶ Event? ──▶ RufVector ──▶ RufLLM         │
...
enum RouteDecision {
    ...
    LocalResponse,
    /// Query RufVector memory
    FetchMemory,
    /// Run RufLLM for generation
    RunLLM,
