...
//! for different ESP32 cluster scales with rufvector optimizations.

use std::collections::HashMap;

fn main() {
    println!("╔═══════════════════════════════════════════════════════════════════════╗");
    println!("║     RufLLM ESP32 - Model Sizing & Rufvector Configuration Guide        ║");
    ...
    println!("┌──────────────┬────────────┬─────────────┬─────────────────────────────┐");
    println!("│ Variant      │ Total SRAM │ Model RAM   │ With Rufvector Optimizations │");
    println!("├──────────────┼────────────┼─────────────┼─────────────────────────────┤");

    for (name, total, model_ram) in &variants {
        // Rufvector optimizations: binary quantization (32x), product quantization (16x)
    ...
    // ============================================================
    // 4. Rufvector Feature Configurations
    // ============================================================
    println!("═══ Rufvector Optimization Configurations ═══\n");
    ...
    // ============================================================
    // 7. Rufvector Vector DB Integration
    // ============================================================
    println!("═══ Rufvector Vector DB Integration ═══\n");

    println!("ESP32 clusters can run rufvector's vector database for RAG:\n");
