...
use rufllm_esp32::optimizations::{
...
fn main() {
    println!("╔═══════════════════════════════════════════════════════════════╗");
    println!("║     RufLLM ESP32 - 5-Chip Federation Benchmark                ║");
    println!("║     With Self-Learning & Rufvector Optimizations               ║");
    println!("╚═══════════════════════════════════════════════════════════════╝\n");
    ...
    for _ in 0..BENCHMARK_ITERS / 10 {
        // Create draft
        let mut draft = rufllm_esp32::federation::speculative::DraftResult {
