// RufLLM ESP32 - Tiny LLM Inference Demo
// This example shows how to run a tiny language model on ESP32

use rufllm_esp32::prelude::*;
use rufllm_esp32::rufvector::{MicroRAG, RAGConfig};

fn main() {
    println!("=== RufLLM ESP32 Demo ===");
            ...
            match MicroEngine::new(model) {
                Ok(mut engine) => {
                    ...
                    let knowledge_entries = [
                        ...
                        "RufLLM supports INT8 quantization",
                    ...
                    println!("\n=== Demo Complete ===");
                    println!("RufLLM ESP32 is ready for deployment!");
                }
                Err(e) => {
