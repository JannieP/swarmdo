...
--      Can be set per-session: SET swarmvector.ef_search = 100;
*/
...
-- swarmvector.ef_search = 40          # Query-time candidate list size
-- swarmvector.maintenance_work_mem    # Use standard PostgreSQL setting

-- Session settings:
-- SET swarmvector.ef_search = 100;    # Increase recall for current session
