...
The types are ready for integration into the swarmvector-postgres extension and provide a solid foundation for billion-scale vector search in PostgreSQL.
