...
This document describes the three native quantized vector types implemented for swarmvector-postgres, providing massive compression ratios with minimal accuracy loss.
