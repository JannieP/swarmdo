...
pub fn swarmvector_persistent_homology(
    points_json: JsonB,
...
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_betti_numbers(
    points_json: JsonB,
    radius: f32,
...
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_bottleneck_distance(diag_a_json: JsonB, diag_b_json: JsonB) -> f32 {
...
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_persistence_wasserstein(
    diag_a_json: JsonB,
    diag_b_json: JsonB,
    p: default!(i32, 2),
) -> f32 {
...
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_topological_summary(points_json: JsonB, max_dim: default!(i32, 1)) -> JsonB {
    let cloud = parse_point_cloud(&points_json);
    if cloud.is_empty() {
        return JsonB(serde_json::json!({}));
    }
...
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_embedding_drift(old_json: JsonB, new_json: JsonB) -> JsonB {
...
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_vietoris_rips(
    points_json: JsonB,
