...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_sparse_dot(
///     '{1:0.5, 2:0.3}'::sparsevec,
///     '{2:0.4, 3:0.2}'::sparsevec
/// );
/// -- Returns: 0.12 (only index 2 overlaps: 0.3 * 0.4)
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_sparse_dot")]
...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_sparse_cosine(
///     '{1:0.5, 2:0.3}'::sparsevec,
///     '{1:0.5, 2:0.3}'::sparsevec
/// );
/// -- Returns: 1.0 (identical vectors)
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_sparse_cosine")]
...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_sparse_euclidean(
///     '{0:3.0}'::sparsevec,
///     '{1:4.0}'::sparsevec
/// );
/// -- Returns: 5.0 (sqrt(3^2 + 4^2))
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_sparse_euclidean")]
...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_sparse_manhattan(
///     '{0:1.0, 2:3.0}'::sparsevec,
///     '{0:4.0, 2:1.0}'::sparsevec
/// );
/// -- Returns: 5.0 (|1-4| + |3-1|)
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_sparse_manhattan")]
...
/// );
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_to_sparse")]
...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_sparse_nnz('{1:0.5, 2:0.3, 5:0.8}'::sparsevec);
/// -- Returns: 3
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_sparse_nnz")]
...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_sparse_dim('{1:0.5, 2:0.3}'::sparsevec);
/// -- Returns: 3 (max index + 1)
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_sparse_dim")]
...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_sparse_norm('{0:3.0, 1:4.0}'::sparsevec);
/// -- Returns: 5.0 (sqrt(9 + 16))
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_sparse_norm")]
...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_sparse_top_k(
///     '{0:0.1, 1:0.5, 2:0.05, 3:0.8}'::sparsevec,
///     2
/// );
/// -- Returns: {1:0.5, 3:0.8}
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_sparse_top_k")]
...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_sparse_prune(
///     '{0:0.1, 1:0.5, 2:0.05, 3:0.8}'::sparsevec,
///     0.2
/// );
/// -- Returns: {1:0.5, 3:0.8}
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_sparse_prune")]
...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_dense_to_sparse(ARRAY[0, 0.5, 0, 0.3, 0]::real[]);
/// -- Returns: {1:0.5, 3:0.3}
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_dense_to_sparse")]
...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_sparse_to_dense('{1:0.5, 3:0.3}'::sparsevec);
/// -- Returns: ARRAY[0, 0.5, 0, 0.3]
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_sparse_to_dense")]
...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_sparse_bm25(
///     query_sparse,
///     doc_sparse,
///     doc_length,
///     avg_doc_length,
...
/// FROM documents;
/// ```
#[pg_extern(immutable, parallel_safe, name = "swarmvector_sparse_bm25")]
fn pg_sparse_bm25(
    query: SparseVec,
    doc: SparseVec,
    doc_len: f32,
