...
### Distance Operations
- `swarmvector_sparse_dot(a, b) -> real`
- `swarmvector_sparse_cosine(a, b) -> real`
- `swarmvector_sparse_euclidean(a, b) -> real`
- `swarmvector_sparse_manhattan(a, b) -> real`
- `swarmvector_sparse_bm25(query, doc, ...) -> real`
...
- `swarmvector_sparse_top_k(sparse, k) -> sparsevec` - Keep top k
- `swarmvector_sparse_prune(sparse, threshold) -> sparsevec` - Prune small values
...
SELECT id,
       ...
       0.3 * swarmvector_sparse_dot(sparse, query_sparse) AS hybrid_score
FROM documents
