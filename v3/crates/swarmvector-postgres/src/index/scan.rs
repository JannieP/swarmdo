...
pub fn parse_distance_metric(op_name: &str) -> DistanceMetric {
    match op_name {
        "swarmvector_l2_ops" | "<->" => DistanceMetric::Euclidean,
        "swarmvector_ip_ops" | "<#>" => DistanceMetric::InnerProduct,
        "swarmvector_cosine_ops" | "<=>" => DistanceMetric::Cosine,
        "swarmvector_l1_ops" | "<+>" => DistanceMetric::Manhattan,
