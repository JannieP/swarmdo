...
/// # SQL Example
/// ```sql
/// SELECT swarmvector_estimate_workers(
...
pub fn swarmvector_estimate_workers(
    index_pages: i32,
    index_tuples: i64,
    k: i32,
    ef_search: i32,
...
/// # SQL Example
/// ```sql
/// SELECT * FROM swarmvector_parallel_info();
/// ```
#[pg_extern]
pub fn swarmvector_parallel_info() -> pgrx::JsonB {
...
/// # SQL Example
/// ```sql
/// SELECT * FROM swarmvector_explain_parallel(
///     'my_hnsw_index',
///     10,   -- k
///     40,   -- ef_search
///     128   -- dimensions
...
/// ```
#[pg_extern]
pub fn swarmvector_explain_parallel(
    index_name: &str,
    k: i32,
    ef_search: i32,
    dimensions: i32,
...
/// Configure parallel execution for SwarmVector
///
/// # SQL Example
/// ```sql
/// SELECT swarmvector_set_parallel_config(
///     enable := true,
///     min_tuples_for_parallel := 10000
/// );
/// ```
#[pg_extern]
pub fn swarmvector_set_parallel_config(
    enable: Option<bool>,
...
/// # SQL Example
/// ```sql
/// SELECT * FROM swarmvector_benchmark_parallel(
///     'embeddings',
///     'embedding',
///     '[0.1, 0.2, ...]'::vector,
///     10
...
/// ```
#[pg_extern]
pub fn swarmvector_benchmark_parallel(
    table_name: &str,
    column_name: &str,
    query_vector: &str,
    k: i32,
...
/// # SQL Example
/// ```sql
/// SELECT * FROM swarmvector_parallel_stats();
/// ```
#[pg_extern]
pub fn swarmvector_parallel_stats() -> pgrx::JsonB {
...
mod tests {
    ...
    fn test_estimate_workers() {
        // Small index
        let workers = swarmvector_estimate_workers(50, 5000, 10, 40);
        assert_eq!(workers, 0);

        // Medium index
        let workers = swarmvector_estimate_workers(2000, 100000, 10, 40);
        assert!(workers > 0);

        // Large complex query
        let workers = swarmvector_estimate_workers(5000, 500000, 100, 200);
        assert!(workers >= 2);
    }

    #[pg_test]
    fn test_parallel_info() {
        let info = swarmvector_parallel_info();
