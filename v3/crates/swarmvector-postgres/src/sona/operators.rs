...
#[pg_extern]
pub fn swarmvector_sona_learn(table_name: &str, trajectory_json: JsonB) -> JsonB {
...
pub fn swarmvector_sona_apply(table_name: &str, embedding: Vec<f32>) -> Vec<f32> {
...
#[pg_extern]
pub fn swarmvector_sona_ewc_status(table_name: &str) -> JsonB {
...
#[pg_extern]
pub fn swarmvector_sona_stats(table_name: &str) -> JsonB {
    let engine = get_or_create_engine(table_name);
    let stats = engine.stats();
