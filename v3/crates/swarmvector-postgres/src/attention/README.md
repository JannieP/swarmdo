...
```rust
use swarmvector_postgres::attention::{ScaledDotAttention, Attention};
...
| Function | Purpose |
|----------|---------|
| `swarmvector_attention_score()` | Single query-key attention score |
| `swarmvector_softmax()` | Softmax activation |
| `swarmvector_multi_head_attention()` | Multi-head attention forward pass |
| `swarmvector_flash_attention()` | Flash Attention v2 |
| `swarmvector_attention_scores()` | Multiple attention scores |
