...
//! - `SwarmVector`: Primary f32 vector type (pgvector compatible)
...
#[pg_extern]
fn swarmvector_memory_detailed() -> pgrx::JsonB {
...
#[pg_extern]
fn swarmvector_reset_peak_memory() {
