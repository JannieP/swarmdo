...
I've implemented a comprehensive native PostgreSQL HalfVec type in `/home/user/swarmvector/crates/swarmvector-postgres/src/types/halfvec.rs` with the following features:
...
2. **Conversion Functions**:
   - `halfvec_to_vector(HalfVec) -> SwarmVector` - Convert to f32 vector
   - `vector_to_halfvec(SwarmVector) -> HalfVec` - Convert from f32 vector
...
- Implementation: `/home/user/swarmvector/crates/swarmvector-postgres/src/types/halfvec.rs`
