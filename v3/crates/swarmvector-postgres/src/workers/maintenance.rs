...
/// Information about a SwarmVector index
#[derive(Debug, Clone)]
...
impl MaintenanceWorker {
    ...
    fn perform_maintenance_cycle(&mut self) -> Result<(), String> {
        ...
        let indexes = self.find_swarmvector_indexes()?;
    ...
    fn find_swarmvector_indexes(&self) -> Result<Vec<IndexInfo>, String> {
    ...
    fn get_tiered_collections(&self) -> Result<Vec<i32>, String> {
        // In production, query swarmvector.tier_policies
        Ok(vec![])
    }
...
#[pg_guard]
pub extern "C" fn swarmvector_maintenance_worker_main(arg: pg_sys::Datum) {
    let worker_id = arg.value() as u64;

    pgrx::log!("SwarmVector maintenance worker {} starting", worker_id);
    ...
    pgrx::log!("SwarmVector maintenance worker {} stopped", worker_id);
}
...
#[pg_extern]
pub fn swarmvector_maintenance_stats() -> pgrx::JsonB {
...
#[pg_extern]
pub fn swarmvector_force_maintenance() -> bool {
