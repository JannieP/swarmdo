...
fn spawn_pg_background_worker(worker_id: u64, worker_type: WorkerType) -> Result<i32, String> {
    ...
    let name = format!("swarmvector {} [{}]", worker_type, worker_id);
    ...
    //         WorkerType::Engine => super::engine::swarmvector_engine_worker_main,
    //         WorkerType::Maintenance => super::maintenance::swarmvector_maintenance_worker_main,
    //         WorkerType::GnnTraining => super::gnn::swarmvector_gnn_training_worker_main,
    //         WorkerType::Integrity => super::integrity::swarmvector_integrity_worker_main,
    //     });
