...
#[pg_extern]
pub fn swarmvector_gnn_worker_status() -> pgrx::JsonB {
...
#[pg_extern]
pub fn swarmvector_gnn_train(collection_id: i32, force_retrain: default!(bool, false)) -> pgrx::JsonB {
    let worker = get_gnn_worker();
...
#[pg_extern]
pub fn swarmvector_gnn_model(collection_id: i32) -> pgrx::JsonB {
    let worker = get_gnn_worker();
