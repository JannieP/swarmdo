...
#[pg_extern]
pub fn swarmvector_integrity_worker_status() -> pgrx::JsonB {
...
#[pg_extern]
pub fn swarmvector_integrity_register(collection_id: i32) -> pgrx::JsonB {
    let worker = get_integrity_worker();
...
#[pg_extern]
pub fn swarmvector_integrity_unregister(collection_id: i32) -> pgrx::JsonB {
    let worker = get_integrity_worker();
...
#[pg_extern]
pub fn swarmvector_integrity_sample(collection_id: i32) -> pgrx::JsonB {
    let worker = get_integrity_worker();
    worker.register_collection(collection_id);
