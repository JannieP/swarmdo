...
/// Get current health status of the SwarmVector system
///
/// Returns JSON with:
...
#[pg_extern]
pub fn swarmvector_health_status() -> pgrx::JsonB {
...
#[pg_extern]
pub fn swarmvector_is_healthy() -> bool {
    let engine = get_healing_engine();
    let engine_lock = engine.read();
    let status = engine_lock.health_status();
    status.healthy
...
#[pg_extern]
pub fn swarmvector_system_metrics() -> pgrx::JsonB {
    let engine = get_healing_engine();
    let engine_lock = engine.read();
...
#[pg_extern]
pub fn swarmvector_healing_history(limit: default!(i32, 20)) -> pgrx::JsonB {
    let engine = get_healing_engine();
    let engine_lock = engine.read();
...
#[pg_extern]
pub fn swarmvector_healing_history_since(since_timestamp: i64) -> pgrx::JsonB {
    let engine = get_healing_engine();
    let engine_lock = engine.read();
...
#[pg_extern]
pub fn swarmvector_healing_history_for_strategy(
    strategy_name: &str,
...
#[pg_extern]
pub fn swarmvector_healing_trigger(problem_type: &str) -> pgrx::JsonB {
    let engine = get_healing_engine();
    let engine_lock = engine.read();
...
#[pg_extern]
pub fn swarmvector_healing_execute(
    strategy_name: &str,
    problem_type: &str,
...
///   - min_improvement_pct
#[pg_extern]
pub fn swarmvector_healing_configure(config_json: pgrx::JsonB) -> pgrx::JsonB {
    let engine = get_healing_engine();
...
#[pg_extern]
pub fn swarmvector_healing_get_config() -> pgrx::JsonB {
    let engine = get_healing_engine();
    let engine_lock = engine.read();
...
#[pg_extern]
pub fn swarmvector_healing_enable(enabled: bool) -> bool {
    let engine = get_healing_engine();
    let mut engine_lock = engine.write();
    engine_lock.set_enabled(enabled);
    engine_lock.enabled
...
#[pg_extern]
pub fn swarmvector_healing_strategies() -> pgrx::JsonB {
    let engine = get_healing_engine();
    let engine_lock = engine.read();
...
#[pg_extern]
pub fn swarmvector_healing_effectiveness() -> pgrx::JsonB {
    let engine = get_healing_engine();
    let engine_lock = engine.read();
...
#[pg_extern]
pub fn swarmvector_healing_stats() -> pgrx::JsonB {
    let engine = get_healing_engine();
    let engine_lock = engine.read();
...
#[pg_extern]
pub fn swarmvector_healing_thresholds() -> pgrx::JsonB {
    let engine = get_healing_engine();
    let engine_lock = engine.read();
...
#[pg_extern]
pub fn swarmvector_healing_set_thresholds(thresholds_json: pgrx::JsonB) -> pgrx::JsonB {
    let engine = get_healing_engine();
    let engine_lock = engine.read();
...
#[pg_extern]
pub fn swarmvector_healing_problem_types() -> pgrx::JsonB {
