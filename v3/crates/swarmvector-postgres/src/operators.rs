...
//!
//! Provides both array-based and native swarmvector type distance functions with SIMD optimization.
...
use crate::types::SwarmVector;

// ============================================================================
// Native SwarmVector Type Distance Functions (Zero-Copy SIMD)
// ============================================================================
// These functions use the native swarmvector type directly for maximum performance

/// Compute L2 (Euclidean) distance between two native swarmvector types
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_l2_distance(a: SwarmVector, b: SwarmVector) -> f32 {
...
/// Compute cosine distance between two native swarmvector types
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_cosine_distance(a: SwarmVector, b: SwarmVector) -> f32 {
    if a.dimensions() != b.dimensions() {
        pgrx::error!(
            "Cannot compute distance between vectors of different dimensions ({} vs {})",
            a.dimensions(),
...
/// Compute inner product between two native swarmvector types
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_inner_product(a: SwarmVector, b: SwarmVector) -> f32 {
    if a.dimensions() != b.dimensions() {
        pgrx::error!(
...
/// Compute Manhattan (L1) distance between two native swarmvector types
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_l1_distance(a: SwarmVector, b: SwarmVector) -> f32 {
    if a.dimensions() != b.dimensions() {
        pgrx::error!(
            "Cannot compute distance between vectors of different dimensions ({} vs {})",
            a.dimensions(),
...
/// Get dimensions of a native swarmvector
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_dims(v: SwarmVector) -> i32 {
    v.dimensions() as i32
}

/// Get L2 norm of a native swarmvector
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_norm(v: SwarmVector) -> f32 {
    v.norm()
}

/// Normalize a native swarmvector to unit length
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_normalize(v: SwarmVector) -> SwarmVector {
    v.normalize()
}

/// Add two native swarmvector types
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_add(a: SwarmVector, b: SwarmVector) -> SwarmVector {
    if a.dimensions() != b.dimensions() {
...
/// Subtract two native swarmvector types
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_sub(a: SwarmVector, b: SwarmVector) -> SwarmVector {
    if a.dimensions() != b.dimensions() {
        pgrx::error!("Vectors must have the same dimensions");
    }
    a.sub(&b)
...
/// Multiply native swarmvector by scalar
#[pg_extern(immutable, parallel_safe)]
pub fn swarmvector_mul_scalar(v: SwarmVector, scalar: f32) -> SwarmVector {
    v.mul_scalar(scalar)
}
