//! Tenant-Aware Operations for SwarmVector Multi-Tenancy
//!
...
pub fn get_current_tenant_id() -> Result<String, TenantError> {
    ...
    // Spi::get_one::<String>("SELECT current_setting('swarmvector.tenant_id', true)")
...
impl AuditLogEntry {
    ...
    pub fn insert_sql_parameterized(&self) -> (String, Vec<Option<String>>) {
        let sql = r#"
INSERT INTO swarmvector.tenant_audit_log (tenant_id, operation, user_id, details, ip_address, success, error)
