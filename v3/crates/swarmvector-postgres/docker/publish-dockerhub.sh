#!/usr/bin/env bash
# SwarmVector-Postgres Docker Hub Publication Script
...
# Configuration
DOCKER_REGISTRY="${DOCKER_REGISTRY:-swarmvector}"
IMAGE_NAME="${IMAGE_NAME:-swarmvector-postgres}"
VERSION="2.0.0"
RUST_VERSION="1.83"
...
log_info "=== SwarmVector-Postgres Docker Hub Publication ==="
...
if [[ "$MULTI_ARCH" == "true" ]]; then
    BUILDER_NAME="swarmvector-builder"
