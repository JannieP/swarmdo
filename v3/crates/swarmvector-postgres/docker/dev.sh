#!/usr/bin/env bash
# SwarmVector-Postgres Development Environment
...
CONTAINER_NAME="swarmvector-postgres-dev"
IMAGE_NAME="swarmvector-postgres:dev"
POSTGRES_PORT="${POSTGRES_PORT:-5432}"
POSTGRES_USER="${POSTGRES_USER:-postgres}"
POSTGRES_PASSWORD="${POSTGRES_PASSWORD:-postgres}"
POSTGRES_DB="${POSTGRES_DB:-swarmvector_dev}"
...
build_extension() {
    log_info "Building swarmvector-postgres extension..."
...
setup_extension() {
    ...
    # Create extension
    docker exec -it "${CONTAINER_NAME}" psql -U "${POSTGRES_USER}" -d "${POSTGRES_DB}" -c "CREATE EXTENSION IF NOT EXISTS swarmvector_postgres CASCADE;" || {
...
show_connection_info() {
    ...
    echo ""
    echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${GREEN}  SwarmVector-Postgres Development Environment Ready!${NC}"
    echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    ...
    echo -e "  3. Reload: ${YELLOW}docker exec ${CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DB} -c 'DROP EXTENSION swarmvector_postgres CASCADE; CREATE EXTENSION swarmvector_postgres;'${NC}"
    echo ""
...
watch_and_reload() {
    ...
    cargo watch -x "pgrx install" -s "docker exec ${CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DB} -c 'DROP EXTENSION IF EXISTS swarmvector_postgres CASCADE; CREATE EXTENSION swarmvector_postgres;'"
}
...
Environment Variables:
    ...
    POSTGRES_DB            PostgreSQL database (default: swarmvector_dev)
...
DROP EXTENSION IF EXISTS swarmvector_postgres CASCADE;
CREATE EXTENSION swarmvector_postgres;
SELECT extname, extversion FROM pg_extension WHERE extname = 'swarmvector_postgres';
EOF
