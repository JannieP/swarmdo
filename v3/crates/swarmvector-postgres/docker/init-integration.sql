-- SwarmVector-Postgres Integration Test Initialization
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'SwarmVector Integration Test Initialization';
    RAISE NOTICE '========================================';
END $$;
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Extension version: %', swarmvector_version();
    RAISE NOTICE 'SIMD info: %', swarmvector_simd_info();
    RAISE NOTICE '========================================';
END $$;
