...
/// Query configuration for RufVector searches
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RufvectorQuery {
...
impl Default for RufvectorQuery {
    fn default() -> Self {
        Self {
            vector: None,
            text: None,
...
impl RufvectorQuery {
    ...
    /// # Example
    /// ```
    /// use rufvector_gnn::query::RufvectorQuery;
    ///
    /// let query = RufvectorQuery::vector_search(vec![0.1, 0.2, 0.3], 10);
    ...
    /// use rufvector_gnn::query::RufvectorQuery;
    ///
    /// let query = RufvectorQuery::neural_search(vec![0.1, 0.2, 0.3], 10, 3);
    ...
    /// use rufvector_gnn::query::RufvectorQuery;
    ///
    /// let query = RufvectorQuery::subgraph_search(vec![0.1, 0.2, 0.3], 20);
...
impl QueryResult {
    ...
    /// # Example
    /// ```
    /// use rufvector_gnn::query::QueryResult;
    ///
...
mod tests {
    ...
    #[test]
    fn test_rufvector_query_default() {
        let query = RufvectorQuery::default();
        assert_eq!(query.k, 10);
    ...
    fn test_vector_search_query() {
        ...
        let query = RufvectorQuery::vector_search(vector.clone(), 5);
    ...
    fn test_neural_search_query() {
        ...
        let query = RufvectorQuery::neural_search(vector.clone(), 10, 3);
    ...
    fn test_subgraph_search_query() {
        ...
        let query = RufvectorQuery::subgraph_search(vector.clone(), 20);
    ...
    fn test_differentiable_search_query() {
        ...
        let query = RufvectorQuery::differentiable_search(vector.clone(), 15, 0.5);
    ...
    fn test_query_builder_pattern() {
        let query = RufvectorQuery::vector_search(vec![0.1, 0.2], 5)
    ...
    fn test_query_serialization() {
        let query = RufvectorQuery::neural_search(vec![0.1, 0.2], 5, 2);
        let json = serde_json::to_string(&query).unwrap();
        let deserialized: RufvectorQuery = serde_json::from_str(&json).unwrap();
