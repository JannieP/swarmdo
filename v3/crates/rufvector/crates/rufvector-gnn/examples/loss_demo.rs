...
//!
//! Run with: cargo run -p rufvector-gnn --example loss_demo

use ndarray::Array2;
use rufvector_gnn::training::{Loss, LossType, Optimizer, OptimizerType};

fn main() {
    println!("=== RufVector GNN Loss Functions Demo ===\n");
