//! Node.js bindings for RufVector Graph Transformer via NAPI-RS
//!
...
//! to avoid coupling with the evolving `rufvector-graph-transformer` crate.
...
/// # Example
/// ```javascript
/// const { GraphTransformer } = require('rufvector-graph-transformer-node');
...
#[napi]
pub fn init() -> String {
    "RufVector Graph Transformer Node.js bindings initialized".to_string()
}
