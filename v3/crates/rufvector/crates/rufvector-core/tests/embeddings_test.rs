...
use rufvector_core::embeddings::{ApiEmbedding, EmbeddingProvider, HashEmbedding};
use rufvector_core::{types::DbOptions, AgenticDB};
use std::sync::Arc;
...
fn test_candle_embedding_provider() {
    use rufvector_core::CandleEmbedding;
