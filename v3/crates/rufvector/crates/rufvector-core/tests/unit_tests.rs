...
use rufvector_core::error::{Result, RufvectorError};
use rufvector_core::types::*;
...
mod distance_tests {
    ...
    fn test_dimension_mismatch() {
        ...
        match result {
            Err(RufvectorError::DimensionMismatch { expected, actual }) => {
...
mod quantization_tests {
    use super::*;
    use rufvector_core::quantization::*;
...
mod storage_tests {
    use super::*;
    use rufvector_core::storage::VectorStorage;
