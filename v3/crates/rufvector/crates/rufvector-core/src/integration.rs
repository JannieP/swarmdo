...
//! `rufvector-core` as a dependency from other ruvnet crates:
//!
...
/// fingerprints in RufVector enables fast recall of "similar layers" across
/// model checkpoints.
///
/// # Example
/// ```no_run
/// use rufvector_core::integration::FannAdapter;
///
...
impl FannAdapter {
    /// Create a new adapter backed by a RufVector database.
    ///
...
/// # Example
/// ```no_run
/// use rufvector_core::integration::SemanticSearchAdapter;
///
...
impl SemanticSearchAdapter {
    ...
    pub fn index_file(
        ...
        if embedding.len() != self.dimensions {
            return Err(RufvectorError::DimensionMismatch {
