...
[![Crates.io](https://img.shields.io/crates/v/rufvector-core.svg)](https://crates.io/crates/rufvector-core)
[![Documentation](https://docs.rs/rufvector-core/badge.svg)](https://docs.rs/rufvector-core)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Rust](https://img.shields.io/badge/rust-1.77%2B-orange.svg)](https://www.rust-lang.org)

**The pure-Rust vector database engine behind RufVector -- HNSW indexing, quantization, and SIMD acceleration in a single crate.**

`rufvector-core` is the foundational library that powers the entire [RufVector](https://github.com/ruvnet/rufvector) ecosystem. It gives you a production-grade vector database you can embed directly into any Rust application: insert vectors, search them in under a millisecond, filter by metadata, and compress storage up to 32x -- all without external services. If you need vector search as a library instead of a server, this is the crate.

| | rufvector-core | Typical Vector Database |
|---|---|---|
...
Add `rufvector-core` to your `Cargo.toml`:

```toml
[dependencies]
rufvector-core = "0.1.0"
```
...
```toml
[dependencies]
rufvector-core = { version = "0.1.0", features = ["simd", "uuid-support"] }
```
...
```rust
use rufvector_core::{VectorDB, DbOptions, VectorEntry, SearchQuery, DistanceMetric};
...
```rust
use rufvector_core::{VectorDB, VectorEntry};
...
```rust
use rufvector_core::{DbOptions, HnswConfig, DistanceMetric};
...
```rust
use rufvector_core::{DbOptions, QuantizationConfig};
...
use rufvector_core::{HybridSearch, HybridConfig};
...
use rufvector_core::{FilteredSearch, FilterExpression};
...
// MMR diversification
use rufvector_core::{MMRSearch, MMRConfig};
...
`rufvector-core` is the foundation for platform-specific bindings:

- **[rufvector-node](../rufvector-node/)** - Node.js bindings via NAPI-RS
- **[rufvector-wasm](../rufvector-wasm/)** - WebAssembly bindings for browsers
- **[rufvector-gnn](../rufvector-gnn/)** - Graph Neural Network layer for learned search
- **[rufvector-cli](../rufvector-cli/)** - Command-line interface
- **[rufvector-bench](../rufvector-bench/)** - Performance benchmarks
...
- **[API Documentation](https://docs.rs/rufvector-core)** - Full API reference on docs.rs
...
[Documentation](https://docs.rs/rufvector-core) | [Crates.io](https://crates.io/crates/rufvector-core) | [GitHub](https://github.com/ruvnet/rufvector)
