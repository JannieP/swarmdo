...
pub fn generate_typescript(schema: &GraphSchema) -> String {
    ...
    out.push_str(
        "// Auto-generated from RufVector GraphSchema (ADR-252 P6). Do not edit by hand.\n\n",
    );
...
pub fn generate_python(schema: &GraphSchema) -> String {
    let mut out = String::new();
    out.push_str("# Auto-generated from RufVector GraphSchema (ADR-252 P6). Do not edit by hand.\n");
