//! Node.js bindings for RufVector Graph Database via NAPI-RS
//!
...
use rufvector_core::advanced::hypergraph::{
    CausalMemory as CoreCausalMemory, Hyperedge as CoreHyperedge,
    HypergraphIndex as CoreHypergraphIndex,
};
use rufvector_core::DistanceMetric;
use rufvector_graph::cypher::{parse_cypher, Statement};
use rufvector_graph::node::NodeBuilder;
use rufvector_graph::storage::GraphStorage;
use rufvector_graph::GraphDB;
                ...
                match statement {
                    Statement::Match(match_clause) => {
                        ...
                        for pattern in &match_clause.patterns {
                            if let rufvector_graph::cypher::ast::Pattern::Node(node_pattern) =
                                pattern
                            {
...
#[napi]
pub fn hello() -> String {
    "Hello from RufVector Graph Node.js bindings!".to_string()
}
