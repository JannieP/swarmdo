...
[![npm version](https://img.shields.io/npm/v/rufvector.svg)](https://www.npmjs.com/package/rufvector)
...
Bring the power of Rufvector's blazing-fast vector search to your Node.js and TypeScript applications. Built with NAPI-RS for zero-overhead native bindings, async/await support, and complete type safety.

> Part of the [Rufvector](https://github.com/ruvnet/rufvector) ecosystem - next-generation vector database built in Rust.

## 🌟 Why Rufvector Node.js?
...
**Rufvector Node.js eliminates these limitations.**
...
```
Operation              Rufvector    Pure JS     Speedup
────────────────────────────────────────────────────────
...
Browser Support         Via WASM    Use rufvector-wasm package
...
```bash
node -e "const {version} = require('rufvector'); console.log('Rufvector v' + version())"
```
...
```javascript
const { VectorDB } = require('rufvector');
...
```typescript
import { VectorDB, JsDbOptions, JsSearchQuery } from 'rufvector';
...
const db = new VectorDB({
  ...
  storagePath?: string,               // Default: './vector.db'
  hnswConfig?: {
...
Get the Rufvector library version.

```typescript
import { version } from 'rufvector';
console.log(`Rufvector v${version()}`);
```
...
cd rufvector/crates/rufvector-node
...
| Feature | Rufvector | Pure JS | Python (Faiss) | Pinecone |
|---------|----------|---------|----------------|----------|
...
**Error**: `Cannot find module 'rufvector'`
...
# Benchmark performance
cargo bench -p rufvector-bench
```

## 📖 Documentation

- **[Main Documentation](../../docs/README.md)** - Complete Rufvector documentation
...
- **GitHub Issues**: [Report bugs or request features](https://github.com/ruvnet/rufvector/issues)
- **Discussions**: [Ask questions and share ideas](https://github.com/ruvnet/rufvector/discussions)
...
- **[rufvector-core](../rufvector-core)** - Core Rust implementation
- **[rufvector-wasm](../rufvector-wasm)** - WebAssembly bindings for browsers
- **[rufvector-cli](../rufvector-cli)** - Command-line interface
- **[rufvector-bench](../rufvector-bench)** - Benchmarking suite

---

<div align="center">

**Built by [rUv](https://ruv.io) • Part of the [Rufvector](https://github.com/ruvnet/rufvector) ecosystem**

[![Star on GitHub](https://img.shields.io/github/stars/ruvnet/rufvector?style=social)](https://github.com/ruvnet/rufvector)
[![npm downloads](https://img.shields.io/npm/dm/rufvector.svg)](https://www.npmjs.com/package/rufvector)
