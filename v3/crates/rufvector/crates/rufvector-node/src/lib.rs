//! Node.js bindings for Rufvector via NAPI-RS
//!
...
// Import new crates
use rufvector_collections::CollectionManager as CoreCollectionManager;
use rufvector_filter::FilterExpression;
use rufvector_metrics::{gather_metrics, HealthChecker, HealthStatus};
...
/// Get the version of the Rufvector library
#[napi]
...
#[napi]
pub fn hello() -> String {
    "Hello from Rufvector Node.js bindings!".to_string()
}
...
impl From<JsCollectionConfig> for rufvector_collections::CollectionConfig {
    fn from(config: JsCollectionConfig) -> Self {
        rufvector_collections::CollectionConfig {
...
impl From<rufvector_collections::CollectionStats> for JsCollectionStats {
    fn from(stats: rufvector_collections::CollectionStats) -> Self {
        JsCollectionStats {
...
impl CollectionManager {
    ...
    pub async fn create_collection(&self, name: String, config: JsCollectionConfig) -> Result<()> {
        let core_config: rufvector_collections::CollectionConfig = config.into();
