...
pub fn project_to_poincare_ball(vector: Float32Array, curvature: f64) -> Float32Array {
    let v = vector.to_vec();
    let projected = rufvector_attention::hyperbolic::project_to_ball(&v, curvature as f32, 1e-5);
...
pub fn poincare_distance(a: Float32Array, b: Float32Array, curvature: f64) -> f64 {
    ...
    rufvector_attention::hyperbolic::poincare_distance(a_slice, b_slice, curvature as f32) as f64
}
...
pub fn mobius_addition(a: Float32Array, b: Float32Array, curvature: f64) -> Float32Array {
    let a_slice = a.as_ref();
    let b_slice = b.as_ref();
    let result = rufvector_attention::hyperbolic::mobius_add(a_slice, b_slice, curvature as f32);
...
pub fn exp_map(base: Float32Array, tangent: Float32Array, curvature: f64) -> Float32Array {
    ...
    let result =
        rufvector_attention::hyperbolic::exp_map(base_slice, tangent_slice, curvature as f32);
    Float32Array::new(result)
}
...
pub fn log_map(base: Float32Array, point: Float32Array, curvature: f64) -> Float32Array {
    ...
    let result = rufvector_attention::hyperbolic::log_map(base_slice, point_slice, curvature as f32);
    Float32Array::new(result)
}
