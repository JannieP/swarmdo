//! rufvector-attention-node
//!
//! Node.js bindings for rufvector-attention via NAPI-RS
//!
...
pub fn info() -> LibraryInfo {
    LibraryInfo {
        name: "rufvector-attention-node".to_string(),
        version: env!("CARGO_PKG_VERSION").to_string(),
        description: "Node.js bindings for rufvector-attention".to_string(),
        features: vec![
