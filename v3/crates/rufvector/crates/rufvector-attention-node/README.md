...
```bash
npm install @rufvector/attention
```
...
```javascript
const { DotProductAttention } = require('@rufvector/attention');
...
```javascript
const { MultiHeadAttention } = require('@rufvector/attention');
...
```javascript
const { FlashAttention } = require('@rufvector/attention');
...
```javascript
const { HyperbolicAttention } = require('@rufvector/attention');
...
```javascript
const { MoEAttention } = require('@rufvector/attention');
...
```javascript
const { Trainer, AdamOptimizer } = require('@rufvector/attention');
...
```javascript
const { BatchProcessor, parallelAttentionCompute } = require('@rufvector/attention');
