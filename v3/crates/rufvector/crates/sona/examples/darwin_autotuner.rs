...
//! staleness-weighted window `w(d_t)` from `rufvector_sona::auto_tuner`: it scores
...
//!
//! Run: `cargo run -p rufvector-sona --release --example darwin_autotuner`

use rand::rngs::StdRng;
use rand::{Rng, SeedableRng};
use rufvector_sona::auto_tuner::{StalenessSchedule, StalenessWindow};
use rufvector_sona::{EwcConfig, EwcPlusPlus};
