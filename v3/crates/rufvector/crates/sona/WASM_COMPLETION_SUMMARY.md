...
- ✓ Created `/workspaces/rufvector/crates/sona/` directory
...
Created interactive browser demo at `/workspaces/rufvector/crates/sona/wasm-example/`:
...
Generated artifacts in `/workspaces/rufvector/crates/sona/pkg/`:
...
### Development Build
```bash
cd /workspaces/rufvector/crates/sona
wasm-pack build --target web --features wasm
```
