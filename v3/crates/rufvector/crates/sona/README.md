...
[![Crates.io](https://img.shields.io/crates/v/rufvector-sona.svg)](https://crates.io/crates/rufvector-sona)
[![npm](https://img.shields.io/npm/v/@rufvector/sona.svg)](https://www.npmjs.com/package/@rufvector/sona)
[![Documentation](https://docs.rs/rufvector-sona/badge.svg)](https://docs.rs/rufvector-sona)
[![License](https://img.shields.io/badge/license-MIT%2FApache--2.0-blue.svg)](LICENSE)

**Runtime-adaptive learning for LLM routers and AI systems -- without expensive retraining.**

```bash
cargo add rufvector-sona
```
...
```toml
[dependencies]
rufvector-sona = "0.1.1"

# With all features
rufvector-sona = { version = "0.1.1", features = ["serde-support"] }
```
...
# or
yarn add @rufvector/sona
# or
pnpm add @rufvector/sona
```
...
```rust
use rufvector_sona::{SonaEngine, SonaConfig};
...
```bash
# Run all benchmarks
cargo bench -p rufvector-sona

# Run specific benchmark
cargo bench -p rufvector-sona -- micro_lora

# With detailed output
cargo bench -p rufvector-sona -- --verbose
```
...
Contributions welcome! Please see our [Contributing Guide](https://github.com/ruvnet/rufvector/blob/main/CONTRIBUTING.md).
...
**[Documentation](https://docs.rs/rufvector-sona)** | **[GitHub](https://github.com/ruvnet/rufvector)** | **[npm](https://www.npmjs.com/package/@rufvector/sona)** | **[crates.io](https://crates.io/crates/rufvector-sona)**

Made with 🦀 Rust by the RufVector Team
