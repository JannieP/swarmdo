...
[![Crates.io](https://img.shields.io/crates/v/rufvector-filter.svg)](https://crates.io/crates/rufvector-filter)
[![Documentation](https://docs.rs/rufvector-filter/badge.svg)](https://docs.rs/rufvector-filter)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Rust](https://img.shields.io/badge/rust-1.77%2B-orange.svg)](https://www.rust-lang.org)

**Advanced metadata filtering for Rufvector vector search.**

`rufvector-filter` provides a powerful filter expression language for combining vector similarity search with metadata constraints. Supports complex boolean expressions, range queries, and efficient filter evaluation. Part of the [Rufvector](https://github.com/ruvnet/rufvector) ecosystem.

## Why Rufvector Filter?
...
Add `rufvector-filter` to your `Cargo.toml`:

```toml
[dependencies]
rufvector-filter = "0.1.1"
```
...
```rust
use rufvector_filter::{Filter, FilterBuilder};
...
```rust
use rufvector_filter::{Filter, FilterExpr, op};
...
- **[rufvector-collections](../rufvector-collections/)** - Collection management

## Documentation

- **[Main README](../../README.md)** - Complete project overview
- **[API Documentation](https://docs.rs/rufvector-filter)** - Full API reference
...
[Documentation](https://docs.rs/rufvector-filter) | [Crates.io](https://crates.io/crates/rufvector-filter) | [GitHub](https://github.com/ruvnet/rufvector)
