# Rufvector Tiny Dancer Core

[![Crates.io](https://img.shields.io/crates/v/rufvector-tiny-dancer-core.svg)](https://crates.io/crates/rufvector-tiny-dancer-core)
[![Documentation](https://docs.rs/rufvector-tiny-dancer-core/badge.svg)](https://docs.rs/rufvector-tiny-dancer-core)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Build Status](https://github.com/ruvnet/rufvector/workflows/CI/badge.svg)](https://github.com/ruvnet/rufvector/actions)
...
```toml
[dependencies]
rufvector-tiny-dancer-core = "0.1.1"
```

### Basic Usage

```rust
use rufvector_tiny_dancer_core::{
    Router,
...
```rust
use rufvector_tiny_dancer_core::{Router, types::*};
...
```rust
use rufvector_tiny_dancer_core::feature_engineering::{FeatureEngineer, FeatureConfig};
...
```rust
use rufvector_tiny_dancer_core::Router;
...
```rust
use rufvector_tiny_dancer_core::model::{FastGRNN, FastGRNNConfig};
...
```rust
use rufvector_tiny_dancer_core::storage::Storage;
...
- **WASM**: [rufvector-tiny-dancer-wasm](../rufvector-tiny-dancer-wasm) - Browser/edge deployment
- **Node.js**: [rufvector-tiny-dancer-node](../rufvector-tiny-dancer-node) - TypeScript bindings
- **Rufvector**: [rufvector-core](../rufvector-core) - Vector database

## 📚 Resources

- **Documentation**: [docs.rs/rufvector-tiny-dancer-core](https://docs.rs/rufvector-tiny-dancer-core)
- **GitHub**: [github.com/ruvnet/rufvector](https://github.com/ruvnet/rufvector)
- **Website**: [ruv.io](https://ruv.io)
- **Examples**: [github.com/ruvnet/rufvector/tree/main/examples](https://github.com/ruvnet/rufvector/tree/main/examples)
...
Built with ❤️ by the [Rufvector Team](https://github.com/ruvnet)
