...
use rufvector_tiny_dancer_core::{Candidate, Router, RouterConfig, RoutingRequest};
...
fn bench_feature_extraction(c: &mut Criterion) {
    use rufvector_tiny_dancer_core::feature_engineering::FeatureEngineer;
...
fn bench_model_inference(c: &mut Criterion) {
    use rufvector_tiny_dancer_core::model::FastGRNN;

    let config = rufvector_tiny_dancer_core::model::FastGRNNConfig {
        input_dim: 128,
        hidden_dim: 64,
        output_dim: 1,
        ..Default::default()
