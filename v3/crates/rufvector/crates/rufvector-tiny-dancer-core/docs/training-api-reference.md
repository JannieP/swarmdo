...
## Module: `rufvector_tiny_dancer_core::training`
...
```rust
use rufvector_tiny_dancer_core::training::generate_teacher_predictions;
...
```rust
use rufvector_tiny_dancer_core::training::BatchIterator;
