...
```toml
[dependencies]
rufvector-tiny-dancer-core = { version = "0.1", features = ["admin-api"] }
...
```rust
use rufvector_tiny_dancer_core::api::{
...
- **Core:** `/home/user/rufvector/crates/rufvector-tiny-dancer-core/src/api.rs`
- **Example:** `/home/user/rufvector/crates/rufvector-tiny-dancer-core/examples/admin-server.rs`
- **Docs:** `/home/user/rufvector/crates/rufvector-tiny-dancer-core/docs/API.md`
