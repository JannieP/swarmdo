...
**Location:** `/home/user/rufvector/crates/rufvector-tiny-dancer-core/src/api.rs`
...
**Location:** `/home/user/rufvector/crates/rufvector-tiny-dancer-core/examples/admin-server.rs`
...
**Location:** `/home/user/rufvector/crates/rufvector-tiny-dancer-core/docs/API.md`
...
**Location:** `/home/user/rufvector/crates/rufvector-tiny-dancer-core/docs/ADMIN_API_QUICKSTART.md`
...
**Location:** `/home/user/rufvector/crates/rufvector-tiny-dancer-core/examples/README.md`
...
```rust
use rufvector_tiny_dancer_core::api::{AdminServer, AdminServerConfig};
use rufvector_tiny_dancer_core::router::Router;
use std::sync::Arc;
...
```rust
use rufvector_tiny_dancer_core::api::record_routing_metrics;
