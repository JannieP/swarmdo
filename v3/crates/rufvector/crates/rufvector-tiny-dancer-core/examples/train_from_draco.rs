...
//!
//! Demonstrates the full pipeline the way `@rufvector/tiny-dancer` would use it:
...
//!
//! Run:  cargo run --example train_from_draco -p rufvector-tiny-dancer-core

use std::collections::HashMap;

use rufvector_tiny_dancer_core::model::{FastGRNN, FastGRNNConfig};
use rufvector_tiny_dancer_core::training::{DracoRow, Trainer, TrainingConfig, TrainingDataset};
