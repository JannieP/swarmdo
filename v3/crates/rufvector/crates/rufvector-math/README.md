...
[![Crates.io](https://img.shields.io/crates/v/rufvector-math.svg)](https://crates.io/crates/rufvector-math)
[![Documentation](https://docs.rs/rufvector-math/badge.svg)](https://docs.rs/rufvector-math)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

## What is rufvector-math?

**rufvector-math** brings advanced mathematical tools to vector search and AI systems. Think of it as a Swiss Army knife for working with high-dimensional data, embeddings, and neural networks.
...
`rufvector-math` provides production-grade implementations of advanced mathematical algorithms that differentiate RufVector from traditional vector databases:
...
- **WebAssembly**: Full browser support via `rufvector-math-wasm`
...
```rust
use rufvector_math::optimal_transport::{SlicedWasserstein, SinkhornSolver, OptimalTransport};
...
```rust
use rufvector_math::information_geometry::{FisherInformation, NaturalGradient};
...
```rust
use rufvector_math::product_manifold::{ProductManifold, ProductManifoldConfig};
