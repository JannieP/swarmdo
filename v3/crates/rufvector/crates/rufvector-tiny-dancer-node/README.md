# Rufvector Tiny Dancer Node

[![npm](https://img.shields.io/npm/v/@rufvector/tiny-dancer-node.svg)](https://www.npmjs.com/package/@rufvector/tiny-dancer-node)
[![Crates.io](https://img.shields.io/crates/v/rufvector-tiny-dancer-node.svg)](https://crates.io/crates/rufvector-tiny-dancer-node)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)

**Node.js bindings for Tiny Dancer neural routing via NAPI-RS.**

`rufvector-tiny-dancer-node` provides native Node.js bindings for production-grade AI agent routing. Run FastGRNN neural inference at native speed for intelligent request routing in server-side applications. Part of the [Rufvector](https://github.com/ruvnet/rufvector) ecosystem.
...
```bash
npm install @rufvector/tiny-dancer-node
# or
yarn add @rufvector/tiny-dancer-node
# or
pnpm add @rufvector/tiny-dancer-node
```
...
```typescript
import { TinyDancer, RouteRequest } from '@rufvector/tiny-dancer-node';
...
```typescript
import { TinyDancer, TrainingData } from '@rufvector/tiny-dancer-node';
...
```typescript
import { TinyDancer } from '@rufvector/tiny-dancer-node';
...
cd rufvector/crates/rufvector-tiny-dancer-node
...
- **[rufvector-tiny-dancer-core](../rufvector-tiny-dancer-core/)** - Core Rust implementation
- **[rufvector-tiny-dancer-wasm](../rufvector-tiny-dancer-wasm/)** - WebAssembly bindings
- **[@rufvector/core](https://www.npmjs.com/package/@rufvector/core)** - Core vector bindings

## Documentation

- **[Main README](../../README.md)** - Complete project overview
- **[API Documentation](https://docs.rs/rufvector-tiny-dancer-node)** - Full API reference
...
[Documentation](https://docs.rs/rufvector-tiny-dancer-node) | [npm](https://www.npmjs.com/package/@rufvector/tiny-dancer-node) | [GitHub](https://github.com/ruvnet/rufvector)
