...
use swarmvector_core::embeddings::{ApiEmbedding, EmbeddingProvider, HashEmbedding};
use swarmvector_core::{types::DbOptions, AgenticDB};
use std::sync::Arc;
...
fn test_candle_embedding_provider() {
    use swarmvector_core::CandleEmbedding;
