...
use swarmvector_core::error::{Result, SwarmvectorError};
use swarmvector_core::types::*;
...
mod distance_tests {
    ...
    fn test_dimension_mismatch() {
        ...
        match result {
            Err(SwarmvectorError::DimensionMismatch { expected, actual }) => {
...
mod quantization_tests {
    use super::*;
    use swarmvector_core::quantization::*;
...
mod storage_tests {
    use super::*;
    use swarmvector_core::storage::VectorStorage;
