...
/// fingerprints in SwarmVector enables fast recall of "similar layers" across
/// model checkpoints.
///
/// # Example
/// ```no_run
/// use swarmvector_core::integration::FannAdapter;
///
...
impl FannAdapter {
    /// Create a new adapter backed by a SwarmVector database.
    ///
...
/// # Example
/// ```no_run
/// use swarmvector_core::integration::SemanticSearchAdapter;
///
