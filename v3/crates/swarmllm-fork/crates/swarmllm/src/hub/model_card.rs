...
impl ModelCard {
    ...
    pub fn to_markdown(&self) -> String {
        ...
        content.push_str("# Download using swarmllm CLI\n");
        content.push_str(&format!("swarmllm pull {}\n", self.name.to_lowercase()));
        content.push_str("```\n\n");

        content.push_str("```rust\n");
        content.push_str("use swarmllm::hub::ModelDownloader;\n\n");
        ...
        // Footer
        content.push_str("---\n\n");
        content.push_str("*This model card was generated automatically by SwarmLLM*\n");
