...
//!
//! Unified interface for Claude Flow CLI hooks to leverage all SwarmLLM v2.3 capabilities:
//!
...
//!
//! ```rust,ignore
//! use swarmllm::claude_flow::{HooksIntegration, HooksConfig, PreTaskInput, PostTaskInput};
//!
