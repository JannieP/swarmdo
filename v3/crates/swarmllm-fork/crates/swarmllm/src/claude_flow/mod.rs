...
//!
//! ```rust,ignore
//! use swarmllm::claude_flow::{ModelRouter, SelectionCriteria, ClaudeModel};
//!
...
//!
//! ```rust,ignore
//! use swarmllm::claude_flow::{AgentCoordinator, ClaudeModel, AgentType, WorkflowStep};
//!
...
//!
//! ```rust,ignore
//! use swarmllm::claude_flow::{PretrainPipeline, PretrainConfig, Phase};
//!
...
//!
//! ```rust,ignore
//! use swarmllm::claude_flow::{TaskGenerator, TaskCategory, TaskComplexity};
//!
...
//! using swarmvector-core's HNSW index. It supports:
//!
...
//!
//! ```rust,ignore
//! use swarmllm::claude_flow::{HnswRouter, HnswRouterConfig, TaskPattern, AgentType, ClaudeFlowTask};
//!
