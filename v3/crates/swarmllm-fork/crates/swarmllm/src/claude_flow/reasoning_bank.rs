...
//!
//! ```rust,ignore
//! use swarmllm::claude_flow::reasoning_bank::{
...
pub struct ReasoningBankIntegration {
    ...
    /// Core reasoning bank (from swarmvector_sona)
...
impl ReasoningBankIntegration {
    ...
    pub fn record_trajectory(
        ...
        // Record to core bank
        {
            ...
            let query_traj =
                swarmvector_sona::QueryTrajectory::new(trajectory.timestamp, embedding.to_vec());
