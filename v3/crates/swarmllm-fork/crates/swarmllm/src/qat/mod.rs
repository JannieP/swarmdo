...
//!
//! This module implements QAT infrastructure for swarmLLM as specified in ADR-090 Phase 2.
...
//!
//! ```rust,ignore
//! use swarmllm::qat::{QatConfig, SteVariant, QuantGranularity};
//!
...
//!
//! ```rust,ignore
//! use swarmllm::qat::{QatConfig, DifferentiableQuantizer, PiQuantDifferentiable, create_quantizer};
//!
...
///
/// ```rust,ignore
/// let quantizer = swarmllm::qat::piq3_quantizer();
/// ```
...
///
/// ```rust,ignore
/// let quantizer = swarmllm::qat::piq2_quantizer();
/// ```
...
///
/// ```rust,ignore
/// let quantizer = swarmllm::qat::uniform_quantizer(4);
/// ```
