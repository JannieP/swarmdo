//! Intelligent Auto-Detection System for SwarmLLM
//!
...
//!
//! ```rust,ignore
//! use swarmllm::autodetect::{SystemCapabilities, InferenceConfig};
//!
...
impl CpuFeatures {
    ...
    fn detect_avx2_runtime() -> bool {
        ...
        {
            // swarmllm always links std; no `feature = "std"` gate needed.
