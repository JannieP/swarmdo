//! LLM inference backends for SwarmLLM
//!
...
//!
//! ```rust,ignore
//! use swarmllm::backends::{CandleBackend, ModelConfig, GenerateParams};
//!
...
//!
//! ```rust,ignore
//! use swarmllm::backends::{MistralBackend, MistralBackendConfig, ModelConfig, GenerateParams};
//! use std::path::Path;
//!
...
/// Model architecture types supported by SwarmLLM.
///
/// SwarmLLM supports multiple transformer architectures with varying
...
///
/// ```rust,ignore
/// use swarmllm::backends::ModelArchitecture;
///
...
/// speed at the cost of some quality. SwarmLLM supports multiple formats
...
///
/// ```rust,ignore
/// use swarmllm::backends::Quantization;
///
...
///
/// ```rust,ignore
/// use swarmllm::backends::{ModelConfig, ModelArchitecture, Quantization, DeviceType};
///
/// let config = ModelConfig {
///     architecture: ModelArchitecture::Mistral,
///     quantization: Some(Quantization::Q4K),
...
///
/// ```rust,ignore
/// use swarmllm::backends::GenerateParams;
///
...
///
/// ```rust,ignore
/// use swarmllm::backends::{TokenStream, StreamEvent};
///
...
///
/// ```rust,ignore
/// use swarmllm::backends::{LlmBackend, ModelConfig, GenerateParams, create_backend};
///
