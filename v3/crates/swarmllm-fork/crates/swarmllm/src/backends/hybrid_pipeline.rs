...
//!
//! ```rust,ignore
//! use swarmllm::backends::{HybridPipeline, HybridPipelineConfig, AneStrategy};
//!
...
///
/// ```rust,ignore
/// use swarmllm::backends::{HybridPipeline, HybridPipelineConfig};
///
...
impl HybridPipeline {
    ...
    pub fn flash_attention(
        ...
        let ctx = self.metal_ctx.as_ref().ok_or_else(|| {
            SwarmLLMError::HybridPipeline("Metal context not available".to_string())
        })?;
    ...
    pub fn flash_attention(
        ...
        Err(SwarmLLMError::HybridPipeline(
