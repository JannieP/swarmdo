...
//!
//! ```rust,ignore
//! use swarmllm::moe::precision_allocator::{PrecisionAllocator, PrecisionConfig, ExpertPrecision};
//! use swarmllm::gguf::GgufQuantType;
//!
...
///
/// ```rust,ignore
/// use swarmllm::moe::precision_allocator::{PrecisionAllocator, PrecisionConfig};
///
/// let config = PrecisionConfig::default();
/// let mut allocator = PrecisionAllocator::new(8, config).unwrap();
///
