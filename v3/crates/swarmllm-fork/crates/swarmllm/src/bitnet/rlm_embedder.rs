...
//! - Structurally aware (conditioned on SwarmVector neighborhood)
...
/// Trait for retrieving neighbors from the evidence store (e.g., SwarmVector).
...
///
/// For larger corpora, use SwarmVector's HNSW index as the retriever.
#[derive(Clone)]
