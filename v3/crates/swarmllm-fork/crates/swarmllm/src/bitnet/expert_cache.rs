...
///
/// ```rust,ignore
/// use swarmllm::bitnet::expert_cache::{ExpertCache, ExpertCacheConfig};
///
...
impl ExpertCache {
    ...
    /// ```rust,ignore
    /// use swarmllm::bitnet::expert_cache::{ExpertCache, ExpertCacheConfig};
    /// use swarmllm::moe::{ExpertAffinity, AffinityConfig};
    ///
    /// let mut cache = ExpertCache::new(8, ExpertCacheConfig::default());
...
///
/// ```rust,ignore
/// use swarmllm::bitnet::expert_cache::align_to_cache_line;
///
