...
//!
//! Test commands:
//! - All gates: `cargo test -p swarmllm moe_integration`
//! - G1 only: `cargo test -p swarmllm gate_1`
//! - G3 only: `cargo test -p swarmllm gate_3`
//! - G4 only: `cargo test -p swarmllm gate_4`

#[cfg(test)]
mod moe_integration {
    use swarmllm::bitnet::expert_cache::{
