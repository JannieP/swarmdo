...
//! - `SWARMLLM_MODELS_DIR`: Default cache directory for downloaded models
...
fn cmd_info(args: &[String]) {
    ...
    println!(
        "  cargo run -p swarmllm --example hub_cli -- pull {}",
        model_id
    );
...
fn print_help() {
    println!("SwarmLLM Hub CLI - Manage models on HuggingFace Hub\n");
    println!("USAGE:");
