...
//! SwarmLLM Evaluation CLI
//!
//! Run real LLM evaluations using SWE-Bench tasks with the full SwarmLLM stack.
//!
//! ## Usage
//!
//! ```bash
//! # Run evaluation with a GGUF model on sample tasks
//! cargo run -p swarmllm --example run_eval --features candle -- \
...
//!
//! - `SWARMLLM_MODELS_DIR`: Default directory for model files
//! - `SWARMLLM_CACHE_DIR`: Cache directory for downloaded datasets

use swarmllm::backends::ModelConfig;
use swarmllm::evaluation::{
