...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if !triplets_path.exists() {
        ...
        println!("  node npm/packages/swarmllm/scripts/training/contrastive-finetune.js");
        println!();
...
/// Simplified trainer for example (uses the actual swarmllm training module when available)
