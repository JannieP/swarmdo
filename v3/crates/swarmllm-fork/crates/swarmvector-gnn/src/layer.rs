...
mod tests {
    ...
    #[test]
    fn test_swarmvector_layer() {
        let layer = SwarmvectorLayer::new(4, 8, 2, 0.1).unwrap();
    ...
    #[test]
    fn test_swarmvector_layer_no_neighbors() {
        let layer = SwarmvectorLayer::new(4, 8, 2, 0.1).unwrap();
    ...
    #[test]
    fn test_swarmvector_layer_invalid_dropout() {
        let result = SwarmvectorLayer::new(4, 8, 2, 1.5);
        assert!(result.is_err());
    }

    #[test]
    fn test_swarmvector_layer_invalid_heads() {
        let result = SwarmvectorLayer::new(4, 7, 3, 0.1);
        assert!(result.is_err());
    }
}
