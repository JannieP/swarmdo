# SwarmLLM ESP32 - Windows PowerShell Installer
...
╔══════════════════════════════════════════════════════════╗
║          SwarmLLM ESP32 - Windows Installer                ║
...
function Build-Project {
    Write-Color "`nBuilding SwarmLLM ESP32..." Yellow
...
function Setup-Cluster {
    ...
    $config = @"
# SwarmLLM ESP32 Cluster Configuration
# Generated by install.ps1

[cluster]
name = "swarmllm-cluster"
chips = $NumChips
