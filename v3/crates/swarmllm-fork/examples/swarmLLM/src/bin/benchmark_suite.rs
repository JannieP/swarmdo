...
//!
//! Compares SwarmLLM against state-of-the-art systems and tracks
//! self-learning improvement over time.

use swarmllm::{Config, Feedback, Result, SwarmLLM};
...
async fn benchmark_latency(llm: &SwarmLLM, config: &BenchmarkConfig) -> Result<BenchmarkMetrics> {
...
async fn benchmark_self_learning(config: &BenchmarkConfig) -> Result<Vec<LearningMetrics>> {
    ...
    // Create SwarmLLM with learning enabled
    ...
    let llm = SwarmLLM::new(llm_config).await?;
...
fn print_comparison_table(metrics: &BenchmarkMetrics, baselines: &SOTABaselines) {
    ...
    println!("╠════════════════════════════════════════════════════════════════════════════════╣");
    println!(
        "║ \x1b[32mSwarmLLM (This)          │ {:>8.2} │ {:>8.2} │ {:>8.2} │ {:>19.0}x\x1b[0m ║",
    ...
    println!("╠════════════════════════════════════════════════════════════════════════════════╣");
    println!(
        "║ \x1b[32mSwarmLLM (CPU Only)      │ {:>11.1} │ {:>38.0}x\x1b[0m ║",
...
fn print_capability_benchmarks() {
    ...
    println!("╠════════════════════════════════════════════════════════════════════════════════════════╣");
    println!("║ \x1b[33mSwarmLLM (Mock LFM2)   │    N/A*   │    N/A*   │  N/A* │  N/A* │    N/A    │ ~350M-2.6B\x1b[0m ║");
    println!("╠════════════════════════════════════════════════════════════════════════════════════════╣");
    println!("║ * SwarmLLM uses mock inference. Production deployment requires LFM2/llama.cpp backend.   ║");
...
/// Print SwarmLLM-specific advantages
fn print_swarmllm_advantages() {
    println!("\n╔════════════════════════════════════════════════════════════════════════════════════════╗");
    println!("║                      SwarmLLM ARCHITECTURAL ADVANTAGES                                    ║");
    println!("╠════════════════════════════════════════════════════════════════════════════════════════╣");
    println!("║                                                                                        ║");
    println!("║  SwarmLLM is NOT a replacement for large foundation models - it's an AUGMENTATION LAYER  ║");
    ...
    println!("║  │    • SwarmLLM: Writes successful Q&A pairs to memory, improves over time          │   ║");
    println!("║  ├─────────────────────────────────────────────────────────────────────────────────┤   ║");
    ...
    println!("║  └─────────────────────────────────────────────────────────────────────────────────┘   ║");
    println!("║                                                                                        ║");
    println!("║  DEPLOYMENT: SwarmLLM wraps ANY LLM backend (llama.cpp, vLLM, OpenAI API, Ollama)        ║");
    println!(
...
fn print_feature_comparison() {
    ...
    println!("╠════════════════════════════════════════════════════════════════════════════════════════╣");
    println!(
        "║ Feature                    │ GPT-4o │ Claude │ Gemini │ RAG   │ vLLM │ SwarmLLM         ║"
    );
    println!("╠════════════════════════════════════════════════════════════════════════════════════════╣");
...
fn print_quality_comparison(avg_quality: f64, baselines: &SOTABaselines) {
    ...
    println!(
        "║ \x1b[32mSwarmLLM (after learning)         │ {:>12.1}% │ Adaptive + learning\x1b[0m    ║",
        avg_quality * 100.0
    );
    println!("╠═══════════════════════════════════════════════════════════════════════════╣");
    println!(
...
async fn main() -> Result<()> {
    println!("╔═══════════════════════════════════════════════════════════════════════════╗");
    println!("║           SwarmLLM Comprehensive Benchmark Suite v1.0                       ║");
    println!("║     Self-Learning LLM with LFM2 + Swarmvector + FastGRNN                     ║");
    println!("╚═══════════════════════════════════════════════════════════════════════════╝");
    println!();
    ...
    let llm = std::sync::Arc::new(SwarmLLM::new(llm_config).await?);
    ...
    println!("║  SwarmLLM adds memory, routing, and learning ON TOP of any LLM.                  ║");
    println!("║                                                                                ║");
    println!("╚════════════════════════════════════════════════════════════════════════════════╝");
