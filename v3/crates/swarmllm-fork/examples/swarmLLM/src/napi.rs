//! N-API bindings for SwarmLLM
//!
//! Provides Node.js bindings for the SwarmLLM self-learning LLM orchestrator.
//!
//! ## v2.0 Features
//!
...
//!
//! ```javascript
//! const { SwarmLLMEngine } = require('@swarmvector/swarmllm');
//!
//! // Create engine with parallel inference
//! const engine = new SwarmLLMEngine({
//!   useParallel: true,
//!   useMetal: false,
//!   quantization: 'q4k',
//! });
...
use swarmllm_lib::kernels::is_neon_available;
use swarmllm_lib::memory_pool::{MemoryManager, MemoryManagerConfig, MemoryManagerStats};

/// SwarmLLM Configuration for Node.js
#[napi(object)]
#[derive(Clone, Debug)]
pub struct JsSwarmLLMConfig {
...
impl Default for JsSwarmLLMConfig {
    fn default() -> Self {
        Self {
...
#[napi]
impl SwarmLLMEngine {
    /// Create a new SwarmLLM engine with default configuration
    #[napi(constructor)]
    pub fn new(config: Option<JsSwarmLLMConfig>) -> Result<Self> {
    ...
    #[napi]
    pub fn stats(&self) -> JsSwarmLLMStats {
