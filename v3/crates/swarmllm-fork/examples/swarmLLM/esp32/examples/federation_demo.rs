...
use swarmllm_esp32::optimizations::{
...
fn main() {
    println!("╔═══════════════════════════════════════════════════════════════╗");
    println!("║     SwarmLLM ESP32 - 5-Chip Federation Benchmark                ║");
    println!("║     With Self-Learning & Swarmvector Optimizations               ║");
    println!("╚═══════════════════════════════════════════════════════════════╝\n");
    ...
    for _ in 0..BENCHMARK_ITERS / 10 {
        // Create draft
        let mut draft = swarmllm_esp32::federation::speculative::DraftResult {
