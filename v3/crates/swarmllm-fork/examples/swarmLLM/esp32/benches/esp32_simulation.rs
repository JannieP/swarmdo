...
use swarmllm_esp32::quantized::{QuantizationType, matmul_int8, QuantParams};
use swarmllm_esp32::attention::MicroAttention;
...
fn benchmark_quantization(c: &mut Criterion) {
    ...
    use swarmllm_esp32::quantized::QuantizedTensor;
