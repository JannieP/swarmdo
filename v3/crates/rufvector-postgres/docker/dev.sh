#!/usr/bin/env bash
# RufVector-Postgres Development Environment
...
CONTAINER_NAME="rufvector-postgres-dev"
IMAGE_NAME="rufvector-postgres:dev"
POSTGRES_PORT="${POSTGRES_PORT:-5432}"
POSTGRES_USER="${POSTGRES_USER:-postgres}"
POSTGRES_PASSWORD="${POSTGRES_PASSWORD:-postgres}"
POSTGRES_DB="${POSTGRES_DB:-rufvector_dev}"
...
build_extension() {
    log_info "Building rufvector-postgres extension..."
...
setup_extension() {
    ...
    # Create extension
    docker exec -it "${CONTAINER_NAME}" psql -U "${POSTGRES_USER}" -d "${POSTGRES_DB}" -c "CREATE EXTENSION IF NOT EXISTS rufvector_postgres CASCADE;" || {
...
show_connection_info() {
    ...
    echo ""
    echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${GREEN}  RufVector-Postgres Development Environment Ready!${NC}"
    echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    ...
    echo -e "  3. Reload: ${YELLOW}docker exec ${CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DB} -c 'DROP EXTENSION rufvector_postgres CASCADE; CREATE EXTENSION rufvector_postgres;'${NC}"
    echo ""
...
watch_and_reload() {
    ...
    cargo watch -x "pgrx install" -s "docker exec ${CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DB} -c 'DROP EXTENSION IF EXISTS rufvector_postgres CASCADE; CREATE EXTENSION rufvector_postgres;'"
}
...
Environment Variables:
    ...
    POSTGRES_DB            PostgreSQL database (default: rufvector_dev)
...
DROP EXTENSION IF EXISTS rufvector_postgres CASCADE;
CREATE EXTENSION rufvector_postgres;
SELECT extname, extversion FROM pg_extension WHERE extname = 'rufvector_postgres';
EOF
