-- RufVector-Postgres Integration Test Initialization
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'RufVector Integration Test Initialization';
    RAISE NOTICE '========================================';
END $$;
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Extension version: %', rufvector_version();
    RAISE NOTICE 'SIMD info: %', rufvector_simd_info();
    RAISE NOTICE '========================================';
END $$;
