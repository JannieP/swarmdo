#!/usr/bin/env bash
# RufVector-Postgres Docker Hub Publication Script
...
# Configuration
DOCKER_REGISTRY="${DOCKER_REGISTRY:-rufvector}"
IMAGE_NAME="${IMAGE_NAME:-rufvector-postgres}"
VERSION="2.0.0"
RUST_VERSION="1.83"
...
log_info "=== RufVector-Postgres Docker Hub Publication ==="
...
if [[ "$MULTI_ARCH" == "true" ]]; then
    BUILDER_NAME="rufvector-builder"
