...
--      Can be set per-session: SET rufvector.ef_search = 100;
*/
...
-- rufvector.ef_search = 40          # Query-time candidate list size
-- rufvector.maintenance_work_mem    # Use standard PostgreSQL setting

-- Session settings:
-- SET rufvector.ef_search = 100;    # Increase recall for current session
