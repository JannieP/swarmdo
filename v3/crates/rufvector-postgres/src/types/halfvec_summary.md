...
I've implemented a comprehensive native PostgreSQL HalfVec type in `/home/user/rufvector/crates/rufvector-postgres/src/types/halfvec.rs` with the following features:
...
2. **Conversion Functions**:
   - `halfvec_to_vector(HalfVec) -> RufVector` - Convert to f32 vector
   - `vector_to_halfvec(RufVector) -> HalfVec` - Convert from f32 vector
...
- Implementation: `/home/user/rufvector/crates/rufvector-postgres/src/types/halfvec.rs`
