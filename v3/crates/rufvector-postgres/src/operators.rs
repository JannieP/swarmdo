...
//!
//! Provides both array-based and native rufvector type distance functions with SIMD optimization.
...
use crate::types::RufVector;

// ============================================================================
// Native RufVector Type Distance Functions (Zero-Copy SIMD)
// ============================================================================
// These functions use the native rufvector type directly for maximum performance

/// Compute L2 (Euclidean) distance between two native rufvector types
#[pg_extern(immutable, parallel_safe)]
pub fn rufvector_l2_distance(a: RufVector, b: RufVector) -> f32 {
...
/// Compute cosine distance between two native rufvector types
#[pg_extern(immutable, parallel_safe)]
pub fn rufvector_cosine_distance(a: RufVector, b: RufVector) -> f32 {
    if a.dimensions() != b.dimensions() {
        pgrx::error!(
            "Cannot compute distance between vectors of different dimensions ({} vs {})",
            a.dimensions(),
...
/// Compute inner product between two native rufvector types
#[pg_extern(immutable, parallel_safe)]
pub fn rufvector_inner_product(a: RufVector, b: RufVector) -> f32 {
    if a.dimensions() != b.dimensions() {
        pgrx::error!(
...
/// Compute Manhattan (L1) distance between two native rufvector types
#[pg_extern(immutable, parallel_safe)]
pub fn rufvector_l1_distance(a: RufVector, b: RufVector) -> f32 {
    if a.dimensions() != b.dimensions() {
        pgrx::error!(
            "Cannot compute distance between vectors of different dimensions ({} vs {})",
            a.dimensions(),
...
/// Get dimensions of a native rufvector
#[pg_extern(immutable, parallel_safe)]
pub fn rufvector_dims(v: RufVector) -> i32 {
    v.dimensions() as i32
}

/// Get L2 norm of a native rufvector
#[pg_extern(immutable, parallel_safe)]
pub fn rufvector_norm(v: RufVector) -> f32 {
    v.norm()
}

/// Normalize a native rufvector to unit length
#[pg_extern(immutable, parallel_safe)]
pub fn rufvector_normalize(v: RufVector) -> RufVector {
    v.normalize()
}

/// Add two native rufvector types
#[pg_extern(immutable, parallel_safe)]
pub fn rufvector_add(a: RufVector, b: RufVector) -> RufVector {
    if a.dimensions() != b.dimensions() {
...
/// Subtract two native rufvector types
#[pg_extern(immutable, parallel_safe)]
pub fn rufvector_sub(a: RufVector, b: RufVector) -> RufVector {
    if a.dimensions() != b.dimensions() {
        pgrx::error!("Vectors must have the same dimensions");
    }
    a.sub(&b)
...
/// Multiply native rufvector by scalar
#[pg_extern(immutable, parallel_safe)]
pub fn rufvector_mul_scalar(v: RufVector, scalar: f32) -> RufVector {
    v.mul_scalar(scalar)
}
