...
#[pg_extern]
fn rufvector_integrity_status() -> pgrx::JsonB {
...
#[pg_extern]
fn rufvector_integrity_create_contract(
    id: &str,
    name: &str,
    min_recall: f64,
    max_latency_ms: i64,
...
#[pg_extern]
fn rufvector_integrity_validate(
    contract_id: &str,
    recall: f64,
    latency_ms: i64,
    mincut: f64,
...
#[pg_extern]
fn rufvector_mincut(n: i32, edges_json: pgrx::JsonB) -> f64 {
...
mod tests {
    ...
    fn test_integrity_status() {
        let status = rufvector_integrity_status();
