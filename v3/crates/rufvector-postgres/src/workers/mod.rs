//! Background Workers for RufVector Postgres v2
//!
...
pub fn init_workers() {
    pgrx::log!("RufVector background worker subsystem initializing");
    ...
    pgrx::log!("RufVector background worker subsystem ready");
}

/// Shutdown all background workers gracefully
pub fn shutdown_all_workers() {
    pgrx::log!("Shutting down all RufVector background workers");
    ...
    pgrx::log!("All RufVector background workers stopped");
}
...
#[pg_extern]
pub fn rufvector_worker_status() -> pgrx::JsonB {
    let registry = get_worker_registry();
...
#[pg_extern]
pub fn rufvector_worker_spawn(worker_type: &str) -> pgrx::JsonB {
...
#[pg_extern]
pub fn rufvector_worker_configure(config: pgrx::JsonB) -> pgrx::JsonB {
