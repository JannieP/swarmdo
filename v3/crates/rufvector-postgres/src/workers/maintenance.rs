...
/// Information about a RufVector index
#[derive(Debug, Clone)]
...
impl MaintenanceWorker {
    ...
    fn perform_maintenance_cycle(&mut self) -> Result<(), String> {
        ...
        let indexes = self.find_rufvector_indexes()?;
    ...
    fn find_rufvector_indexes(&self) -> Result<Vec<IndexInfo>, String> {
    ...
    fn get_tiered_collections(&self) -> Result<Vec<i32>, String> {
        // In production, query rufvector.tier_policies
        Ok(vec![])
    }
...
#[pg_guard]
pub extern "C" fn rufvector_maintenance_worker_main(arg: pg_sys::Datum) {
    let worker_id = arg.value() as u64;

    pgrx::log!("RufVector maintenance worker {} starting", worker_id);
    ...
    pgrx::log!("RufVector maintenance worker {} stopped", worker_id);
}
...
#[pg_extern]
pub fn rufvector_maintenance_stats() -> pgrx::JsonB {
...
#[pg_extern]
pub fn rufvector_force_maintenance() -> bool {
