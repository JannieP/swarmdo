...
fn spawn_pg_background_worker(worker_id: u64, worker_type: WorkerType) -> Result<i32, String> {
    ...
    let name = format!("rufvector {} [{}]", worker_type, worker_id);
    ...
    //         WorkerType::Engine => super::engine::rufvector_engine_worker_main,
    //         WorkerType::Maintenance => super::maintenance::rufvector_maintenance_worker_main,
    //         WorkerType::GnnTraining => super::gnn::rufvector_gnn_training_worker_main,
    //         WorkerType::Integrity => super::integrity::rufvector_integrity_worker_main,
    //     });
