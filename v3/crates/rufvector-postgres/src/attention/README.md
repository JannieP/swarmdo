...
```rust
use rufvector_postgres::attention::{ScaledDotAttention, Attention};
...
| Function | Purpose |
|----------|---------|
| `rufvector_attention_score()` | Single query-key attention score |
| `rufvector_softmax()` | Softmax activation |
| `rufvector_multi_head_attention()` | Multi-head attention forward pass |
| `rufvector_flash_attention()` | Flash Attention v2 |
| `rufvector_attention_scores()` | Multiple attention scores |
