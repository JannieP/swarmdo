//! Local embedding generation module for rufvector-postgres
//!
...
//! SELECT rufvector_embed('Hello world', 'all-MiniLM-L6-v2');
//!
//! -- Batch embedding
//! SELECT rufvector_embed_batch(ARRAY['text1', 'text2']);
//!
//! -- List available models
//! SELECT * FROM rufvector_embedding_models();
//!
//! -- Model management
//! SELECT rufvector_load_model('all-MiniLM-L6-v2');
