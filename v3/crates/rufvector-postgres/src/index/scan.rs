...
pub fn parse_distance_metric(op_name: &str) -> DistanceMetric {
    match op_name {
        "rufvector_l2_ops" | "<->" => DistanceMetric::Euclidean,
        "rufvector_ip_ops" | "<#>" => DistanceMetric::InnerProduct,
        "rufvector_cosine_ops" | "<=>" => DistanceMetric::Cosine,
        "rufvector_l1_ops" | "<+>" => DistanceMetric::Manhattan,
