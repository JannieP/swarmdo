...
### Distance Operations
- `rufvector_sparse_dot(a, b) -> real`
- `rufvector_sparse_cosine(a, b) -> real`
- `rufvector_sparse_euclidean(a, b) -> real`
- `rufvector_sparse_manhattan(a, b) -> real`
- `rufvector_sparse_bm25(query, doc, ...) -> real`
...
- `rufvector_sparse_top_k(sparse, k) -> sparsevec` - Keep top k
- `rufvector_sparse_prune(sparse, threshold) -> sparsevec` - Prune small values
...
SELECT id,
       ...
       0.3 * rufvector_sparse_dot(sparse, query_sparse) AS hybrid_score
FROM documents
