...
This document describes the three native quantized vector types implemented for rufvector-postgres, providing massive compression ratios with minimal accuracy loss.
