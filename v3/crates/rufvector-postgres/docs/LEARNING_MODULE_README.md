# Self-Learning Module for RufVector-Postgres
...
WITH params AS (
    SELECT rufvector_get_search_params('documents',
...
```sql
SELECT jsonb_pretty(rufvector_learning_stats('documents'));
```
...
- Documentation: https://github.com/ruvnet/rufvector/tree/main/docs
