# RufVector Benchmark Suite

Comprehensive benchmarks comparing rufvector vs pgvector across multiple dimensions.
...
```bash
# Setup database
createdb rufvector_bench
psql -d rufvector_bench -c 'CREATE EXTENSION rufvector;'
psql -d rufvector_bench -c 'CREATE EXTENSION pgvector;'

# Quick benchmark (10k vectors)
psql -d rufvector_bench -f benches/sql/quick_benchmark.sql

# Full workload (1M vectors)
psql -d rufvector_bench -f benches/sql/benchmark_workload.sql
```
...
- rufvector vs pgvector comparison
