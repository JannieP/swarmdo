...
**Status**: Accepted — Implemented in swarmdo 3.10.18
**Date**: 2026-05-30
...
node v3/@swarmdo/cli/scripts/benchmark-pretrained-retrieval.mjs       # hybrid (default)
HYBRID=0 node v3/@swarmdo/cli/scripts/benchmark-pretrained-retrieval.mjs   # cosine baseline
```
