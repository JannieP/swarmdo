...
**Status**: Accepted — Implemented in swarmdo 3.10.15
**Date**: 2026-05-30
**Tracking**: [#2245](the upstream project (see NOTICE)) — self-learning subsystem audit
...
|---|---|
| `globalStats` (`.swarmdo/neural/stats.json`) | "did the SONA/trajectory pipeline persist a learning event" (counter form) |
...
( cd v3/@swarmdo/cli && npx vitest run __tests__/unified-stats-2245.test.ts )
