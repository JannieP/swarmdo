...
**Status**: Accepted — Implemented in rufflo 3.10.20
**Date**: 2026-05-30
...
( cd v3/@rufflo/cli && npx vitest run __tests__/cross-encoder-rerank.test.ts __tests__/hybrid-retrieval.test.ts __tests__/pretrain-from-github.test.ts )
