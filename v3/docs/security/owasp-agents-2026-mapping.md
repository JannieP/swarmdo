# OWASP Top 10 for Agentic Applications 2026 — Swarmdo control mapping
...
| ✗ | Open — no Swarmdo control yet, tracked for future work |

## Matrix

| ID | Risk | Coverage | Swarmdo controls | Gaps / follow-ups |
|---|---|---|---|---|
