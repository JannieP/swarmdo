...
hooks:
  pre: |
    ...
    mcp__swarmdo__memory_usage store "swarm$hierarchical$status" "{\"agent\":\"hierarchical-coordinator\",\"status\":\"initializing\",\"timestamp\":$(date +%s),\"topology\":\"hierarchical\"}" --namespace=coordination
    # Set up monitoring
  ...
  post: |
    ...
    mcp__swarmdo__memory_usage store "swarm$hierarchical$complete" "{\"status\":\"complete\",\"agents_used\":$(mcp__swarmdo__swarm_status | jq '.agents.total'),\"timestamp\":$(date +%s)}" --namespace=coordination
    # Cleanup resources
...
- **Spawn Command**: `mcp__swarmdo__agent_spawn researcher --capabilities="research,analysis,information_gathering"`

### Code Workers 💻  
- **Capabilities**: Implementation, code review, testing, documentation
- **Use Cases**: Feature development, bug fixes, code optimization
- **Spawn Command**: `mcp__swarmdo__agent_spawn coder --capabilities="code_generation,testing,optimization"`

### Analyst Workers 📊
- **Capabilities**: Data analysis, performance monitoring, reporting
- **Use Cases**: Metrics analysis, performance optimization, reporting
- **Spawn Command**: `mcp__swarmdo__agent_spawn analyst --capabilities="data_analysis,performance_monitoring,reporting"`

### Test Workers 🧪
- **Capabilities**: Quality assurance, validation, compliance checking
- **Use Cases**: Testing, validation, quality gates
- **Spawn Command**: `mcp__swarmdo__agent_spawn tester --capabilities="testing,validation,quality_assurance"`
...
mcp__swarmdo__swarm_init hierarchical --maxAgents=10 --strategy=centralized

# Spawn specialized workers
mcp__swarmdo__agent_spawn researcher --capabilities="research,analysis"
mcp__swarmdo__agent_spawn coder --capabilities="implementation,testing"  
