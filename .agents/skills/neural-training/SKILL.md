...
1. **RETRIEVE** — Fetch relevant patterns via HNSW (~1.9x-4.7x measured faster)
...
| HNSW | Pattern search | ~1.9x-4.7x measured |
| EWC++ | Prevent forgetting | Continuous |
| Flash Attention | Speed | unverified (no benchmark) |
