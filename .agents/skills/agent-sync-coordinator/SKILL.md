...
// Get file contents
CLAUDE_CONTENT=$(Bash("gh api repos/:owner/:repo$contents$ruf-swarm$docs/CLAUDE.md --jq '.content' | base64 -d"))
...
[Single Message - Complete Synchronization]:
  ...
  Read("$workspaces$ruv-FANN$ruf-swarm$docs/CLAUDE.md")
  ...
  Bash("cd $workspaces$ruv-FANN$ruf-swarm$npm && npm test")
