...
export const mcpExamples: RouterExample[] = [
	...
	},
	{
		...
		followUps: [
			...
			},
			{
				...
				prompt: "Find related memories with rufvector__hooks_recall query='editor settings'.",
			},
		],
	},
	{
		title: "Route a task",
		prompt:
			"Use rufvector__hooks_route on the task: 'add OAuth2 to a SvelteKit API'. Tell me which agent type and topology you'd recommend.",
		followUps: [
			{
			...
			},
			{
				...
				prompt: "Begin a trajectory with rufvector__hooks_trajectory_begin to record the work.",
			},
		],
	},
	{
	...
	},
	{
		...
		prompt:
			"Use rufvector__neural_train to learn from this successful pattern: 'JWT auth with refresh tokens — store refresh in httpOnly cookie, access in memory'.",
		followUps: [
			{
				title: "Predict",
				prompt: "Use rufvector__neural_predict for the task 'add session-based auth'.",
			},
		],
	},
];
