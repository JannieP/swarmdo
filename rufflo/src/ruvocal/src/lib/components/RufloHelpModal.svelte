<script lang="ts">
	...
	const tips = [
		...
		'**Tool name prefixes** — `rufflo__` is the agent/memory backend, `ruvector__` is the intelligence layer. Always use the full prefixed name when invoking explicitly.',
	];
		...
		<div class="flex-1 overflow-y-auto px-6 py-4">
			...
			<section class="mb-6">
				...
				<div class="mt-3 rounded-lg border border-emerald-300/40 bg-emerald-50/50 px-3 py-2 text-xs dark:border-emerald-700/40 dark:bg-emerald-900/10">
					...
					<p class="mt-1 text-emerald-900/80 dark:text-emerald-200/80">Rufflo speaks any OpenAI-compatible endpoint: vLLM, Ollama, LM Studio, Together, Groq, or self-hosted. Native support for <a href="https://github.com/ruvnet/RuVector/tree/main/examples/ruvLLM" target="_blank" rel="noopener" class="underline">ruvLLM</a> (lives in <code>ruvnet/RuVector/examples/ruvLLM</code>) — Rufflo's self-improving local model layer with MicroLoRA adapters that learn from your trajectories via SONA. Pair cloud + local, or run fully offline.</p>
				</div>
			</section>
			...
			<section>
				...
				<ul class="space-y-1 text-sm">
					...
					<li>
						<a href="https://github.com/ruvnet/ruflo/blob/main/rufflo/docs/adr/ADR-033-RUVOCAL-WASM-MCP-INTEGRATION.md" target="_blank" rel="noopener" class="text-blue-600 hover:underline dark:text-blue-400">
