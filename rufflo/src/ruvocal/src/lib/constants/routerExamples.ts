...
// Rufflo-themed router examples — shown on the empty-state welcome screen
...
export const routerExamples: RouterExample[] = [
	...
	{
		title: "Memory & recall",
		prompt: "Explain how Rufflo's persistent memory works across sessions, and give me a 3-step example of saving a preference and recalling it later.",
		followUps: [
			{
				title: "Namespaces",
	...
	},
	{
		...
		prompt: "I'm starting a 4-week migration. How should I structure horizon tracking, milestone checkpoints, and drift detection in Rufflo?",
		followUps: [
			{
	...
	},
	{
		...
		followUps: [
			...
			{
				title: "Offline",
				prompt: "What can Rufflo still do if my network drops?",
			},
		],
	},
];
