...
[![npm version (rufflo)](https://img.shields.io/npm/v/rufflo?label=rufflo&style=for-the-badge&logo=npm&color=cb3837)](https://www.npmjs.com/package/rufflo)
...
[![🕸️ RufVector Graph Ai](https://img.shields.io/badge/RufVector_Agentic-DB-06b6d4?style=for-the-badge&logoColor=white&logo=graphql)](https://github.com/ruvnet/rufvector)
...
Orchestrate 100+ specialized AI agents across machines, teams, and trust boundaries. Rufflo adds coordinated swarms, self-learning memory, federated comms, and enterprise security to Claude Code — so agents don't just run, they collaborate.
...
| [**rufflo-metaharness**](https://github.com/ruvnet/ruflo/blob/main/plugins/rufflo-metaharness/README.md) | Grade your agent setup, scan tool configs for security risks, and track changes over time ([guide](https://github.com/ruvnet/ruflo/blob/main/docs/metaharness-user-guide.md)) |
...
| 🔬 **MetaHarness** | Audit your AI agent setup before you ship. Grade readiness (1-100), scan tool configs for security issues, snapshot the whole project to catch regressions over time, and find templates that match your repo. `rufflo eject` turns a rufflo project into a standalone agent toolkit with its own name. [Full guide](https://github.com/ruvnet/ruflo/blob/main/docs/metaharness-user-guide.md). |
...
| 🎯 **[Rufflo Research](https://goal.ruv.io/)** | GOAP A\* planner at goal.ruv.io — plain-English goals → executable agent plans, with a live agent dashboard at [/agents](https://goal.ruv.io/agents) |
...
<p align="center">
  <a href="https://goal.ruv.io/agents">
    <img src="v3/docs/assets/goal.png" alt="goal.ruv.io/agents — Rufflo Goal-Oriented Action Planning (GOAP) UI for autonomous AI agents. Visual goal decomposition, A* search through state spaces, multi-agent task assignment, and live agent telemetry." width="100%" />
  </a>
</p>

### Goal Planner UI — autonomous agents at [goal.ruv.io](https://goal.ruv.io/)

**Turn high-level goals into executable agent plans.** `goal.ruv.io` is Rufflo's hosted Goal-Oriented Action Planning (GOAP) front-end — describe an outcome in plain English and watch Rufflo decompose it into preconditions, actions, and an A* path through state space, then dispatch the work to live agents at [`/agents`](https://goal.ruv.io/agents).
